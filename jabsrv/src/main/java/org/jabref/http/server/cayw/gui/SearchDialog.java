...
public class SearchDialog {
    ...
    private final ObservableList<CAYWEntry> selectedItems =
        FXCollections.observableArrayList();

    private Stage dialogStage;

    public List<CAYWEntry> show(
        Function<String, List<CAYWEntry>> searchFunction,
        List<CAYWEntry> entries
    ) {
        FilteredList<CAYWEntry> searchResults = new FilteredList<>(
        ...
        dialogStage.setTitle(
            Localization.lang("%0 | Cite As You Write", "JabRef")
        );
        ...
        SelectedItemsContainer selectedContainer = new SelectedItemsContainer(
            selectedItems
        );
        ...
        mainLayout
            .getChildren()
            .addAll(searchField, selectedContainer, scrollPane, finishButton);

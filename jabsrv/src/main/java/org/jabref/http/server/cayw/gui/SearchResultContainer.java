...
public class SearchResultContainer extends ListView<CAYWEntry> {
    ...
    private static final int ESTIMATED_CHARS_PER_LINE = 80;
    private static final int TOOLTIP_WIDTH = 400;
    private static final double PREF_WIDTH = 300;

    private ObservableList<CAYWEntry> selectedEntries =
        javafx.collections.FXCollections.observableArrayList();

    public SearchResultContainer(
        ObservableList<CAYWEntry> entries,
        ObservableList<CAYWEntry> selectedEntries
    ) {
        super(entries);
    ...
    private static class SearchResultCell extends ListCell<CAYWEntry> {
        ...
        public SearchResultCell() {
            ...
            descriptionText
                ...
                .bind(widthProperty().subtract(20));
        }
        ...
        protected void updateItem(CAYWEntry item, boolean empty) {
            ...
            if (empty || item == null) {
                ...
                String truncatedDescription = truncateToThreeLines(
                    fullDescription
                );
        ...
        private String truncateToThreeLines(String text) {
            ...
            if (lines.length <= MAX_LINES) {
                return StringUtil.limitStringLength(
                    text,
                    ESTIMATED_CHARS_PER_LINE * MAX_LINES
                );
            } else {
                return (

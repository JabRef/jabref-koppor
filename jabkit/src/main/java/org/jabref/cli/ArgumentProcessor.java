...
public class ArgumentProcessor implements Runnable {
     ...
     * Reads URIs as input
     */
    protected static Optional<ParserResult> importFile(
        ...
        Optional<ParserResult> importResult = importFile(
            file,
            importFormat,
            cliPreferences,
            porcelain
    ...
    protected static void saveDatabase(
        ...
        saveDatabaseContext(
            cliPreferences,
            entryTypesManager,
            new BibDatabaseContext(newBase),
            outputFile
        );
    }

    protected static void saveDatabaseContext(
        CliPreferences cliPreferences,
        BibEntryTypesManager entryTypesManager,
        ...
        try {
            if (!FileUtil.isBibFile(outputFile)) {
                System.err.println(
                    Localization.lang("Invalid output file type provided.")
                );
            }
            try (
                ...
                SelfContainedSaveConfiguration saveConfiguration =
                    (SelfContainedSaveConfiguration) new SelfContainedSaveConfiguration().withReformatOnSave(
                        cliPreferences
    ...
    public static List<Pair<String, String>> getAvailableImportFormats(
    ...
    public static List<Pair<String, String>> getAvailableExportFormats(
        CliPreferences preferences
    ) {
    ...
    public static class SharedOptions {
        ...
        @Option(
            names = { "-p", "--porcelain" },
            description = "Enable script-friendly output"
        )
        boolean porcelain;

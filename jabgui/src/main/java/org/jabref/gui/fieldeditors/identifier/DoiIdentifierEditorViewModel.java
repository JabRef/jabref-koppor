...
public class DoiIdentifierEditorViewModel extends BaseIdentifierEditorViewModel<DOI> {
    ...
    public DoiIdentifierEditorViewModel(SuggestionProvider<?> suggestionProvider, FieldCheckers fieldCheckers,
    ...
    public void openExternalLink() {
        identifier.get().map(DOI::asString).ifPresent(s -> NativeDesktop.openCustomDoi(s, preferences, dialogService));
    }

...
public class PersonsEditorViewModel extends AbstractEditorViewModel {
    ...
    public PersonsEditorViewModel(Field field, SuggestionProvider<?> suggestionProvider,
            AutoCompletePreferences preferences, FieldCheckers fieldCheckers, UndoManager undoManager) {

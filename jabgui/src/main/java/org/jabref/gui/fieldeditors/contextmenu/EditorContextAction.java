...
public class EditorContextAction extends SimpleCommand {
    ...
    public EditorContextAction(
        ...
        BooleanBinding undoableBinding = Bindings.createBooleanBinding(
            textInputControl::isUndoable,
            textInputControl.undoableProperty()
        );
        BooleanBinding redoableBinding = Bindings.createBooleanBinding(
            textInputControl::isRedoable,

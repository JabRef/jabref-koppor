...
public class FieldEditors {
    ...
    public static FieldEditorFX getForField(
        ...
        if (
            ...
            (fieldProperties.contains(FieldProperty.IDENTIFIER)
                && field != StandardField.PMID)
            ...
            return new CitationCountEditor(
                field,
                suggestionProvider,
                fieldCheckers
            );
        } else if (field == StandardField.ISSN) {
            return new ISSNEditor(
                field,
                suggestionProvider,
                fieldCheckers,
                undoAction,
            ...
            List<String> selectorValues = databaseContext
                .getMetaData()
                .getContentSelectorValuesForField(field);

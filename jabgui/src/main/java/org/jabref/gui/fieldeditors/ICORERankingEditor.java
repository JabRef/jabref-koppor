...
public class ICORERankingEditor extends HBox implements FieldEditorFX {
    ...
    @FXML
    private ICORERankingEditorViewModel viewModel;

    @FXML
    private EditorTextField textField;

    @FXML
    private Button lookupICORERankButton;

    @FXML
    private Button visitICOREConferencePageButton;
    ...
    public ICORERankingEditor(
        ...
        visitICOREConferencePageButton
            .disableProperty()
            .bind(textField.textProperty().isEmpty());
    }

...
public class GenderEditorViewModel extends StringMapBasedEditorViewModel {
    ...
    public GenderEditorViewModel(Field field, SuggestionProvider<?> suggestionProvider, FieldCheckers fieldCheckers,
        ...
        super(field, suggestionProvider, fieldCheckers, undoManager,
                Map.of("sf", Localization.lang("Female name"), "sm", Localization.lang("Male name"), "sn",
                        Localization.lang("Neuter name"), "pf", Localization.lang("Female names"), "pm",
                        Localization.lang("Male names"), "pn", Localization.lang("Neuter names"), "pp",

...
public class CleanupSingleAction extends SimpleCommand {
    ...
    public CleanupSingleAction(BibEntry entry, CliPreferences preferences, DialogService dialogService,
     ...
     */
    private void doCleanup(BibDatabaseContext databaseContext, CleanupPreferences preset, BibEntry entry,
            NamedCompound ce) {
    ...
    private void showFailures(List<JabRefException> failures) {
        ...
        Platform
            .runLater(() -> dialogService.showErrorDialogAndWait(Localization.lang("File Move Errors"), sb.toString()));
    }

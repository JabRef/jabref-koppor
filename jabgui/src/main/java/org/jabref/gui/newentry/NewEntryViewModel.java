...
public class NewEntryViewModel {
    ...
    public NewEntryViewModel(
        ...
        idTextValidator = new FunctionBasedValidator<>(
            ...
            ValidationMessage.error(
                Localization.lang("You must specify an identifier.")
            )
        );
        duplicateDoiValidator = new FunctionBasedValidator<>(idText, input ->
            checkDOI(input).orElse(null)
        );
        idFetchers = new SimpleListProperty<>(
        ...
        idFetcherValidator = new FunctionBasedValidator<>(
            ...
            Objects::nonNull,
            ValidationMessage.error(
                Localization.lang("You must select an identifier type.")
            )
        );
        idLookupWorker = null;
        ...
        interpretTextValidator = new FunctionBasedValidator<>(
            ...
            StringUtil::isNotBlank,
            ValidationMessage.error(
                Localization.lang("You must specify one (or more) citations.")
            )
        );
        interpretParsers = new SimpleListProperty<>(
            FXCollections.observableArrayList()
        );
        ...
        bibtexTextValidator = new FunctionBasedValidator<>(
            ...
            StringUtil::isNotBlank,
            ValidationMessage.error(
                Localization.lang("You must specify a Bib(La)TeX source.")
            )
        );
        bibtexWorker = null;
    }
    ...
    public void populateDOICache() {
        doiCache.clear();
        Optional<BibDatabaseContext> activeDatabase =
        ...
        if (doiCache.containsKey(normalized)) {
            ...
            return Optional.of(
                ValidationMessage.warning(
                    Localization.lang("Entry already exists in a library")
                )
            );
        }
    ...
    private class WorkerLookupId extends Task<Optional<BibEntry>> {
        ...
        protected Optional<BibEntry> call() throws FetcherException {
            ...
            final CompositeIdFetcher fetcher = new CompositeIdFetcher(
                preferences.getImportFormatPreferences()
            );
    ...
    private class WorkerLookupTypedId extends Task<Optional<BibEntry>> {
        ...
        protected Optional<BibEntry> call() throws FetcherException {
            final String text = idText.getValue();
            final boolean textValid = idTextValidator
                .getValidationStatus()
                .isValid();
    ...
    public void executeLookupIdentifier(boolean searchComposite) {
        ...
        idLookupWorker.setOnFailed(_ -> {
            ...
            final String dialogTitle = Localization.lang(
            ...
            LOGGER.error(
                "An exception occurred with the '{}' fetcher when resolving '{}'.",
                fetcherName,
                textString,
                exception
            );
    ...
    private class WorkerInterpretCitations
        extends Task<Optional<List<BibEntry>>> {

        @Override
        protected Optional<List<BibEntry>> call() throws FetcherException {
            final String text = interpretText.getValue();
            final boolean textValid = interpretTextValidator
                .getValidationStatus()
                .isValid();
            final PlainCitationParserChoice parserChoice =
                interpretParser.getValue();
            ...
            final PlainCitationParser parser = switch (parserChoice) {
                ...
                case PlainCitationParserChoice.GROBID -> new GrobidPlainCitationParser(
                    preferences.getGrobidPreferences(),
                    preferences.getImportFormatPreferences()
                );
                case PlainCitationParserChoice.LLM -> new LlmPlainCitationParser(
            ...
            final SeveralPlainCitationParser setParser =
                new SeveralPlainCitationParser(parser);
            final List<BibEntry> entries = setParser.parseSeveralPlainCitations(
                text
            );
    ...
    public void executeInterpretCitations() {
        ...
        interpretWorker.setOnFailed(event -> {
            ...
            final String exceptionMessage = exception.getMessage();
            final String parserName = interpretParser
                .getValue()
                .getLocalizedName();
            ...
            LOGGER.error(
                "An exception occurred with the '{}' parser.",
                parserName,
                exception
            );
        ...
        interpretWorker.setOnSucceeded(_ -> {
            ...
            if (result.isEmpty()) {
                ...
                LOGGER.error(
                    "An invalid result was returned when parsing citations."
                );
                executing.set(false);
                return;
            }
            ...
            handler.importEntriesWithDuplicateCheck(
                libraryTab.getBibDatabaseContext(),
                result.get()
            );
    ...
    private class WorkerSpecifyBibtex extends Task<Optional<List<BibEntry>>> {
        ...
        protected Optional<List<BibEntry>> call() throws ParseException {
            ...
            final boolean textValid = bibtexTextValidator
                .getValidationStatus()
                .isValid();
    ...
    public void executeSpecifyBibtex() {
        ...
        bibtexWorker.setOnFailed(_ -> {
            ...
            LOGGER.error(
                "An exception occurred when parsing Bib(La)Tex entries.",
                exception
            );
        ...
        bibtexWorker.setOnSucceeded(_ -> {
            ...
            if (result.isEmpty()) {
                ...
                LOGGER.error(
                    "An invalid result was returned when parsing Bib(La)Tex entries."
                );
                executing.set(false);
                return;
            }

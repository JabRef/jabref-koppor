    ...
    private void createMenu() {
        ...
        file
            ...
            .addAll(
                ...
                factory.createSubMenu(
                    StandardActions.GIT,
                    factory.createMenuItem(
                        StandardActions.GIT_COMMIT,
                        new GitCommitAction(dialogService, stateManager)
                    ),
                    factory.createMenuItem(
                        StandardActions.GIT_PULL,
                        new GitPullAction(
                            dialogService,
                            stateManager,
                            preferences,
        ...
        edit
            ...
            .addAll(
                ...
                RightClickMenu.createCopySubMenu(
                    factory,
                    dialogService,
                    stateManager,
                    preferences,
        ...
        edit.addEventHandler(ActionEvent.ACTION, event -> {
            ...
            boolean isStageUnfocused = !Injector.instantiateModelOrService(
                Stage.class
            )
                .focusedProperty()
                .get();
        ...
        library
            ...
            .addAll(
                factory.createMenuItem(
                    StandardActions.ADD_ENTRY_IMMEDIATE,
                    new NewEntryAction(
                        true,
                        frame::getCurrentLibraryTab,
                        dialogService,
                ...
                factory.createMenuItem(
                    StandardActions.ADD_ENTRY_IDENTIFIER,
                    new NewEntryAction(
                        NewEntryDialogTab.ENTER_IDENTIFIER,
                        frame::getCurrentLibraryTab,
                        dialogService,
                        preferences,
                        stateManager
                ...
                factory.createMenuItem(
                    StandardActions.ADD_ENTRY_PLAINTEXT,
                    new NewEntryAction(
                        NewEntryDialogTab.INTERPRET_CITATIONS,
                        frame::getCurrentLibraryTab,
                        dialogService,
                        preferences,
                        stateManager
                ...
                factory.createMenuItem(
                    ...
                    new JabRefFrame.OpenDatabaseFolder(
                        dialogService,
                        stateManager,
                        preferences,
        ...
        quality
            ...
            .addAll(
                ...
                factory.createMenuItem(
                    StandardActions.CHECK_CONSISTENCY,
                    new ConsistencyCheckAction(
                        frame::getCurrentLibraryTab,
                        dialogService,
                        stateManager,
                        preferences,
                ...
                factory.createSubMenu(
                    ...
                    factory.createMenuItem(
                        StandardActions.ABBREVIATE_LTWA,
                        new AbbreviateAction(
                            StandardActions.ABBREVIATE_LTWA,
                            frame::getCurrentLibraryTab,
                            dialogService,
        ...
        Menu lookupIdentifiers = factory.createSubMenu(
        ...
        final MenuItem pushToApplicationMenuItem = factory.createMenuItem(
        ...
        tools
            ...
            .addAll(
                factory.createMenuItem(
                    StandardActions.PARSE_LATEX,
                    new ParseLatexAction(stateManager)
                ),
                factory.createMenuItem(
                ...
                ), // we know at this point that this is a UITaskExecutor
                new SeparatorMenuItem(),
                createSendSubMenu(
                    factory,
                    dialogService,
        ...
        help
            ...
            .addAll(
                ...
                new SeparatorMenuItem(),
                factory.createMenuItem(
                    StandardActions.OPEN_WELCOME_TAB,
                    new SimpleCommand() {
                        @Override
                        public void execute() {
                ...
                new SeparatorMenuItem(),
                factory.createMenuItem(
                    StandardActions.ABOUT,
                    new AboutAction(dialogService)
                )
            );

...
public class ModifyCSLBibliographyPropertiesDialogView
    ...
    public ModifyCSLBibliographyPropertiesDialogView(
        OpenOfficePreferences openOfficePreferences
    ) {
        this.viewModel = new ModifyCSLBibliographyPropertiesDialogViewModel(
    ...
    public void initialize() {
        titleField
            .textProperty()
            .bindBidirectional(viewModel.cslBibliographyTitleProperty());
        ...
        headerFormats
            .itemsProperty()
            .bind(viewModel.headerFormatListProperty());
        headerFormats
            .valueProperty()
            .bindBidirectional(
                viewModel.cslBibliographySelectedHeaderFormatProperty()
            );
        ...
        bodyFormats
            .valueProperty()
            .bindBidirectional(
                viewModel.cslBibliographySelectedBodyFormatProperty()
            );
    }
}

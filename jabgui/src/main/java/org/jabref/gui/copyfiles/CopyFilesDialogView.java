...
public class CopyFilesDialogView extends BaseDialog<Void> {
    ...
    private void setupTable() {
        ...
        colFile.setCellFactory(new ValueTableCellFactory<CopyFilesResultItemViewModel, String>().withText(item -> item)
            .withTooltip(item -> item));
        colStatus
            .setCellFactory(new ValueTableCellFactory<CopyFilesResultItemViewModel, JabRefIcon>().withGraphic(item -> {

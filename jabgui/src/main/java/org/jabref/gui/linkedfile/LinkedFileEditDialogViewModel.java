...
public class LinkedFileEditDialogViewModel extends AbstractViewModel {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(
        LinkedFileEditDialogViewModel.class
    );
    ...
    public LinkedFileEditDialogViewModel(
        ...
        monadicSelectedExternalFileType = EasyBind.wrapNullable(
    ...
    public void openBrowseDialog() {
        ...
        dialogService
            ...
            .ifPresent(this::checkForBadFileNameAndAdd);
    }

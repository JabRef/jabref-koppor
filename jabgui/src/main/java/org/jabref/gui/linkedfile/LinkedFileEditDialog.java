...
public class LinkedFileEditDialog extends BaseDialog<LinkedFile> {
    ...
    private static final ButtonType ADD_BUTTON = new ButtonType(
    ...
    private void initializeDialog(String title, ButtonType primaryButtonType) {
        ...
        this.getDialogPane()
            .getButtonTypes()
            .setAll(ButtonType.CANCEL, primaryButtonType);
    ...
    private void initialize() {
        viewModel = new LinkedFileEditDialogViewModel(
            linkedFile,
        ...
        sourceUrl
            .textProperty()
            .bindBidirectional(viewModel.sourceUrlProperty());

...
public class ActionHelper {
    ...
    public static BooleanExpression needsSavedLocalDatabase(
    ...
    public static BooleanExpression needsMultipleDatabases(
        StateManager stateManager
    ) {
    ...
    public static BooleanExpression hasLinkedFileForSelectedEntries(
        ...
        return BooleanExpression.booleanExpression(
            EasyBind.reduce(stateManager.getSelectedEntries(), entries ->
                entries.anyMatch(entry -> !entry.getFiles().isEmpty())
            )
        );
    }

    public static BooleanExpression needsGitRemoteConfigured(
        StateManager stateManager
    ) {
        return BooleanExpression.booleanExpression(
            EasyBind.map(

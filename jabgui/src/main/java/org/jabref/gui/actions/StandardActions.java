...
public enum StandardActions implements Action {
    ...
    BATCH_MERGE_WITH_FETCHED_ENTRY(
        Localization.lang(
            "Get bibliographic data from %0 (fully automated)",
            "DOI/ISBN/..."
        )
    ),
    ATTACH_FILE(
    ...
    NEW_LIBRARY_FROM_PDF_ONLINE(
        Localization.lang(
            "New library based on references in PDF file... (online)"
        ),
        Localization.lang(
    ...
    NEW_LIBRARY_FROM_PDF_OFFLINE(
        Localization.lang(
            "New library based on references in PDF file... (offline)"
        ),
        Localization.lang(
    ...
    ABBREVIATE_LTWA(
        Localization.lang("LTWA"),
        Localization.lang(
            "Abbreviate journal names of the selected entries (LTWA)"
        )
    ),
    UNABBREVIATE(
    ...
    CUSTOMIZE_KEYBINDING(
        Localization.lang("Customize keyboard shortcuts"),
    ...
    ADD_ENTRY_IMMEDIATE(
        Localization.lang("Add entry"),
        IconTheme.JabRefIcons.ADD_ENTRY_IMMEDIATE
    ),
    ADD_ENTRY(
        Localization.lang("Add entry using..."),
        IconTheme.JabRefIcons.ADD_ENTRY,
        KeyBinding.ADD_ENTRY
    ),
    ADD_ENTRY_IDENTIFIER(
        Localization.lang("Enter identifier..."),
        IconTheme.JabRefIcons.ADD_ENTRY_IDENTIFIER,
        KeyBinding.ADD_ENTRY_IDENTIFIER
    ),
    ADD_ENTRY_PLAINTEXT(
        Localization.lang("Interpret citations..."),
        IconTheme.JabRefIcons.ADD_ENTRY_PLAINTEXT,
    ...
    LOOKUP_DOC_IDENTIFIER(
        ...
        KeyBinding.LOOKUP_DOC_IDENTIFIER
    ),
    LOOKUP_FULLTEXT(
    ...
    REDOWNLOAD_FILE(
        Localization.lang("Redownload file"),
        IconTheme.JabRefIcons.DOWNLOAD_FILE
    ),
    ...
    RENAME_FILE_TO_NAME(
        Localization.lang("Rename files to configured filename format pattern"),
    ...
    REMOVE_LINKS(
        Localization.lang("Remove links"),
        IconTheme.JabRefIcons.REMOVE_LINK
    ),
    DELETE_FILE(
    ...
    HELP_GROUPS(
        Localization.lang("Open Help page"),
        IconTheme.JabRefIcons.HELP,
        KeyBinding.HELP
    ),
    HELP_KEY_PATTERNS(
    ...
    OPEN_LINKEDIN(
        "LinkedIn",
        Localization.lang("Opens JabRef's LinkedIn page"),
        IconTheme.JabRefIcons.LINKEDIN
    ),
    OPEN_MASTODON(
        "Mastodon",
        Localization.lang("Opens JabRef's Mastodon page"),
        IconTheme.JabRefIcons.MASTODON
    ),
    OPEN_PRIVACY_POLICY(
        "Privacy policy",
        Localization.lang("Opens JabRef's privacy policy"),
    ...
    GROUP_GENERATE_SUMMARIES(
        Localization.lang("Generate summaries for entries in the group")
    ),
    GROUP_GENERATE_EMBEDDINGS(
        Localization.lang("Generate embeddings for linked files in the group")
    ),
    GROUP_SUGGESTED_GROUPS_ADD(
        Localization.lang("Add JabRef suggested groups")
    ),
    ...
    GROUP_SUBGROUP_RENAME(
        Localization.lang("Rename subgroup"),
        KeyBinding.GROUP_SUBGROUP_RENAME
    ),

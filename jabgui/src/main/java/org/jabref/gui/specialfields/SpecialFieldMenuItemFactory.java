...
public class SpecialFieldMenuItemFactory {
    ...
    public static MenuItem getSpecialFieldSingleItem(SpecialField field, ActionFactory factory,
            Supplier<LibraryTab> tabSupplier, DialogService dialogService, GuiPreferences preferences,
    ...
    public static Menu createSpecialFieldMenu(SpecialField field, ActionFactory factory,
            Supplier<LibraryTab> tabSupplier, DialogService dialogService, GuiPreferences preferences,
            UndoManager undoManager, StateManager stateManager) {

        return createSpecialFieldMenu(field, factory, preferences, undoManager,
                specialField -> new SpecialFieldViewModel(field, preferences, undoManager)
                    .getSpecialFieldAction(specialField.getValue(), tabSupplier, dialogService, stateManager));
    }

    public static Menu createSpecialFieldMenu(SpecialField field, ActionFactory factory, GuiPreferences preferences,
            UndoManager undoManager, Function<SpecialFieldValueViewModel, Command> commandFactory) {

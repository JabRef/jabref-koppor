...
public class ContentSelectorViewModel implements PropertiesTabViewModel {
    ...
    public void setValues() {
        ...
        fieldKeywordsMap = ContentSelectors.getFieldKeywordsMap(
        ...
        if (fields.isEmpty()) {
            ContentSelectors.DEFAULT_FIELD_NAMES.forEach(
                this::addFieldIfUnique
            );
        }
    }
    ...
    public void storeSettings() {
        ...
        if (ContentSelectors.isDefaultMap(fieldKeywordsMap)) {
            ...
            fieldNamesToRemove = metaData
                .getContentSelectorsSorted()
                .stream()

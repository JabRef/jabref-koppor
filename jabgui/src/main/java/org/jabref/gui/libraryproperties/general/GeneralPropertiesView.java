...
public class GeneralPropertiesView extends AbstractPropertiesTabView<GeneralPropertiesViewModel> {
    ...
    private final String switchToRelativeText = Localization
        .lang("Switch to relative path: converts the path to a relative path.");

    private final String switchToAbsoluteText = Localization
        .lang("Switch to absolute path: converts the path to an absolute path.");
    ...
    public void initialize() {
        ...
        userSpecificFileDirectoryTooltip.setText(Localization.lang("User-specific file directory: %0",
        ...
        librarySpecificFileDirectory.textProperty().addListener((_, _, newValue) -> {
            ...
            librarySpecificFileDirectoryTooltip
                .setText(newValue.trim().isEmpty() ? Localization.lang("Library-specific file directory")
        ...
        latexFileDirectory.textProperty().addListener((_, _, newValue) -> {
            ...
            latexFileDirectoryTooltip.setText(newValue.trim().isEmpty() ? Localization.lang("LaTeX file directory")
                    : Localization.lang("LaTeX file directory: %0", newValue));
        });

        Platform.runLater(() -> {
            librarySpecificFileDirectoryValidationVisualizer
            ...
            latexFileDirectoryValidationVisualizer.initVisualization(viewModel.laTexFileDirectoryStatus(),
                    latexFileDirectory);

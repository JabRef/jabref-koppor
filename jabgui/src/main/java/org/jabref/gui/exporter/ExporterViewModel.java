...
/**
 * ExporterViewModel wraps a TemplateExporter from logic and is used in the exporter
 * customization dialog view and ViewModel.
 */
...
public class ExporterViewModel {
    ...
    public ExporterViewModel(TemplateExporter exporter) {
        ...
        // Only the first of the extensions gotten from FileType is saved into the class
        // using get(0)

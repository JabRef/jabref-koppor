...
public abstract class ThreeWayMergeCell extends HBox {
    ...
    public ThreeWayMergeCell(String text, int rowIndex) {
        ...
        EasyBind.subscribe(viewModel.oddProperty(),
                isOdd -> pseudoClassStateChanged(PseudoClass.getPseudoClass(ODD_PSEUDO_CLASS), isOdd));
        EasyBind.subscribe(viewModel.evenProperty(),
                isEven -> pseudoClassStateChanged(PseudoClass.getPseudoClass(EVEN_PSEUDO_CLASS), isEven));
    }

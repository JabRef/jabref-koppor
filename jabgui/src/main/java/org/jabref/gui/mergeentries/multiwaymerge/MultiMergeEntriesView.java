...
public class MultiMergeEntriesView extends BaseDialog<BibEntry> {
    ...
    private void fillDiffModes() {
        ...
        new ViewModelListCellFactory<DiffMode>()
            ...
            .install(diffMode);
        diffMode.setValue(
            preferences.getMergeDialogPreferences().getMergeDiffMode()
        );
        EasyBind.subscribe(this.diffMode.valueProperty(), mode ->
            preferences.getMergeDialogPreferences().setMergeDiffMode(mode)
        );
    }
    ...
    private class FieldRow {
        ...
        public FieldRow(Field field, int rowIndex) {
            ...
            fieldEditorCell.addEventFilter(KeyEvent.KEY_PRESSED, event ->

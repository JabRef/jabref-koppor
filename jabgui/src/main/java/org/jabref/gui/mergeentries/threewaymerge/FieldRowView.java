...
public class FieldRowView {
    ...
    public FieldRowView(
        ...
        viewModel = new FieldRowViewModel(
            field,
            leftEntry,
            rightEntry,
            mergedEntry,
        ...
        leftValueCell = new FieldValueCell(
            viewModel.getLeftFieldValue(),
            rowIndex,
            preferences
        );
        rightValueCell = new FieldValueCell(
            viewModel.getRightFieldValue(),
            rowIndex,
            preferences
        );
        mergedValueCell = new MergedFieldCell(
            viewModel.getMergedFieldValue(),
            rowIndex
        );
        ...
        if (FieldMergerFactory.canMerge(field)) {
            ...
            EasyBind.listen(
                ...
                (observableValue, old, fieldState) -> {
                    ...
                    if (
                        fieldState == ToggleMergeUnmergeButton.FieldState.MERGED
                    ) {

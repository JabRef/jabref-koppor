...
public enum ConsistencySymbol {
    REQUIRED_FIELD_AT_ENTRY_TYPE_CELL_ENTRY(
        "x",
        IconTheme.JabRefIcons.CONSISTENCY_REQUIRED_FIELD
    ),
    OPTIONAL_FIELD_AT_ENTRY_TYPE_CELL_ENTRY(
        "o",
        IconTheme.JabRefIcons.CONSISTENCY_OPTIONAL_FIELD
    ),
    UNKNOWN_FIELD_AT_ENTRY_TYPE_CELL_ENTRY(
        "?",
        IconTheme.JabRefIcons.CONSISTENCY_UNKNOWN_FIELD
    ),
    UNSET_FIELD_AT_ENTRY_TYPE_CELL_ENTRY(
        "-",
        IconTheme.JabRefIcons.CONSISTENCY_UNSET_FIELD
    );

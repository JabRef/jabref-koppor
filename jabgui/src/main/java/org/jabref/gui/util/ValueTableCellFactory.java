...
public class ValueTableCellFactory<S, T>
    ...
    public ValueTableCellFactory<S, T> graphicTooltip(
        BiFunction<S, T, Tooltip> tooltip
    ) {
    ...
    public ValueTableCellFactory<S, T> withOnMouseClickedEvent(
        ...
        this.toOnMouseClickedEvent = (rowItem, value) ->
            toOnMouseClickedEvent.apply(value);
        return this;
    }

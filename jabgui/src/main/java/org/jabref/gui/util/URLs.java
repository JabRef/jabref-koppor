...
public class URLs {
    ...
    public static final String DEV_VERSION_LINK_URL =
    ...
    // Quick Settings URLs
    public static final String FILE_LINKS_DOC =
        "https://docs.jabref.org/finding-sorting-and-cleaning-entries/filelinks";
    public static final String CUSTOM_THEME_DOC =
        "https://docs.jabref.org/advanced/custom-themes";
    public static final String PERFORMANCE_DOC =
        "https://docs.jabref.org/faq#q-i-have-a-huge-library.-what-can-i-do-to-mitigate-performance-issues";
    public static final String PUSH_TO_APPLICATIONS_DOC =
        "https://docs.jabref.org/cite/pushtoapplications";
    public static final String ONLINE_SERVICES_DOC =
        "https://docs.jabref.org/collect/import-using-online-bibliographic-database";
    public static final String GROBID_DOC =
        "https://docs.jabref.org/collect/newentryfromplaintext#grobid";
    public static final String ENTRY_TABLE_COLUMNS_DOC =
        "https://docs.jabref.org/advanced/main-window";

    // Walkthroughs URLs
    public static final String GROUPS_DOC =
        "https://docs.jabref.org/finding-sorting-and-cleaning-entries/groups";
    public static final String SEARCH_WITH_IN_LIBRARY_DOC =
        "https://docs.jabref.org/finding-sorting-and-cleaning-entries/search";
    public static final String MANAGE_ASSOCIATED_FILES_DOC =
        "https://docs.jabref.org/finding-sorting-and-cleaning-entries/filelinks";
    public static final String LINK_EXTERNAL_FILE_WALKTHROUGH_EXAMPLE_PDF =
        "https://nutritionandmetabolism.biomedcentral.com/counter/pdf/10.1186/1743-7075-3-2.pdf";
    public static final String ADD_PDF_DOC =
        "https://docs.jabref.org/collect/add-pdfs-to-an-entry";
    public static final String FIND_UNLINKED_FILES_DOC =
        "https://docs.jabref.org/collect/findunlinkedfiles";

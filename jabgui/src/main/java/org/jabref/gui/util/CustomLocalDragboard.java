...
/**
 * Placeholder class for a custom generic type safe dragboard to be used in drag and drop,
 * does not depend on serialization Don't use this class directly. Use the instance
 * provided in {@link StateManager#getLocalDragboard()}
 */
public class CustomLocalDragboard {
    ...
    /**
     * Puts the value of the concrete class in a map. All previous content stored in the
     * map is removed

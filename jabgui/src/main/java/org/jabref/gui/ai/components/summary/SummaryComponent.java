...
public class SummaryComponent extends AiPrivacyNoticeGuardedComponent {
    ...
    public SummaryComponent(
        ...
        this.entry = entry;
        this.citationKeyGenerator = new CitationKeyGenerator(
            bibDatabaseContext,
    ...
    private Node tryToShowSummary() {
        ProcessingInfo<BibEntry, Summary> processingInfo = aiService
            .getSummariesService()
            .summarize(entry, bibDatabaseContext);
    ...
    private Node showErrorWhileSummarizing(
        ...
        return ErrorStateComponent.withTextAreaAndButton(
            ...
            () ->
                aiService
                    .getSummariesService()
                    .regenerateSummary(entry, bibDatabaseContext)
        );
    }

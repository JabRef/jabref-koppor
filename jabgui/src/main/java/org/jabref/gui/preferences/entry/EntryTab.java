...
public class EntryTab
    ...
    public void initialize() {
        ...
        resolvableTagsField
            .tagsProperty()
            .bindBidirectional(viewModel.resolvableTagsFieldProperty());
        nonWrappableTagsField
            .tagsProperty()
            .bindBidirectional(viewModel.nonWrappableTagsFieldProperty());
    ...
    private Node createTag(TagsField<Field> tagsField, Field field) {
        ...
        tagLabel
            .getGraphic()
            .setOnMouseClicked(event -> tagsField.removeTags(field));

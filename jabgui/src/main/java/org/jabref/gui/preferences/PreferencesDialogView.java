...
public class PreferencesDialogView
    ...
    public static final String DIALOG_TITLE = Localization.lang(
        "JabRef preferences"
    );
    ...
    public PreferencesDialogView(
        ...
        ControlHelper.setAction(saveButton, getDialogPane(), event ->
    ...
    private void initialize() {
        ...
        if (this.preferencesTabToSelectClass != null) {
            Optional<PreferencesTab> tabToSelectIfExist = preferenceTabList
                .getItems()
                .stream()
                .filter(prefTab ->
                ...
                .findFirst();
            tabToSelectIfExist.ifPresent(preferencesTab ->
                preferenceTabList.getSelectionModel().select(preferencesTab)
            );
        } else {
            preferenceTabList.getSelectionModel().selectFirst();
        }

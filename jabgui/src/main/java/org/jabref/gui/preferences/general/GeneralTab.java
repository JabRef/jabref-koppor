...
public class GeneralTab
    ...
    @FXML
    private CheckBox donationNeverShow;
    ...
    @FXML
    private CheckBox enableLanguageServer;

    @FXML
    private TextField languageServerPort;
    ...
    private final TextFormatter<Integer> fontSizeFormatter =
        new TextFormatter<>(new IntegerStringConverter(), 9, c -> {
    ...
    public void initialize() {
        ...
        shouldAskForIncludingCrossReferences
            .selectedProperty()
            .bindBidirectional(
                viewModel.shouldAskForIncludingCrossReferences()
            );
        confirmHideTabBar
            .selectedProperty()
            .bindBidirectional(viewModel.confirmHideTabBarProperty());
        donationNeverShow
            .selectedProperty()
            .bindBidirectional(viewModel.donationNeverShowProperty());
        ...
        Platform.runLater(() -> {
            ...
            validationVisualizer.initVisualization(
                viewModel.httpPortValidationStatus(),
                httpServerPort
            );
            validationVisualizer.initVisualization(
                viewModel.languageServerPortValidationStatus(),
                languageServerPort
            );
            validationVisualizer.initVisualization(
        ...
        enableHttpServer
            .selectedProperty()
            .bindBidirectional(viewModel.enableHttpServerProperty());
        httpServerPort
            .textProperty()
            .bindBidirectional(viewModel.httpPortProperty());
        httpServerPort
            .disableProperty()
            .bind(enableHttpServer.selectedProperty().not());

        enableLanguageServer
            .selectedProperty()
            .bindBidirectional(viewModel.enableLanguageServerProperty());
        languageServerPort
            .textProperty()
            .bindBidirectional(viewModel.languageServerPortProperty());
        languageServerPort
            .disableProperty()
            .bind(enableLanguageServer.selectedProperty().not());
    }

...
public class NewProtectedTermsFileDialog extends BaseDialog<Void> {
    ...
    public NewProtectedTermsFileDialog(List<ProtectedTermsListItemModel> termsLists, DialogService dialogService,
        ...
        VBox container = new VBox(10, new VBox(5, new Label(Localization.lang("Description")), newDescription),
        ...
        setResultConverter(button -> {
            if (button == ButtonType.OK) {
                ProtectedTermsList newList = new ProtectedTermsList(newDescription.getText(), new ArrayList<>(),
                        newFile.getText(), false);

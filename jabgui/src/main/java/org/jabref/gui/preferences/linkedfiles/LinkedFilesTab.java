...
public class LinkedFilesTab
    ...
    @FXML
    private CheckBox autoRenameFilesOnChange;
    ...
    public void initialize() {
        ...
        moveToTrash
            .selectedProperty()
            .bindBidirectional(viewModel.moveToTrashProperty());
        ...
        autoRenameFilesOnChange
            .selectedProperty()
            .bindBidirectional(viewModel.autoRenameFilesOnChangeProperty());
        fileNamePattern
            .valueProperty()
        ...
        openFileExplorerInFilesDirectory
            .selectedProperty()
            .bindBidirectional(
                viewModel.openFileExplorerInFilesDirectoryProperty()
            );
        openFileExplorerInLastDirectory
            .selectedProperty()
            .bindBidirectional(

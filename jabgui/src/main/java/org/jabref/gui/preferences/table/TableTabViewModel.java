...
public class TableTabViewModel implements PreferenceTabViewModel {
    ...
    private void insertSpecialFieldColumns() {
        EnumSet.allOf(SpecialField.class)
            ...
            .forEach(item ->
                availableColumnsProperty.getValue().addFirst(item)
            );
    }
    ...
    private void removeSpecialFieldColumns() {
        columnsListProperty
            ...
            .removeIf(
                column ->
                    column.getType() == MainTableColumnModel.Type.SPECIALFIELD
            );
    ...
    private void removeExtraFileColumns() {
        columnsListProperty
            ...
            .removeIf(
                column ->
                    column.getType() == MainTableColumnModel.Type.EXTRAFILE
            );
        availableColumnsProperty
            .getValue()
            .removeIf(

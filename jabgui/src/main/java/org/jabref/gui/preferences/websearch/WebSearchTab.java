...
public class WebSearchTab
    ...
    private Node createFetcherNode(
        WebSearchTabViewModel.FetcherViewModel item
    ) {
    ...
    private void showApiKeyDialog(
        WebSearchTabViewModel.FetcherViewModel fetcherViewModel
    ) {
        dialogService.showCustomDialogAndWait(
            new ApiKeyDialog(viewModel, fetcherViewModel)
        );
    }
}

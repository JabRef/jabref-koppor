...
public class AutoCompletionTab
    ...
    public void initialize() {
        viewModel = new AutoCompletionTabViewModel(
    ...
    private void setupTagsFiled() {
        autoCompleteFields.setCellFactory(
            new ViewModelListCellFactory<Field>().withText(
                Field::getDisplayName
            )
        );
        autoCompleteFields.setSuggestionProvider(request ->
        ...
        autoCompleteFields.setOnMouseClicked(event ->
            autoCompleteFields.getEditor().requestFocus()
        );
    ...
    private Node createTag(Field field) {
        ...
        tagLabel
            .getGraphic()
            .setOnMouseClicked(event -> autoCompleteFields.removeTags(field));

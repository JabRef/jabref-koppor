...
public class ErrorConsoleView extends BaseDialog<Void> {
    ...
    public ErrorConsoleView() {
        ...
        ControlHelper.setAction(copyLogButton, getDialogPane(), event ->
            copyLog()
        );
        ControlHelper.setAction(clearLogButton, getDialogPane(), event ->
            clearLog()
        );
        ControlHelper.setAction(createIssueButton, getDialogPane(), event ->
            createIssue()
        );
    }
    ...
    private void initialize() {
        viewModel = new ErrorConsoleViewModel(
            dialogService,
            preferences,
            clipBoardManager,
            buildInfo
        ...
        return cell ->
            new ListCell<>() {
                ...
                private ContextMenu createContextMenu(
                    LogEventViewModel selectedLogEntry
                ) {

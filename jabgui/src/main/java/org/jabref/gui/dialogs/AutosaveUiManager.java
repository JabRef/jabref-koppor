...
/**
 * This class has an abstract UI role as it listens for an {@link AutosaveEvent} and saves
 * the bib file associated with the given {@link LibraryTab}.
 */
public class AutosaveUiManager {
    ...
    public AutosaveUiManager(LibraryTab libraryTab, DialogService dialogService, GuiPreferences preferences,

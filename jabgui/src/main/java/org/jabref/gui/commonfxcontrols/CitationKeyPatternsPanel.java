...
public class CitationKeyPatternsPanel
    ...
    @FXML
    public TableColumn<
        CitationKeyPatternsPanelItemModel,
        EntryType
    > entryTypeColumn;
    ...
    public CitationKeyPatternsPanel() {
        ...
        this.patterns = FXCollections.observableArrayList(
            CitationKeyPattern.getAllPatterns()
                .stream()
    ...
    private void initialize() {
        ...
        patternColumn.setCellFactory(_ ->
            new CitationKeyPatternSuggestionCell(patterns)
        );
        ...
        patternColumn.setOnEditCommit(
            (TableColumn.CellEditEvent<
                CitationKeyPatternsPanelItemModel,
                String
            > event) -> event.getRowValue().setPattern(event.getNewValue())
        );
        ...
        >()
            ...
            .withTooltip(entryType ->
                Localization.lang("Reset %s to default value").formatted(
    ...
    public void setValues(
        ...
        AbstractCitationKeyPatterns keyPattern
    ) {
    ...
    private static class HighlightTableRow
        ...
        public void updateItem(
            CitationKeyPatternsPanelItemModel item,
            boolean empty
        ) {
            ...
            if (item == null || item.getEntryType() == null) {
                ...
                CitationKeyPatternsPanelViewModel.ENTRY_TYPE_DEFAULT_NAME.equals(
                    item.getEntryType().getName()
                )
            ) {

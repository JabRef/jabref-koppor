...
public class GroupsSidePaneComponent extends SidePaneComponent {
    ...
    private final ToggleButton filterToggle =
        IconTheme.JabRefIcons.FILTER.asToggleButton();
    private final ToggleButton invertToggle =
        IconTheme.JabRefIcons.INVERT.asToggleButton();
        ...
        groupsPreferences
            ...
            .addListener(
                (SetChangeListener<GroupViewMode>) change -> {
                    GroupModeViewModel modeViewModel = new GroupModeViewModel(
    ...
    private void setupFilterToggle() {
        ...
        filterToggle.setTooltip(
            new Tooltip(Localization.lang("Filter by groups"))
        );
    ...
    private void setupInvertToggle() {
        ...
        invertToggle.setTooltip(
            new Tooltip(Localization.lang("Invert groups"))
        );

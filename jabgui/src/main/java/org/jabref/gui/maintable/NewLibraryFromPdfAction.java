...
/**
 * Similar to {@link ExtractReferencesAction}. This action creates a new library, the
 * other action "just" appends to the current library
 *
 * <ul>
...
public abstract class NewLibraryFromPdfAction extends SimpleCommand {
    ...
    public NewLibraryFromPdfAction(LibraryTabContainer libraryTabContainer, StateManager stateManager,
    ...
    public void execute() {
        ...
        // Sensible default for the directory to start browsing is the directory of the
        // currently opened library. The pdf storage dir seems not to be feasible, because
        // extracting references from a PDF itself can be done by the context menu of the
        // respective entry.

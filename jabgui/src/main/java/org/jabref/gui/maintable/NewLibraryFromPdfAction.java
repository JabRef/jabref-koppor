...
public abstract class NewLibraryFromPdfAction extends SimpleCommand {
    ...
    @Override
    public void execute() {
        final FileDialogConfiguration.Builder builder =
        ...
        LOGGER.trace(
            "Opening file dialog with configuration: {}",
    ...
    protected abstract Callable<ParserResult> getParserResultCallable(
        Path path
    );
}

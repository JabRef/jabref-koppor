...
public class RightClickMenu {
    ...
    public static ContextMenu create(
        ...
        ExtractReferencesAction extractReferencesAction =
            new ExtractReferencesAction(
                dialogService,
                stateManager,
                preferences
            );
        // Two menu items required, because of menu item display. Action checks preference internal what to do
        MenuItem extractFileReferencesOnline = factory.createMenuItem(
            StandardActions.EXTRACT_FILE_REFERENCES_ONLINE,
            extractReferencesAction
        );
        MenuItem extractFileReferencesOffline = factory.createMenuItem(
            StandardActions.EXTRACT_FILE_REFERENCES_OFFLINE,
            extractReferencesAction
        );
        ...
        contextMenu
            ...
            .addAll(
                ...
                factory.createMenuItem(
                    StandardActions.LOOKUP_DOC_IDENTIFIER,
    ...
    private static Menu createCopyToMenu(
        ...
        copyToMenu
            .disableProperty()
            .bind(ActionHelper.needsMultipleDatabases(stateManager).not());
        ...
        for (BibDatabaseContext targetDatabaseContext : stateManager.getOpenDatabases()) {
            ...
            if (targetDatabaseContext.getDatabasePath().isPresent()) {
                ...
                targetDatabaseContext.getLocation() == DatabaseLocation.SHARED
            ) {
                targetDatabaseName =
                    targetDatabaseContext.getDBMSSynchronizer().getDBName()
                    + " ["
    ...
    public static Menu createCopySubMenu(
        ActionFactory factory,
        DialogService dialogService,
        StateManager stateManager,
        GuiPreferences preferences,
        ...
        copySpecialMenu
            ...
            .addAll(
                ...
                new SeparatorMenuItem(),
                factory.createMenuItem(
                    StandardActions.COPY_CITATION_KEY,
                    new CopyMoreAction(
                        StandardActions.COPY_CITATION_KEY,
                        dialogService,
                        stateManager,
                ...
                factory.createMenuItem(
                    StandardActions.COPY_AS_CITE_COMMAND,
                    new CopyMoreAction(
                        StandardActions.COPY_AS_CITE_COMMAND,
                        dialogService,
                        stateManager,
                ...
                factory.createMenuItem(
                    StandardActions.COPY_CITATION_KEY_AND_TITLE,
                    new CopyMoreAction(
                        StandardActions.COPY_CITATION_KEY_AND_TITLE,
                        dialogService,
                        stateManager,
                ...
                factory.createMenuItem(
                    StandardActions.COPY_CITATION_KEY_AND_LINK,
                    new CopyMoreAction(
                        StandardActions.COPY_CITATION_KEY_AND_LINK,
                        dialogService,
                        stateManager,
        ...
        if (
            ...
            copySpecialMenu
                ...
                .addAll(
                    ...
                    factory.createMenuItem(
                        StandardActions.COPY_CITATION_MARKDOWN,
                        new CopyCitationAction(
    ...
    static Menu createCopyFieldContentSubMenu(
        ActionFactory factory,
        DialogService dialogService,
        StateManager stateManager,
        ClipBoardManager clipBoardManager,
        ...
        Menu copyFieldContentMenu = factory.createMenu(
            StandardActions.COPY_FIELD_CONTENT
        );

        copyFieldContentMenu
            .getItems()
            .addAll(
                factory.createMenuItem(
                    StandardActions.COPY_FIELD_AUTHOR,
                    new CopyMoreAction(
                        StandardActions.COPY_FIELD_AUTHOR,
                        dialogService,
                        stateManager,
                ...
                factory.createMenuItem(
                    StandardActions.COPY_FIELD_TITLE,
                    new CopyMoreAction(
                        StandardActions.COPY_FIELD_TITLE,
                        dialogService,
                        stateManager,
                ...
                factory.createMenuItem(
                    StandardActions.COPY_FIELD_JOURNAL,
                    new CopyMoreAction(
                        StandardActions.COPY_FIELD_JOURNAL,
                        dialogService,
                        stateManager,
                ...
                factory.createMenuItem(
                    StandardActions.COPY_FIELD_DATE,
                    new CopyMoreAction(
                        StandardActions.COPY_FIELD_DATE,
                        dialogService,
                        stateManager,
                ...
                factory.createMenuItem(
                    StandardActions.COPY_FIELD_KEYWORDS,
                    new CopyMoreAction(
                        StandardActions.COPY_FIELD_KEYWORDS,
                        dialogService,
                        stateManager,
                ...
                factory.createMenuItem(
                    StandardActions.COPY_FIELD_ABSTRACT,
                    new CopyMoreAction(
                        StandardActions.COPY_FIELD_ABSTRACT,
                        dialogService,
                        stateManager,

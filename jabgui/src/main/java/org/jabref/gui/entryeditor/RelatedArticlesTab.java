...
public class RelatedArticlesTab extends EntryEditorTab {
    ...
    private ScrollPane getPrivacyDialog(BibEntry entry) {
        ...
        Button hideTab = new Button(
            Localization.lang("Hide 'Related articles' tab")
        );
        ...
        hideTab.setOnAction(event -> {
            preferences
                ...
                .setShouldShowRecommendationsTab(false);
            dialogService.showWarningDialogAndWait(
                Localization.lang("Restart"),
                Localization.lang(
                    "Please restart JabRef for preferences to take effect."
        ...
        vbox
            .getChildren()
            .addAll(title, line1, line2, mdlLink, line3, vb, hbox);

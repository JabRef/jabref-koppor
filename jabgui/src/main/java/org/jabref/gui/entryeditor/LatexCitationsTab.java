...
public class LatexCitationsTab extends EntryEditorTab {
    ...
    private void setSearchPane() {
        ...
        citationsDisplay.setOnMouseClicked(event ->
            viewModel.handleMouseClick(event, citationsDisplay)
        );
    ...
    private HBox getLatexDirectoryBox() {
        ...
        latexDirectoryPath
            .textProperty()
            .bind(viewModel.directoryProperty().asString());
        ...
        latexDirectoryButton.setOnAction(event ->
            viewModel.setLatexDirectory()
        );
    ...
    protected void bindToEntry(BibEntry entry) {
        if (stateManager.activeTabProperty().get().isPresent()) {
            LibraryTab libraryTab = stateManager
                .activeTabProperty()
                .get()
                .get();

...
public record TooltipStep(
    ...
    public static class Builder {
        ...
        public Builder activeWindow(
            @NonNull WindowResolver activeWindowResolver
        ) {
        ...
        public Builder quitButtonPosition(
            @NonNull QuitButtonPosition quitButtonPosition
        ) {
        ...
        public TooltipStep build() {
            if (resolver == null) {
                throw new IllegalStateException(
                    "Node resolver is required for TooltipStep"
                );
            }
            return new TooltipStep(
                title,
                content,
                resolver,
                continueButtonText,

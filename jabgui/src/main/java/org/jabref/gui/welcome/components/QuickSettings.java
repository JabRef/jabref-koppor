...
public class QuickSettings extends VBox {
    ...
    private void showThemeDialog() {
        dialogService.showCustomDialogAndWait(
            new ThemeDialog(preferences, dialogService, themeManager)
        );
    }
    ...
    private void showLargeLibraryOptimizationDialog() {
        dialogService.showCustomDialogAndWait(
            new LargeLibraryOptimizationDialog(preferences, themeManager)
        );
    }
    ...
    private void showOnlineServicesConfigurationDialog() {
        dialogService.showCustomDialogAndWait(
            new OnlineServicesDialog(preferences, themeManager)
        );
    }
    ...
    private void showEntryTableConfigurationDialog() {
        dialogService.showCustomDialogAndWait(
            new EntryTableConfigurationDialog(preferences, themeManager)
        );
    }
}

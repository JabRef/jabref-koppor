...
public class PushToApplicationCell extends ListCell<GuiPushToApplication> {
    ...
    public static final String DETECTED_APPLICATION_STYLE_CLASS =
        "detected-application";

    private final ObservableSet<GuiPushToApplication> detectedApplications;

    public PushToApplicationCell(
        ObservableSet<GuiPushToApplication> detectedApplications
    ) {
    ...
    private void updateDetectionStyle() {
        ...
        boolean isDetected =
            item != null && detectedApplications.contains(item);

...
public class OnlineServicesDialog extends FXDialog {
    ...
    private void initialize() {
        ...
        webSearchBox
            .selectedProperty()
            .bindBidirectional(viewModel.webSearchProperty());
        grobidCheckBox
            .selectedProperty()
        ...
        dlibCheckBox
            .selectedProperty()
            .bindBidirectional(viewModel.dlibEnabledProperty());

        grobidUrlContainer
            .visibleProperty()
            .bind(grobidCheckBox.selectedProperty());
        grobidUrlContainer
            .managedProperty()
            .bind(grobidCheckBox.selectedProperty());
    ...
    private void populateFetchers() {
        for (StudyCatalogItem fetcher : viewModel.fetchersProperty()) {
            ...
            fetcherCheckBox
                .selectedProperty()
                .addListener((_, _, newValue) -> fetcher.setEnabled(newValue));

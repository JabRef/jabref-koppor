...
public class PreviewPanel extends VBox implements PreviewControls {
    ...
    private ContextMenu createPopupMenu() {
        MenuItem copyCitationHtml = new MenuItem(
        ...
        keyBindingRepository
            ...
            .ifPresent(copyCitationHtml::setAccelerator);
        copyCitationHtml.setOnAction(_ ->
            previewView.copyPreviewHtmlToClipBoard()
        );
        MenuItem copyCitationText = new MenuItem(
            Localization.lang("Copy citation (text)")
        );
        copyCitationText.setOnAction(_ ->
            previewView.copyPreviewPlainTextToClipBoard()
        );
        MenuItem exportToClipboard = new MenuItem(
            Localization.lang("Export to clipboard")
        );
        exportToClipboard.setOnAction(_ ->
            previewView.exportToClipBoard(stateManager)
        );

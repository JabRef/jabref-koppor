...
public class Launcher {
    ...
    public static void main(String[] args) {
        ...
        final JabRefGuiPreferences preferences =
        ...
        if (!argumentProcessor.getGuiCli().usageHelpRequested) {
            ...
            MultipleInstanceAction instanceAction = handleMultipleAppInstances(
                args,
    ...
    public static void initLogging(String[] args) {
        ...
        Level logLevel = Arrays.stream(args).anyMatch(
     ...
     */
    private static MultipleInstanceAction handleMultipleAppInstances(
        String[] args,
        RemotePreferences remotePreferences
    ) {
        ...
        if (remotePreferences.useRemoteServer()) {
            ...
            if (remoteClient.ping()) {
                ...
                if (args.length == 0) {
                    ...
                    LOGGER.warn(
                        "A JabRef instance is already running. Switching to that instance."
                    );
                    ...
                    LOGGER.debug(
                        "Passing arguments passed on to running JabRef..."
                    );

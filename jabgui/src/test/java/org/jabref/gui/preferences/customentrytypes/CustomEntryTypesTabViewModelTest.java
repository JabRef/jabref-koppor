...
class CustomEntryTypesTabViewModelTest {
    ...
    void storeSettingsKeepsStandardTypes(BibDatabaseMode mode) {
        CustomEntryTypesTabViewModel model = new CustomEntryTypesTabViewModel(
            mode,
            entryTypesManager,
        ...
        assertEquals(
            new TreeSet<>(),
            entryTypesManager.getAllCustomizedTypes(mode)
        );
    }
    ...
    void storeSettingsKeepsTypeWhenOrFieldsDiffersOnly() {
        ...
        model
            ...
            .setAll(
                List.of(
                    new CustomEntryTypeViewModel(onlineWithoutOrFields, x ->
                        false
                    )
                )
            );
    ...
    void storeSettingsUpdatesType() {
        ...
        model
            .entryTypes()
            .setAll(
                List.of(new CustomEntryTypeViewModel(modified, x -> false))
            );

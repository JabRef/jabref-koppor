...
class ConstantsPropertiesViewModelTest {
    ...
    void stringsListPropertyResorting() {
        ...
        ListProperty<ConstantsItemModel> stringsList =
            model.stringsListProperty();
        stringsList.add(
    ...
    void storeSettingsWithStringConstantTest() {
        ...
        ListProperty<ConstantsItemModel> stringsList =
            model.stringsListProperty();
        stringsList.add(
            new ConstantsItemModel("KTH", "Royal Institute of Technology")
        );

        model.storeSettings();

        List<BibtexString> actual = context
            .getDatabase()
            .getStringValues()
            .stream()
            .toList();
        assertEquals(
            List.of(new BibtexString("KTH", "Royal Institute of Technology")),
            actual
        );
    }
}

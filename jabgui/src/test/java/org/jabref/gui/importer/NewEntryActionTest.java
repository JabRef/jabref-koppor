...
class NewEntryActionTest {
    ...
    private final LibraryTabContainer tabContainer = mock(
        LibraryTabContainer.class
    );
    ...
    void executeOnSuccessWithFixedType() {
        ...
        when(tabContainer.getLibraryTabs()).thenReturn(
            FXCollections.observableArrayList(libraryTab)
        );

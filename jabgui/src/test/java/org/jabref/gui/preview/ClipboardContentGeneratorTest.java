...
class ClipboardContentGeneratorTest {
    ...
    void processPreviewText() {
        ...
        ClipboardContent clipboardContent =
            ClipboardContentGenerator.processPreview(
    ...
    void processText() {
        ...
        ClipboardContent textTransferable =
            ClipboardContentGenerator.processText(
                Arrays.asList(citation, citation)
            );
    ...
    void processHtmlAsHtml() {
        ...
        ClipboardContent htmlTransferable =
            ClipboardContentGenerator.processHtml(
                Arrays.asList(citation, citation)
            );
    ...
    void processCslMarkdownAsMarkdown() {
        ...
        ClipboardContent markdown = ClipboardContentGenerator.processMarkdown(
            List.of(citationMd, citationMd)
        );

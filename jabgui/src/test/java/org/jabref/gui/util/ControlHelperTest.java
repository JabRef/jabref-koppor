...
class ControlHelperTest {
    ...
    void truncateWithDefaultMaxCharactersReturnsText() {
        String truncatedText = ControlHelper.truncateString(TEXT, DEFAULT_MAX_CHARACTERS, ELLIPSIS_STRING,
                ELLIPSIS_POSITION);
        assertEquals(TEXT, truncatedText);
    }
    ...
    void truncateWithEllipsisPositionBeginningReturnsTruncatedText() {
        String truncatedText = ControlHelper.truncateString(TEXT, MAX_CHARACTERS, ELLIPSIS_STRING,
    ...
    void truncateWithDefaultMaxCharactersAndNullEllipsisAndPositionEndingReturnsTruncatedText() {
        ...
        String truncatedText = ControlHelper.truncateString(text, DEFAULT_MAX_CHARACTERS, null,

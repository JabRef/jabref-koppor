...
class ManageKeywordsViewModelTest {
    ...
    void removedKeywordNotIncludedInKeywordsList() {
        ...
        assertEquals(FXCollections.observableList(originalKeywordsList), modifiedKeywords,
                "compared lists are not identical");

        keywordsViewModel.removeKeyword("Human-machine interaction");

        assertNotEquals(FXCollections.observableList(originalKeywordsList), modifiedKeywords,

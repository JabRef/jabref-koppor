...
public class CopyToTest {
    ...
    void setUp() {
        this.entry = new BibEntry(StandardEntryType.Article)
            .withField(
                ...
                "Beck, Aaron T. and Epstein, Norman and Brown, Gary and Steer, Robert A."
            )
            .withField(
                StandardField.TITLE,
        ...
        this.entryWithCrossRef = new BibEntry(StandardEntryType.InProceedings)
            ...
            .withField(
                ...
                "InternationalConferenceonMachineLearning2023"
            )
    ...
    void executeCopyEntriesWithoutCrossRef() {
        ...
        ArgumentCaptor<EntryImportHandlerTracker> trackerCaptor =
            ArgumentCaptor.forClass(EntryImportHandlerTracker.class);
        copyTo.copyEntriesWithoutCrossRef(
            selectedEntries,
            targetDatabaseContext
        );

        verify(importHandler).importEntriesWithDuplicateCheck(
            eq(targetDatabaseContext),
            eq(selectedEntries),
    ...
    void executeGetCrossRefEntry() {
        ...
        BibEntry result = copyTo
            .getCrossRefEntry(entryWithCrossRef, sourceDatabaseContext)
            .orElse(null);

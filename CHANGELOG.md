...
- We added a `jabkit autofix` command that applies a set of bibliographic cleanup operations (DOI, arXiv, eprint, URL and the default field formatters) to all entries of a library. [#TODO](https://github.com/JabRef/jabref/pull/TODO)
- We added an "arXiv DOI" cleanup operation that consolidates the arXiv identifier onto the version-stable DOI field and removes the now-redundant eprint fields. See the [arXiv DOI documentation](https://info.arxiv.org/help/doi.html). [#TODO](https://github.com/JabRef/jabref/pull/TODO)
...
- The cleanup of arXiv data was moved out of the DOI cleanup into a dedicated "arXiv DOI" cleanup; for arXiv entries the version-stable DOI is now kept and the redundant eprint fields are removed. [#TODO](https://github.com/JabRef/jabref/pull/TODO)

...
- We fixed an issue where legacy library content (explicit group assignments, markings, and special fields stored in the `keywords` field, as written by JabRef 2.x/3.x) was no longer migrated when opening a library. [#12990](https://github.com/JabRef/jabref/pull/12990)

...
public class SemanticMergerTest {
    ...
    void patchDatabase(
        ...
        BibDatabaseContext baseDatabaseContext = BibDatabaseContext.of(
            base,
            importFormatPreferences
        );
        BibDatabaseContext localDatabaseContext = BibDatabaseContext.of(
            local,
            importFormatPreferences
        );
        BibDatabaseContext remoteDatabaseContext = BibDatabaseContext.of(
            remote,
            importFormatPreferences
        );
        ...
        BibEntry patched = localDatabaseContext
            .getDatabase()
            .getEntryByCitationKey("a")
            .orElseThrow();
        if (expectedAuthor == null) {
            ...
            assertEquals(
                ...
                patched.getField(StandardField.AUTHOR)
            );
        }
    }
    ...
    static Stream<Arguments> patchDatabase() {
        return Stream.of(
            Arguments.of(
                "T1 - remote changed a field, local unchanged",
                """
                @article{a,
                    author = {TestAuthor},
                    doi = {ExampleDoi}
            ...
            Arguments.of(
                "T2 - local changed a field, remote unchanged",
                """
                @article{a,
                    author = {TestAuthor},
                    doi = {ExampleDoi}
            ...
            Arguments.of(
                "T4 - field removed in remote, unchanged in local",
                """
                @article{a,
                    author = {TestAuthor},
                    doi = {ExampleDoi},

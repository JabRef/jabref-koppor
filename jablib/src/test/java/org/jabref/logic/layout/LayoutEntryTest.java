...
class LayoutEntryTest {
    ...
    void parseMethodCalls() {
        ...
        assertEquals(
            "bla",
            LayoutEntry.parseMethodsCalls("bla").getFirst().getFirst()
        );
        ...
        assertEquals(
            "_bla.bla.blub",
            LayoutEntry.parseMethodsCalls("_bla.bla.blub,")
                .getFirst()
                .getFirst()
        );
        ...
        assertEquals(
            "bla",
            LayoutEntry.parseMethodsCalls("bla,foo").getFirst().getFirst()
        );
        assertEquals(
            "foo",
            LayoutEntry.parseMethodsCalls("bla,foo").get(1).getFirst()
        );
        ...
        assertEquals(
            "bla",
            LayoutEntry.parseMethodsCalls("bla(\"test\"),foo(\"fark\")")
                .getFirst()
                .getFirst()
        );
        assertEquals(
    ...
    void unsupportedOperationTypes(int type) {
        List<StringInt> parsedEntries = List.of(
            new StringInt("place_holder", 0),
    ...
    @ParameterizedTest
    @CsvSource(
        { "1, testString", "5, testString", "8, UTF-8", "9, ''", "10, ''" }
    )

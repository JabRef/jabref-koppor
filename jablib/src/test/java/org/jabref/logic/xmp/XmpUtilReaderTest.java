...
class XmpUtilReaderTest {
    ...
    @Test
    void readArticleDublinCoreReadRawXmp()
        ...
        DublinCoreSchema dcSchema = DublinCoreSchemaCustom.copyDublinCoreSchema(
            meta.getFirst().getDublinCoreSchema()
        );
        ...
        List<BibEntry> expected = bibtexImporter
    ...
    @Test
    void readArticleDublinCoreReadXmpPartialDate()
        throws IOException, URISyntaxException {
        Path pathPdf = Path.of(
            XmpUtilShared.class.getResource(

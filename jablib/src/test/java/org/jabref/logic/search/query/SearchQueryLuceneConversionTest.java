...
class SearchQueryLuceneConversionTest {
    ...
    public static Stream<Arguments> searchConversion() {
        return Stream.of(
            ...
            Arguments.of(
                "content:image AND NOT annotations:processing",
                "content = image AND annotations != processing"
            ),
            ...
            Arguments.of(
                "\"image processing\"",
                "\"image processing\" AND author = smith"
            ),
            Arguments.of(
                "image AND (processing)",
                "image AND (title = term OR processing)"
            ),
            Arguments.of(
                "image OR (processing)",
                "image OR (title = term OR processing)"
            ),
    ...
    void searchConversion(String expected, String searchExpression) {
        assertEquals(
            expected,
            SearchQueryConversion.searchToLucene(

...
class SearchQueryFlagsConversionTest {
    ...
    private static Stream<Arguments> searchConversion() {
        return Stream.of(
            createTestCases("Term", "Term", "Term", "Term", "Term"),
            createTestCases(
                "title = Term",
                "title = Term",
                "title =! Term",
    ...
    @ParameterizedTest
    @MethodSource
    void searchConversion(
        String expected,
        String searchExpression,
        EnumSet<SearchFlags> flags
    ) {
        String result = SearchQueryConversion.flagsToSearchExpression(
            new SearchQuery(searchExpression, flags)
        );

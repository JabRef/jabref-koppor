...
class JavaLocalizationEntryParser {
    ...
    public static List<String> getLanguageKeysInString(
        ...
        for (String param : parameters) {
            ...
            String languagePropertyKey = LocalizationKey.fromEscapedJavaString(
                languageKey
            ).getKey();
    ...
    private static String getContentWithinQuotes(String param) {
        ...
        String contentWithProtectedEscapedQuote =
            ESCAPED_QUOTATION_SYMBOL.matcher(param).replaceAll(
                QUOTATION_PLACEHOLDER
            );
        ...
        String languageKey = QUOTATION_SYMBOL_PATTERN.matcher(

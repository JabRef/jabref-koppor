...
public class JavaLocalizationEntryParserTest {
    ...
    public static Stream<Arguments> singleLineChecks() {
        return Stream.of(Arguments.of("Localization.lang(\"one per line\")", "one per line"),

                // '\c' is an escaped character, thus "\cite" is wrong as lookup text. It
                // has to be "\\cite" in the .properties file
                Arguments.of("Localization.lang(\"Copy \\\\cite{citation key}\")", "Copy \\\\cite{citation key}"),

                // " is kept unescaped
                Arguments.of("Localization.lang(\"\\\"Hey\\\"\")", "\"Hey\""),

                // \n is a "real" newline character in the simulated read read Java source
                // code
                ...
                Arguments.of("Localization.lang(\"Reset preferences (key1,key2,... or 'all')\")",
                ...
                // \n is allowed. See // see also
                // https://stackoverflow.com/a/10285687/873282
    ...
    public static Stream<Arguments> multiLineChecks() {
        return Stream.of(Arguments.of("Localization.lang(\"two per line\") Localization.lang(\"two per line\")",
    ...
    public static Stream<String> causesRuntimeExceptions() {
        return Stream.of("Localization.lang(\"Ends with a space \")",

...
public class ConferenceRepositoryTest {
    ...
    static void loadTestConferenceDataIntoRepo() throws JabRefException {
        InputStream inputStream =
            ConferenceRepositoryTest.class.getResourceAsStream(TEST_DATA_FILE);
    ...
    static Stream<Arguments> generateConferenceTestData() {
        return Stream.of(
            ...
            Arguments.of(
                ...
                "IIWAS",
                "C"
            ), // acronym with other text separated by space; acronym first
            Arguments.of(
                "(2010 iiWAS)",
                "822",
                "Information Integration and Web-based Applications and Services",
                "IIWAS",
                "C"
            ), // acronym with other text separated by space; acronym second
            Arguments.of(
                "(CLOSER'12)",
                "2300",
                ...
                "CLOSER",
                "C"
            ), // acronym with other text separated by quote
            Arguments.of(
                "(IEEE CCNC)",
                "616",
            ...
            Arguments.of(
                ...
                "ACM_WiSec",
                "B"
            ), // acronym with special character with extra text separated by space
            Arguments.of(
                "(EC-TEL'2023)",
                "2262",
                ...
                "EC-TEL",
                "B"
            ), // acronym with special character and quote
            Arguments.of(
                "(IEEE-IV'2023)",
                "2062",
                "Intelligent Vehicles Conference",
                "IEEE-IV",
                "B"
            ), // longer acronym with delimiter matches (IEEE-IV) instead of nested one (IV)
            Arguments.of(
                "CoopIS 2009 (OTM 2009)",
                "979",
                "International Conference on Cooperative Information Systems",
                "CoopIS",
                "B"
            ), // acronym outside parentheses matches post-normalization
            Arguments.of(
                "Cloud Computing and Services Science (CLOSER 2016): 6th International Conference", // Acronym in middle of title
                "2300",
                "International Conference on Cloud Computing and Services Science",
                "CLOSER",
                "C"
            ...
            // Title match tests
            Arguments.of(
                "AAAI Conference on Human Computation and Crowdsourcing", // Exact match without normalization
                "2264",
                "AAAI Conference on Human Computation and Crowdsourcing",
                "HCOMP",
                "B"
            ...
            Arguments.of(
                "Proceedings of the 2nd AAAI Conference on Human Computation and Crowdsourcing", // Exact match post-normalization
                "2264",
                "AAAI Conference on Human Computation and Crowdsourcing",
                "HCOMP",
                "B"
    ...
    @ParameterizedTest(
        name = "Booktitle \"{0}\" should match conference \"{2}\""
    )
    ...
    void getConferenceFromBookTitle(
        ...
        Optional<ConferenceEntry> expectedResult = Optional.ofNullable(
            expectedId
        ).map(_ ->
            new ConferenceEntry(
                expectedId,
                expectedTitle.toLowerCase(),
                expectedAcronym.toLowerCase(),
                expectedRank
            )
        );
        ...
        assertEquals(
            expectedResult,
            TEST_REPO.getConferenceFromBookTitle(testBookTitle)
        );
    }
}

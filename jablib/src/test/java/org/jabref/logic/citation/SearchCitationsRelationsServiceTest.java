...
class SearchCitationsRelationsServiceTest {
     ...
     */
    private CitationFetcher createMockFetcher(
        BibEntry targetEntry,
        List<BibEntry> citationsToReturn,
        List<BibEntry> referencesToReturn,
    ...
    class CitationsTests {
        ...
        void serviceShouldSearchForCitations() throws FetcherException {
            ...
            BibEntryCitationsAndReferencesRepository repository =
                BibEntryRelationsRepositoryTestHelpers.Mocks.from(
                    _ -> citationsToReturn,
                    null,
                    null,
                    null,
            ...
            SearchCitationsRelationsService searchService =
                new SearchCitationsRelationsService(null, repository);
        ...
        void serviceShouldCallTheFetcherForCitationsWhenRepositoryIsUpdatable()
            ...
            Map<BibEntry, List<BibEntry>> citationsDatabase =
                HashMap.newHashMap(300);
            CitationFetcher fetcher = createMockFetcher(
                cited,
                citationsToReturn,
                null,
                null
            ...
            SearchCitationsRelationsService searchService =
                new SearchCitationsRelationsService(fetcher, repository);
    ...
    class ReferencesTests {
        ...
        void serviceShouldCallTheFetcherForReferencesWhenRepositoryIsUpdatable()
            ...
            assertEquals(
                referencesToReturn,
                referencesDatabase.get(referencer)
            );
            assertEquals(referencesToReturn, references);
        }
        ...
        void serviceShouldUpdateCitationCountWithEmptyPaperDetailsResponse()
            ...
            int citationsCount = searchService.getCitationCount(
                referencer,
                field
            );

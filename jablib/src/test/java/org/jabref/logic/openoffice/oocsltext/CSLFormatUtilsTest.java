...
class CSLFormatUtilsTest {
    ...
    private static final BibDatabaseContext TEST_ENTRY_CONTEXT =
    ...
    @ParameterizedTest
    @MethodSource
    void ooHTMLTransformFromRawBibliography(
        String expected,
        CitationStyle style
    ) {
    ...
    static Stream<Arguments> ooHTMLTransformFromRawBibliography() {
        return Stream.of(
            ...
            Arguments.of(
                ...
                STYLE_LIST.stream()
                    .filter(e ->
                        "Springer - Lecture Notes in Computer Science".equals(
                            e.getTitle()
                        )
                    )
                    .findAny()
            ...
            Arguments.of(
                ...
                STYLE_LIST.stream()
                    .filter(e ->
                        "Chicago Manual of Style 17th edition (author-date)".equals(
                            e.getTitle()
                        )
                    )
                    .findAny()
            ...
            Arguments.of(
                ...
                STYLE_LIST.stream()
                    .filter(e ->
                        "American Medical Association 11th edition".equals(
                            e.getTitle()
                        )
                    )
                    .findAny()
            ...
            Arguments.of(
                ...
                STYLE_LIST.stream()
                    .filter(e ->
                        "De Montfort University - Harvard".equals(e.getTitle())
                    )
                    .findAny()
                    .get()
            ),
            ...
            Arguments.of(
                ...
                STYLE_LIST.stream()
                    .filter(e ->
                        "Modern Language Association 7th edition (underline)".equals(
                            e.getTitle()
                        )
                    )
                    .findAny()
            ...
            Arguments.of(
                ...
                STYLE_LIST.stream()
                    .filter(e ->
                        "Histoire & Mesure (Français)".equals(e.getTitle())
                    )
                    .findAny()
                    .get()
            ),
            ...
            Arguments.of(
                ...
                STYLE_LIST.stream()
                    .filter(e ->
                        "The Journal of Veterinary Medical Science".equals(
                            e.getTitle()
                        )
                    )
                    .findAny()
            ...
            Arguments.of(
                ...
                STYLE_LIST.stream()
                    .filter(e ->
                        "Acta Orthopædica Belgica".equals(e.getTitle())
                    )
                    .findAny()
                    .get()
            ),
            ...
            Arguments.of(
                ...
                STYLE_LIST.stream()
                    .filter(e ->
                        "Acta Anaesthesiologica Taiwanica".equals(e.getTitle())
                    )
                    .findAny()
                    .get()
            ),
            ...
            Arguments.of(
                ...
                STYLE_LIST.stream()
                    .filter(e ->
                        "American Chemical Society".equals(e.getTitle())
                    )
                    .findAny()
                    .get()
            ),
            ...
            Arguments.of(
                ...
                STYLE_LIST.stream()
                    .filter(e ->
                        "Chemical and Pharmaceutical Bulletin".equals(
                            e.getTitle()
                        )
                    )
                    .findAny()
            ...
            Arguments.of(
                ...
                STYLE_LIST.stream()
                    .filter(e ->
                        "American Institute of Physics 4th edition".equals(
                            e.getTitle()
                        )
                    )
                    .findAny()
    ...
    @ParameterizedTest
    @MethodSource
    void ooHTMLTransformFromCitationWithSingleEntry(
        String expected,
        CitationStyle style
    ) {
    ...
    static Stream<Arguments> ooHTMLTransformFromCitationWithSingleEntry() {
        return Stream.of(
            ...
            Arguments.of(
                ...
                STYLE_LIST.stream()
                    .filter(e ->
                        "The Journal of Clinical Ethics".equals(e.getTitle())
                    )
                    .findAny()
                    .get()
            )
    ...
    @ParameterizedTest
    @MethodSource
    void ooHTMLTransformFromCitationWithMultipleEntries(
        String expected,
        CitationStyle style
    ) {
    ...
    void updateSingleNumericBibliography(String expected, CitationStyle style) {
        ...
        String actual = CSLFormatUtils.updateSingleBibliographyNumber(
            transformedCitation,
            3
        );
        assertEquals(expected, actual);
    ...
    @ParameterizedTest
    @MethodSource
    void generateAlphanumericCitationTest(
        String expected,
        ...
        return Stream.of(
            ...
            Arguments.of(
                ...
                new BibEntry(StandardEntryType.Article)
                    .withField(
                        StandardField.AUTHOR,
                        "Johnson, Emily and Williams, Jessica and Lee, David"
                    )
                    .withField(StandardField.YEAR, "2019")
            ),
    ...
    @ParameterizedTest
    @MethodSource
    void generateAlphanumericInTextCitationTest(
        String expected,
        BibEntry entry
    ) {
        BibDatabaseContext context = new BibDatabaseContext(
        ...
        String actual = CSLFormatUtils.generateAlphanumericInTextCitation(
            entry,
            context
        );
        assertEquals(expected, actual);

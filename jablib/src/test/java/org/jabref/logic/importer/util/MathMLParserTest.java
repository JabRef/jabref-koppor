...
class MathMLParserTest {
    ...
    private static Stream<Arguments> tests() {
        return Stream.of(Arguments.of("$\\begin{pmatrix}0 & 1 & 0\\\\ 0 & 0 & 1\\\\ 1 & 0 & 0\\end{pmatrix}$", """
                ...
                """), Arguments
            .of("$\\underset{a}{\\overset{b}{\\int }}\\left(5x+2\\mathrm{sin}\\left(x\\right)\\right)\\mathrm{dx}$", """
                    <math xmlns="http://www.w3.org/1998/Math/MathML">
                        <munderover>
                            <mo>&#x222B;</mo>
                            <mi>a</mi>

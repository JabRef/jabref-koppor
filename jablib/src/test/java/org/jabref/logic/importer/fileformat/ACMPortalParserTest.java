...
class ACMPortalParserTest {
    ...
    void setUp() throws URISyntaxException, MalformedURLException {
        ...
        searchUrl = new URIBuilder("https://dl.acm.org/action/doSearch").addParameter("AllField", searchQuery)
            .build()
            .toURL();
        searchEntryList = List.of(new BibEntry(StandardEntryType.Conference)
            ...
            .withField(StandardField.PAGES, "152–158"),
                new BibEntry(StandardEntryType.Book).withField(StandardField.YEAR, "2016")

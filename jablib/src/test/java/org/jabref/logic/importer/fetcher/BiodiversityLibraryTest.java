...
class BiodiversityLibraryTest {
    ...
    void setUp() {
        ...
        when(
            importerPreferences.getApiKey(BiodiversityLibrary.FETCHER_NAME)
    ...
    void getPartMetadaUrl(String id)
        throws MalformedURLException, URISyntaxException {
        String expected = fetcher
            .getTestUrl()
            .concat(apiKey)
    ...
    void getItemMetadaUrl(String id)
        throws MalformedURLException, URISyntaxException {
        String expected = fetcher
            .getTestUrl()
            .concat(apiKey)
    ...
    void performSearch() throws FetcherException {
        ...
        assertEquals(
            expected,
            fetcher
                .performSearch("Amanoa condorensis (Phyllanthaceae)")
                .getFirst()
        );
    }

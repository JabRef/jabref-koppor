...
class SpringerFetcherTest implements SearchBasedFetcherCapabilityTest, PagedSearchFetcherTest {
    ...
    void searchByQueryFindsEntry() throws FetcherException {
        ...
        BibEntry articleSupportingIdentification = new BibEntry(StandardEntryType.Article)
            ...
            .withField(StandardField.FILE,
                    ":http\\://link.springer.com/openurl/pdf?id=doi\\:10.1007/s11219-025-09720-9:PDF")
        ...
        BibEntry articleTagThatIssue = new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR,
        ...
        BibEntry firstArticle = new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR,
        ...
        BibEntry fourthArticle = new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR,
        ...
        assertEquals(List.of(articleSupportingIdentification, articleTagThatIssue, fourthArticle, thirdArticle,
                firstArticle, secondArticle), fetchedEntries);
    }
    ...
    void supportsPhraseSearch() throws FetcherException {
        // Normal search should match due to Redmiles, Elissa M., phrase search on the
        // other hand should not find it.
        BibEntry expected = new BibEntry(StandardEntryType.InCollection).withField(StandardField.AUTHOR,
    ...
    void supportsBooleanANDSearch() throws FetcherException {
        ...
        List<BibEntry> result = fetcher
            .performSearch("author:\"Redmiles, David\" AND journal:\"Computer Supported Cooperative Work\"");

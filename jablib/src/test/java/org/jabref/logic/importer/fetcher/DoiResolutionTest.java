...
class DoiResolutionTest {
    ...
    @Test
    void anchorFallbackPreservesUrlCase() throws Exception {
    ...
    @Test
    void linkWithPdfInTitleTag() throws Exception {
    ...
    @Test
    void linkWithPdfStringLeadsToFulltext() throws Exception {
    ...
    @Test
    void citationMetaTagLeadsToFulltext() throws Exception {
    ...
    @Test
    void notReturnAnythingWhenMultipleLinksAreFound() throws Exception {
        entry.setField(StandardField.DOI, "10.1109/JXCDC.2019.2911135");
        assertEquals(Optional.empty(), finder.findFullText(entry));
    }

    @Test
    void returnAnythingWhenBehindSpringerPayWall() throws Exception {

...
class CollectionOfComputerScienceBibliographiesFetcherTest {
    ...
    void getUrlForQueryReturnsCorrectUrl() throws MalformedURLException, URISyntaxException, QueryNodeParseException {
        ...
        URL url = fetcher
            .getURLForQuery(new StandardSyntaxParser().parse(query, AbstractQueryTransformer.NO_EXPLICIT_FIELD));
    ...
    void performSearchReturnsMatchingMultipleEntries() throws FetcherException {
        ...
        BibEntry secondBibEntry = new BibEntry(StandardEntryType.Article).withCitationKey("oai:DiVA.org:lnu-68408")
            ...
            .withField(StandardField.ABSTRACT, "The open source application JabRef has existed since"
                    ...
                    + " violations detectable by SACC methods are connected to" + " higher than normal code churn.")
        ...
        // Checking a subset, because the query "jabref" is generic and returns a changing
        // result set

...
class ResearchGateTest {
    ...
    void performSearchWithString() throws FetcherException {
        BibEntry master = new BibEntry(StandardEntryType.PhdThesis).withCitationKey("phdthesis")
    ...
    void performSearchWithLuceneQuery() throws QueryNodeParseException, FetcherException {
        BibEntry master = new BibEntry(StandardEntryType.Article).withCitationKey("article")
            .withField(StandardField.TITLE,
    ...
    void performSearchWithBibEntry() throws FetcherException {
        BibEntry entryZaffar = new BibEntry(StandardEntryType.InProceedings).withCitationKey("inproceedings")
    ...
    void performSearchWithTitleWithCurlyBraces() throws FetcherException {
        BibEntry entryInput = new BibEntry(StandardEntryType.Misc).withField(StandardField.TITLE,

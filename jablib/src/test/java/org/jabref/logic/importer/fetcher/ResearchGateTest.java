...
class ResearchGateTest {
    ...
    void fullTextFoundByDOI() throws IOException, FetcherException {
        assertEquals(
            Optional.of(URLUtil.create(URL_PDF)),
    ...
    @Test
    void performSearchWithLuceneQuery()
        throws QueryNodeParseException, FetcherException {
    ...
    void performSearchWithTitleWithCurlyBraces() throws FetcherException {
        BibEntry entryInput = new BibEntry(StandardEntryType.Misc).withField(
            StandardField.TITLE,

...
class DoiFetcherTest {
    ...
    private final BibEntry bibBenedetto2000 = new BibEntry(
        StandardEntryType.Article
    )
        .withCitationKey("Benedetto_2000")
        .withField(
            StandardField.AUTHOR,
            "Benedetto, D. and Caglioti, E. and Marchioro, C."
        )
        .withField(
        ...
        .withField(
            StandardField.DOI,
            "10.1002/(sici)1099-1476(20000125)23:2<147::aid-mma108>3.0.co;2-j"
        )

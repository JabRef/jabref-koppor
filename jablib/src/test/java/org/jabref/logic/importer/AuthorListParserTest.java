...
class AuthorListParserTest {
    ...
    private static Stream<Arguments> parseSingleAuthorCorrectly() {
        return Stream.of(Arguments.of("王, 军", new Author("军", "军.", null, "王", null)),
                ...
                Arguments.of("{Society of Automotive Engineers}",
    ...
    void dashedNamesWithoutSpaceNormalized() {
        assertEquals(Optional.of("Z. Yao and D. S. Weld and W-P. Chen and H. Sun"),
    ...
    private static Stream<Arguments> parseMultipleCorrectly() {
        return Stream.of(
                Arguments.of(AuthorList.of(new Author("Alexander", "A.", null, "Artemenko", null), Author.OTHERS),
                        "Alexander Artemenko and others"),
                Arguments.of(AuthorList.of(new Author("I.", "I.", null, "Podadera", null),
                        new Author("J. M.", "J. M.", null, "Carmona", null),
                        new Author("A.", "A.", null, "Ibarra", null), new Author("J.", "J.", null, "Molla", null)),
                        "I. Podadera, J. M. Carmona, A. Ibarra, and J. Molla"),
                Arguments.of(AuthorList.of(new Author("Vivian", "V.", null, "U", null),
                        new Author("Thomas", "T.", null, "Lai", null)), "U, Vivian and Lai, Thomas"),
                Arguments.of(AuthorList.of(new Author("I.", "I.", null, "Podadera", null),
                        new Author("J. M.", "J. M.", null, "Carmona", null),
                        new Author("A.", "A.", null, "Ibarra", null), new Author("J.", "J.", null, "Molla", null)),
                        "I. Podadera      J. M. Carmona     A. Ibarra     J. Molla"),
                Arguments.of(AuthorList.of(new Author("Alexander", "A.", null, "Artemenko", null),
                        ...
                        new Author("J. M.", "J. M.", null, "Carmona", null)), """
                                ...
                                J. M. Carmona
                                """),
                Arguments.of(AuthorList.of(new Author("First1", "F.", null, "Last1", null),

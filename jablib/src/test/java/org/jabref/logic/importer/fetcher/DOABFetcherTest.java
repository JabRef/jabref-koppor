...
public class DOABFetcherTest {
    ...
    public static Stream<Arguments> performSearch() {
        return Stream.of(Arguments.of(new BibEntry(StandardEntryType.Book).withField(StandardField.AUTHOR, "David Pol")
            ...
            .withField(StandardField.KEYWORDS,
                    "poetry, love, warfare, thema EDItEUR::D Biography, Literature and Literary studies::DC Poetry::DCF Poetry by individual poets")
            .withField(StandardField.PUBLISHER, "punctum books"), "i open fire"),
                Arguments.of(new BibEntry(StandardEntryType.Book).withField(StandardField.ISBN, "9789085551201")
                    ...
                    .withField(StandardField.LANGUAGE, "English")
                    .withField(StandardField.KEYWORDS,
                            "Open Access, Monographs, OAPEN Library, Directory of Open Access Books, thema EDItEUR::G Reference, Information and Interdisciplinary subjects::GL Library and information sciences / Museology, thema EDItEUR::G Reference, Information and Interdisciplinary subjects::GP Research and information: general")
                ...
                Arguments.of(new BibEntry(StandardEntryType.Book)
                    ...
                    .withField(StandardField.LANGUAGE, "English")
                    .withField(StandardField.KEYWORDS,
                            "Religion, thema EDItEUR::Q Philosophy and Religion::QR Religion and beliefs::QRM Christianity::QRMF Christianity: sacred texts and revered writings::QRMF1 Bibles::QRMF13 New Testaments")
                ...
                Arguments.of(
                        new BibEntry(StandardEntryType.Book)
                            ...
                            .withField(StandardField.PUBLISHER,
    ...
    void performSearch(BibEntry expected, String query) throws FetcherException {
        ...
        // We must not contain abstracts in our code base; thus we remove the abstracts

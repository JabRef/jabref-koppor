...
class MedraTest {
    ...
    private static Stream<Arguments> getDoiBibEntryPairs() {
        return Stream.of(Arguments.of("10.2143/TVF.80.3.3285690",
                Optional.of(new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "SPILEERS, Steven ")
                ...
                Arguments.of("10.3303/CET1977146", Optional.of(new BibEntry(StandardEntryType.Article)
                ...
                Arguments.of("10.1400/115378", Optional.of(new BibEntry(StandardEntryType.Article)

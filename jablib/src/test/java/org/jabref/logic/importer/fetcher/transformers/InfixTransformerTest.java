...
public abstract class InfixTransformerTest<T extends AbstractQueryTransformer> {
    ...
    @Test
    public void convertExplicitUnFieldedTermPrefix()
    ...
    @Test
    public void convertMultipleValuesWithTheSameFieldPrefix()
        throws ParseCancellationException {
        String queryString =
    ...
    public void notOperatorPrefix() throws ParseCancellationException {
        String queryString =
            "NOT (author=\"Igor Steinmacher\" OR author=\"Christoph Treude\")";
        SearchQuery searchQuery = new SearchQuery(queryString);
        BaseQueryNode searchQueryList = new SearchQueryVisitor(
            searchQuery.getSearchFlags()
        ).visitStart(searchQuery.getContext());

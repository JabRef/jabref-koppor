...
class MedlineFetcherTest {
    ...
    void setUp() throws InterruptedException {
        ...
        entryWijedasa = new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR,
        ...
        entryEndharti = new BibEntry(StandardEntryType.Article).withField(StandardField.TITLE,
        ...
        bibEntryIchikawa = new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR,
            ...
            .withField(new UnknownField("chemicals"),
    ...
    void searchByIDWijedasa() throws FetcherException {
        ...
        fetchedEntry.get().clearField(StandardField.ABSTRACT); // Remove abstract due to
                                                               // copyright
    ...
    void multipleEntries() throws FetcherException {
        ...
        entryList.forEach(entry -> entry.clearField(StandardField.ABSTRACT)); // Remove
                                                                              // abstract
                                                                              // due to
                                                                              // copyright);
    ...
    void invalidSearchTerm() {
        assertThrows(FetcherClientException.class,

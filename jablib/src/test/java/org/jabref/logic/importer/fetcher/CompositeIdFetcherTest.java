...
/**
 * Tests the CompositeIdFetcher, for which Fetchers implementing the IdBasedFetcher
 * interface are a prerequisite. Excluding TitleFetcher.
 */
@FetcherTest
class CompositeIdFetcherTest {
    ...
    public static Stream<Arguments> performSearchByIdReturnsCorrectEntryForIdentifier() {
        return Stream.of(Arguments.arguments("performSearchByIdReturnsCorrectEntryForArXivId", new BibEntry(
            ...
            .withField(new UnknownField("copyright"), "Creative Commons Attribution 4.0 International"),
                "arXiv:2110.02957"),
                /*
                 * disabled, because Iacr does not work Arguments.arguments(
                 * "performSearchByIdReturnsCorrectEntryForIacrEprintId", new
                 * BibEntry(StandardEntryType.Misc) .withField(StandardField.ABSTRACT,
                 ...
                 * .withField(StandardField.HOWPUBLISHED,
                 ...
                 * .withCitationKey("cryptoeprint:2017:1118"), "2017/1118" ),
                 */
                Arguments.arguments("performSearchByIdReturnsCorrectEntryForIsbnId", new BibEntry(
                    ...
                    .withField(StandardField.ADDRESS, "Boston"), "9780134685991"),
                Arguments.arguments("performSearchByIdReturnsCorrectEntryForDoiId",
                        new BibEntry(StandardEntryType.Book).withField(StandardField.TITLE, "Java® For Dummies®")

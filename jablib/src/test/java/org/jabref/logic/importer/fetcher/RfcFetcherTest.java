...
class RfcFetcherTest {
    ...
    @Test
    void performSearchByIdFindsEntryWithDraftIdentifier()
    ...
    void performSearchByIdFindsEntry(String identifier)
        throws FetcherException {
        assertEquals(
    ...
    void performSearchByIdFindsNothingWithValidDraftIdentifier(
        String identifier
    ) {

...
class RfcFetcherTest {
    ...
    private BibEntry bibEntry = new BibEntry(StandardEntryType.Misc).withCitationKey("rfc1945")
    ...
    void performSearchByIdFindsEntryWithDraftIdentifier() throws FetcherException {
        ...
        bibDraftEntry
            .setCommentsBeforeEntry("%% You should probably cite draft-ietf-http-v10-spec instead of this I-D.\n");

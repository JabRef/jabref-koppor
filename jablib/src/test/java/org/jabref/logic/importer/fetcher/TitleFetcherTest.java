...
class TitleFetcherTest {
    ...
    void setUp() {
        ...
        bibEntryBischof2009 = new BibEntry(StandardEntryType.InProceedings).withCitationKey("Bischof_2009")
    ...
    void performSearchKopp2007() throws FetcherException {
        Optional<BibEntry> fetchedEntry = fetcher
            .performSearchById("BPELscript: A simplified script syntax for WS-BPEL 2.0");

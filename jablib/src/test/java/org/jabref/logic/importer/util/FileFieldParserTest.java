...
class FileFieldParserTest {
    ...
    private static Stream<Arguments> stringsToParseTest()
        ...
        return Stream.of(
            ...
            Arguments.of(
                List.of(
                    new LinkedFile(
                        "A test",
                        URLUtil.create("https://www.yahoo.com/abc/cde.htm"),
                        "URL"
                    )
                ),
            ...
            Arguments.of(
                List.of(
                    new LinkedFile(
                        URLUtil.create("http://arxiv.org/pdf/2010.08497v1"),
                        "PDF"
                    )
                ),
            ...
            Arguments.of(
                List.of(
                    new LinkedFile(
                        URLUtil.create("https://books.google.de/"),
                        ""
                    )
                ),
            ...
            Arguments.of(
                List.of(
                    new LinkedFile(URLUtil.create("https://www.google.de/"), "")
                ),
                "https://www.google.de/"
            ),
            // url as file
            Arguments.of(
                List.of(
                    new LinkedFile(
                        "",
                        URLUtil.create("http://ceur-ws.org/Vol-438"),
                        "URL"
                    )
                ),

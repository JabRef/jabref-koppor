...
public class JstorFetcherTest implements SearchBasedFetcherCapabilityTest {
    ...
    private final BibEntry bibEntry = new BibEntry(StandardEntryType.Article).withCitationKey("10.2307/90002164")
    ...
    private final BibEntry doiEntry = new BibEntry(StandardEntryType.Article).withCitationKey("10.1086/501484")
    ...
    void searchById() throws FetcherException {
        ...
        // The URL date is always the current date in the US. No need to properly check
        // it.
    ...
    void searchByUrlUsingId() throws FetcherException {
        ...
        assertEquals(Optional.of(doiEntry),

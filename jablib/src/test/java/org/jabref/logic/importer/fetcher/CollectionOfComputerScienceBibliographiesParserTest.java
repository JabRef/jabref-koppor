...
class CollectionOfComputerScienceBibliographiesParserTest {
    ...
    @Test
    void parseEntriesReturnsEmptyListIfXmlHasNoResults()
    ...
    @Test
    void parseEntriesReturnsOneBibEntryInListIfXmlHasSingleResult()
        throws ParseException, IOException {
        parseXmlAndCheckResults(
    ...
    @Test
    void parseEntriesReturnsMultipleBibEntriesInListIfXmlHasMultipleResults()
        throws ParseException, IOException {
        parseXmlAndCheckResults(

...
public class GrobidPlainCitationParserTest {
    ...
    static ImportFormatPreferences importFormatPreferences = mock(ImportFormatPreferences.class,
            Answers.RETURNS_DEEP_STUBS);
    static GrobidPreferences grobidPreferences = new GrobidPreferences(true, false, "http://grobid.jabref.org:8070");
    static GrobidPlainCitationParser grobidPlainCitationParser = new GrobidPlainCitationParser(grobidPreferences,
    ...
    public static Stream<Arguments> provideExamplesForCorrectResultTest() {
        return Stream.of(Arguments.of("example1", example1AsBibEntry, example1),
    ...
    void grobidPerformSearchCorrectResultTest(String testName, BibEntry expectedBibEntry, String searchQuery)
    ...
    void grobidPerformSearchWithInvalidDataTest(String invalidInput) throws FetcherException {
        assertThrows(FetcherException.class, () -> grobidPlainCitationParser.parsePlainCitation("invalidInput"),
    ...
    void performSearchThrowsExceptionInCaseOfConnectionIssues() throws IOException, ParseException {
        ...
        assertThrows(FetcherException.class, () -> grobidPlainCitationParser.parsePlainCitation("any text"),

...
public class GrobidPlainCitationParserTest {
    ...
    @Test
    void performSearchThrowsExceptionInCaseOfConnectionIssues()
        throws IOException, ParseException {
        GrobidService grobidServiceMock = mock(GrobidService.class);
        when(
            grobidServiceMock.processCitation(anyString(), any(), any())
        ).thenThrow(new SocketTimeoutException("Timeout"));
        grobidPlainCitationParser = new GrobidPlainCitationParser(
            importFormatPreferences,
            grobidServiceMock
        );

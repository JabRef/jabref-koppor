...
class INSPIREFetcherTest {
    ...
    void searchByQueryFindsEntry() throws FetcherException {
        BibEntry master = new BibEntry(StandardEntryType.MastersThesis).withCitationKey("Diez:2013fdp")
    ...
    void searchByIdentifierFindsEntry() throws FetcherException {
        BibEntry article = new BibEntry(StandardEntryType.Article).withCitationKey("Melnikov:1998pr")

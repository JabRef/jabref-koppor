...
class PdfMergeMetadataImporterTest {
    ...
    void setUp() {
        ...
        when(grobidPreferences.getGrobidURL()).thenReturn(
        ...
        when(importFormatPreferences.grobidPreferences()).thenReturn(
            grobidPreferences
        );
    ...
    void doesNotHandleEncryptedPdfs() throws URISyntaxException {
        Path file = Path.of(
            PdfMergeMetadataImporter.class.getResource(
                "/pdfs/encrypted.pdf"
            ).toURI()
        );
    ...
    void importWorksAsExpected() throws URISyntaxException {
        Path file = Path.of(
            PdfMergeMetadataImporterTest.class.getResource(
                "mixedMetadata.pdf"
            ).toURI()
        );
        List<BibEntry> result = importer
    ...
    void pdfMetadataExtractedFrom2024SPLCBecker() throws URISyntaxException {
        ...
        BibEntry expected = new BibEntry(StandardEntryType.InProceedings)
            ...
            .withField(
                ...
                "Becker, Martin and Rabiser, Rick and Botterweck, Goetz"
            )
            .withField(
                StandardField.TITLE,
            ...
            .withField(
                ...
                "case studies about companies adopting product line engineering"
            )
    ...
    void fetchArxivInformationForPdfWithArxivId() throws URISyntaxException {
        ...
        BibEntry expected = new BibEntry(StandardEntryType.Article)
            .withField(
                StandardField.AUTHOR,
                "Ricca, Filippo and Marchetto, Alessandro and Stocco, Andrea"
            )
            .withField(
                StandardField.TITLE,
            ...
            .withField(
                ...
                "https://doi.org/10.48550/arxiv.2408.06224"
            )
            .withField(StandardField.YEAR, "2024")
            .withField(
                StandardField.KEYWORDS,
                "Software Engineering (cs.SE), FOS: Computer and information sciences, FOS: Computer and information sciences"
            )
    ...
    void importRelativizesFilePath() throws URISyntaxException, IOException {
        ...
        Path directory = Path.of(
            PdfMergeMetadataImporter.class.getResource("/pdfs/").toURI()
        );
        when(preferences.getMainFileDirectory()).thenReturn(
            Optional.of(directory)
        );

        List<BibEntry> result = importer
            .importDatabase(file, database, preferences)
            .getDatabase()
            .getEntries();

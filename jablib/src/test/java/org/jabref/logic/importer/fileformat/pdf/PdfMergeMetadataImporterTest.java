...
class PdfMergeMetadataImporterTest {
    ...
    void importWorksAsExpected() throws URISyntaxException {
        ...
        BibEntry expected = new BibEntry(StandardEntryType.Book).withCitationKey("9780134685991")
        ...
        expected.setField(StandardField.URL,
    ...
    void pdfMetadataExtractedFrom2024SPLCBecker() throws URISyntaxException {
        ...
        BibEntry expected = new BibEntry(StandardEntryType.InProceedings).withCitationKey("Becker_2024")
        ...
        BibEntry expected = new BibEntry(StandardEntryType.Article)
            ...
            .withField(StandardField.FILE,
                    ":http\\://arxiv.org/pdf/2408.06224v2:PDF;:"
                            + file.toString().replace("\\", "/").replace(":", "\\:") + ":PDF")

...
class FieldComparatorTest {
    ...
    void compareStringFieldsEquality() {
        FieldComparator comparator = new FieldComparator(StandardField.TITLE);
        BibEntry equal = new BibEntry().withField(StandardField.TITLE, "title");
        BibEntry equal2 = new BibEntry().withField(
            StandardField.TITLE,
            "title"
        );
    ...
    void compareNumericFieldsBiggerDescending() {
        ...
        BibEntry smaller = new BibEntry().withField(
            StandardField.PMID,
            "234567"
        );
        BibEntry bigger = new BibEntry().withField(
            StandardField.PMID,
            "123456"
        );
    ...
    void compareParsableWithNonParsableNumericFieldDescending() {
        ...
        BibEntry parsable = new BibEntry().withField(
            StandardField.PMID,
            "123456"
        );
        BibEntry unparsable = new BibEntry().withField(
            StandardField.PMID,
            "abc##z"
        );

...
class EntryComparatorTest {
    ...
    void recognizeIdenticalObjectsAsEqual() {
        ...
        assertEquals(
            0,
            new EntryComparator(false, false, StandardField.TITLE).compare(
                entry,
                entry
            )
        );
    ...
    void compareAuthorFieldBiggerAscending() {
        BibEntry entry1 = new BibEntry().withField(
            StandardField.AUTHOR,
            "Stephen King"
        );
        BibEntry entry2 = new BibEntry().withField(
            StandardField.AUTHOR,
            "Henning Mankell"
        );
    ...
    void compareObjectsByKeyAscending() {
        ...
        assertEquals(
            1,
            new EntryComparator(false, false, InternalField.KEY_FIELD).compare(
                e1,
                e2
            )
        );
    ...
    void compareWithCrLfFields() {
        BibEntry e1 = new BibEntry().withField(
            StandardField.COMMENT,
            "line1\r\n\r\nline3\r\n\r\nline5"
        );
        BibEntry e2 = new BibEntry().withField(
            StandardField.COMMENT,
            "line1\r\n\r\nline3\r\n\r\nline5"
        );
        assertEquals(
    ...
    void withAuthorIsBeforeWithEmptyAuthorWhenSortingWithNonExistentKey() {
        ...
        assertEquals(
            -1,
            new EntryComparator(true, false, InternalField.KEY_FIELD).compare(
                e1,
                e2
            )
        );
    ...
    void withAuthorIsBeforeEmptyAuthorWhenSortingWithAuthor() {
        ...
        assertEquals(
            -1,
            new EntryComparator(true, false, StandardField.AUTHOR).compare(
                e1,
                e2
            )
        );
    ...
    void withAuthorIsBeforeWithoutAuthorWhenSortingWithAuthor() {
        ...
        assertEquals(
            1,
            new EntryComparator(false, false, StandardField.AUTHOR).compare(
                e1,
                e2
            )
        );

...
class BibDatabaseDiffTest {
    ...
    void compareOfSameEntryReportsNoDifferences() {
        BibEntry entry = new BibEntry(BibEntry.DEFAULT_TYPE).withField(
            StandardField.TITLE,
            "test"
        );
    ...
    void compareOfDifferentEntriesWithSameDataReportsNoDifferences() {
        BibEntry entryOne = new BibEntry(BibEntry.DEFAULT_TYPE).withField(
            StandardField.TITLE,
            "test"
        );
        BibEntry entryTwo = new BibEntry(BibEntry.DEFAULT_TYPE).withField(
            StandardField.TITLE,
            "test"
        );
    ...
    void compareOfTwoEntriesWithSameContentAndLfEndingsReportsNoDifferences() {
        BibEntry entryOne = new BibEntry().withField(
            StandardField.COMMENT,
            "line1\n\nline3\n\nline5"
        );
        BibEntry entryTwo = new BibEntry().withField(
            StandardField.COMMENT,
            "line1\n\nline3\n\nline5"
        );
    ...
    void compareOfTwoDifferentEntriesWithDifferentDataReportsDifferences() {
        ...
        assertNull(
            diff.getEntryDifferences().get(1).originalEntry(),
    ...
    void compareOfThreeDifferentEntriesWithDifferentDataReportsDifferences() {
        ...
        BibEntry entryThree = new BibEntry(BibEntry.DEFAULT_TYPE).withField(
            StandardField.TITLE,
            "again another test"
        );
        BibDatabaseContext databaseOne = new BibDatabaseContext(
            new BibDatabase(List.of(entryOne))
        );
        ...
        assertNull(
            diff.getEntryDifferences().get(2).originalEntry(),
    ...
    private BibDatabaseDiff compareEntries(
        ...
        BibDatabaseContext databaseTwo = new BibDatabaseContext(
            new BibDatabase(List.of(entryTwo))
        );

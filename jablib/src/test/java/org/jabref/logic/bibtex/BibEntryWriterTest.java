...
class BibEntryWriterTest {
    ...
    void setUpWriter() {
        ...
        bibEntryWriter = new BibEntryWriter(
    ...
    void bibEntryTwoSpacesBeforeAndAfterKept() throws IOException {
        BibEntry entry = new BibEntry(StandardEntryType.Article)
            .withField(
                ...
                "  two spaces before and after (before)  "
            )
            .withChanged(true);
    ...
    void constantMonthApril() throws IOException {
        BibEntry entry = new BibEntry(StandardEntryType.Misc).withField(
            StandardField.MONTH,
            "#apr#"
        );
        // enable writing
     ...
     */
    private BibEntry firstEntryFrom(final String bibContentText)
        throws JabRefException {
        return BibDatabaseContext.of(bibContentText, importFormatPreferences)
            .getEntries()
            .getFirst();
    }
}

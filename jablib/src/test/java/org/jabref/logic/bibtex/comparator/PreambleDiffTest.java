...
class PreambleDiffTest {
    ...
    @BeforeEach
    void setUp() {
        when(originalDataBaseContext.getDatabase()).thenReturn(
            originalDataBase
        );
    ...
    void compareSamePreambleTest() {
        when(originalDataBase.getPreamble()).thenReturn(
            Optional.of("preamble")
        );
    ...
    void compareDifferentPreambleTest() {
        ...
        when(newDataBase.getPreamble()).thenReturn(
            Optional.of("otherPreamble")
        );

...
public class BibWarningToIntegrityMessageConverterTest {
    ...
    void convertsWarningsToIntegrityMessagesTest() {
        BibEntry firstEntry = new BibEntry(StandardEntryType.Article).withCitationKey("Scholey_2013")
            .withField(StandardField.AUTHOR, "Scholey");
        BibEntry secondEntry = new BibEntry(StandardEntryType.Article).withCitationKey("Tan_2021")
    ...
    void skipsWarningsForMissingEntries() {
        ...
        BibEntry scholey = new BibEntry(StandardEntryType.Article).withCitationKey("Scholey_2013");
        ...
        List<BibWarning> warnings = List.of(
                new BibWarning(SeverityType.WARNING, "empty journal", "journal", "Scholey_2013"),
                new BibWarning(SeverityType.WARNING, "empty year", "year", "NonExistent_9999") // should
                                                                                               // be
                                                                                               // skipped
        );
        ...
        List<IntegrityMessage> expectedMessages = List
            .of(new IntegrityMessage("empty journal", scholey, FieldFactory.parseField("journal")));

...
class CitationStyleGeneratorTest {
    ...
    private static final List<CitationStyle> STYLE_LIST =
        CSLStyleLoader.getInternalStyles();
    private static final String DEFAULT_STYLE =
        CSLStyleLoader.getDefaultStyle().getSource();
    private static final CitationStyleOutputFormat HTML_OUTPUT_FORMAT =
        CitationStyleOutputFormat.HTML;
    private static final CitationStyleOutputFormat TEXT_OUTPUT_FORMAT =
        CitationStyleOutputFormat.TEXT;
    private static final CitationStyleOutputFormat MARKDOWN_OUTPUT_FORMAT =
        CitationStyleOutputFormat.MARKDOWN;
    private static final BibEntryTypesManager ENTRY_TYPES_MANAGER =
        new BibEntryTypesManager();

    private final BibEntry testEntry = TestEntry.getTestEntry();
    private final BibDatabaseContext testEntryContext = new BibDatabaseContext(
        new BibDatabase(List.of(testEntry))
    );
    ...
    void clinicalEthicsNoteCitation() {
        ...
        String expected =
            "B. Smith, B. Jones and J. Williams, &ldquo;Title of the test entry,&rdquo; <span style=\"font-style: italic\">BibTeX Journal</span> 34, no. 3 (July 2016): 45&ndash;67.";
    ...
    void aCMBibliography() {
        ...
        String expected =
            "  <div class=\"csl-entry\"><span style=\"font-variant: small-caps\">Smith, B., Jones, B., and Williams, J.</span> 2016. Title of the test entry. <span style=\"font-style: italic\">BibTeX Journal</span> <span style=\"font-style: italic\">34</span>, 3, 45&ndash;67.</div>\n";
    ...
    void aPABibliography() {
        ...
        String expected =
            "  <div class=\"csl-entry\">Smith, B., Jones, B., &amp; Williams, J. (2016). Title of the test entry. <span style=\"font-style: italic\">BibTeX Journal</span>, <span style=\"font-style: italic\">34</span>(3), 45&ndash;67. https://doi.org/10.1001/bla.blubb</div>\n";
    ...
    void din1502AlphanumericInTextCitation() {
        ...
        CitationStyle style = STYLE_LIST.stream()
            .filter(e ->
                "DIN 1505-2 (alphanumeric, Deutsch) - standard superseded by ISO-690".equals(
                    e.getTitle()
                )
            )
            .findAny()
            .get();
        String inTextCitation = CitationStyleGenerator.generateCitation(
            List.of(testEntry),
            style.getSource(),
            HTML_OUTPUT_FORMAT,
            testEntryContext,
    ...
    void markdownFormat() {
        String expectedCitation =
            "\\[1\\]B\\. Smith\\, B\\. Jones\\, and J\\. Williams\\, “Title of the test entry\\,” *BibTeX Journal*\\, vol\\. 34\\, no\\. 3\\, pp\\. 45–67\\, July 2016\\, doi\\: 10\\.1001\\/bla\\.blubb\\.<br />\n";
    ...
    void handleAmpersand() {
        String expectedCitation =
            "[1]B. Smith, B. Jones, and J. Williams, “Famous quote: “&TitleTest&” - that is it,” BibTeX Journal, vol. 34, no. 3, pp. 45–67, July 2016, doi: 10.1001/bla.blubb.\n";
        testEntry.setField(
            StandardField.TITLE,
    ...
    void cslMapping(
        ...
        String citation = CitationStyleGenerator.generateBibliography(
            List.of(entry),
            CSLStyleUtils.createCitationStyleFromFile(cslFileName)
                .orElseThrow()
                .getSource(),
            TEXT_OUTPUT_FORMAT,
            testEntryContext,
        ...
        return Stream.of(
            ...
            Arguments.of(
                ...
                new BibEntry(StandardEntryType.Article)
                    ...
                    .withField(
                        StandardField.DOI,
                        "http://dx.doi.org/10.1161/circulationaha.108.827022"
                    )
                    .withField(StandardField.ISSN, "1524-4539")
                    .withField(StandardField.NUMBER, "10")
                    .withField(StandardField.PAGES, "1433--1441")
            ...
            Arguments.of(
                ...
                new BibEntry(StandardEntryType.Article)
                    ...
                    .withField(
                        StandardField.DOI,
                        "10.1161/circ.108_827022~special"
                    )
                    .withField(StandardField.ISSN, "1524-4539")
                    .withField(StandardField.NUMBER, "10")
                    .withField(StandardField.PAGES, "1433--1441")

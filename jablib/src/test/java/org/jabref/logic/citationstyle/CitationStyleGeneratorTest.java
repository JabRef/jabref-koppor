...
class CitationStyleGeneratorTest {
    ...
    void defaultCitation() {
        ...
        String citation = CitationStyleGenerator.generateCitation(List.of(testEntry), DEFAULT_STYLE, HTML_OUTPUT_FORMAT,
                testEntryContext, ENTRY_TYPES_MANAGER);
    ...
    void aCMCitation() {
        ...
        String citation = CitationStyleGenerator.generateCitation(List.of(testEntry), style.getSource(),
                HTML_OUTPUT_FORMAT, testEntryContext, ENTRY_TYPES_MANAGER);
    ...
    void clinicalEthicsNoteCitation() {
        ...
        CitationStyle style = STYLE_LIST.stream()
            .filter(e -> "The Journal of Clinical Ethics".equals(e.getTitle()))
            .findAny()
            .get();
        String citation = CitationStyleGenerator.generateCitation(List.of(testEntry), style.getSource(),
                HTML_OUTPUT_FORMAT, testEntryContext, ENTRY_TYPES_MANAGER);
    ...
    void defaultBibliography() {
        // IEEE
        testEntryContext.setMode(BibDatabaseMode.BIBLATEX);
        String citation = CitationStyleGenerator
            .generateBibliography(List.of(testEntry), DEFAULT_STYLE, HTML_OUTPUT_FORMAT, testEntryContext,
                    ENTRY_TYPES_MANAGER)
            .getFirst();
    ...
    void aCMBibliography() {
        ...
        CitationStyle style = STYLE_LIST.stream().filter(e -> "ACM SIGGRAPH".equals(e.getTitle())).findAny().get();
        String citation = CitationStyleGenerator
            .generateBibliography(List.of(testEntry), style.getSource(), HTML_OUTPUT_FORMAT, testEntryContext,
                    ENTRY_TYPES_MANAGER)
            .getFirst();
    ...
    /**
     * Fails due to citeproc-java
     * ({@link CitationStyleGenerator#generateCitation(List, String, CitationStyleOutputFormat, BibDatabaseContext, BibEntryTypesManager)
     * generateCitation}) returning an empty citation. Alphanumeric citations are thus,
     * currently manually generated by formatting (see
     * {@link org.jabref.logic.openoffice.oocsltext.CSLFormatUtils#generateAlphanumericCitation(List, BibDatabaseContext)
     * generateAlphaNumericCitation}).
     */
    @Test
    ...
    void din1502AlphanumericInTextCitation() {
        testEntryContext.setMode(BibDatabaseMode.BIBLATEX);
        CitationStyle style = STYLE_LIST.stream()
            .filter(e -> "DIN 1505-2 (alphanumeric, Deutsch) - standard superseded by ISO-690".equals(e.getTitle()))
            .findAny()
            .get();
        String inTextCitation = CitationStyleGenerator.generateCitation(List.of(testEntry), style.getSource(),
                HTML_OUTPUT_FORMAT, testEntryContext, ENTRY_TYPES_MANAGER);
    ...
    void ignoreNewLine() {
        ...
        String expected = "  <div class=\"csl-entry\">\n"
                ...
                + "  </div>\n";
        String citation = CitationStyleGenerator.generateBibliography(List.of(entry), DEFAULT_STYLE,
                ENTRY_TYPES_MANAGER);
        assertEquals(expected, citation);
    }
    ...
    void missingCitationStyle() {
        ...
        String citation = CitationStyleGenerator.generateBibliography(List.of(entry), "faulty citation style",
                ENTRY_TYPES_MANAGER);
        assertEquals(expected, citation);
    }
    ...
    void handleCrossRefFields() {
        BibEntry firstEntry = new BibEntry(StandardEntryType.InCollection).withCitationKey("smit2021")
        ...
        BibEntry secondEntry = new BibEntry(StandardEntryType.Book).withCitationKey("jone2021")
        ...
        String actualCitation = CitationStyleGenerator
            .generateBibliography(List.of(firstEntry), DEFAULT_STYLE, TEXT_OUTPUT_FORMAT, bibDatabaseContext,
                    ENTRY_TYPES_MANAGER)
            .getFirst();
        assertEquals(expectedCitation, actualCitation);
    }
    ...
    static Stream<Arguments> cslMapping() {
        // if the default citation style changes this has to be modified
        return Stream.of(Arguments.of("[1]F. Last and J. Doe, no. 28.\n", BibDatabaseMode.BIBTEX,
                new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Last, First and\nDoe, Jane")
                    .withField(StandardField.NUMBER, "28"),
                "ieee.csl"),
                Arguments.of("[1]F. Last and J. Doe, no. 7.\n", BibDatabaseMode.BIBLATEX,
                        new BibEntry(StandardEntryType.Article)
                            .withField(StandardField.AUTHOR, "Last, First and\nDoe, Jane")
                            .withField(StandardField.ISSUE, "7"),
                        "ieee.csl"),
                Arguments.of("[1]F. Last and J. Doe, no. 28.\n", BibDatabaseMode.BIBLATEX,
                        new BibEntry(StandardEntryType.Article)
                ...
                Arguments.of("[1]F. Last and J. Doe, no. 28.\n", BibDatabaseMode.BIBLATEX,
                        new BibEntry(StandardEntryType.Article)
                            ...
                            .withField(StandardField.NUMBER, "28"),
                        "ieee.csl"),
                Arguments.of("[1]F. Last and J. Doe, no. 7, Art. no. e0270533.\n", BibDatabaseMode.BIBLATEX,
                        new BibEntry(StandardEntryType.Article)
                            .withField(StandardField.AUTHOR, "Last, First and\nDoe, Jane")
                            .withField(StandardField.ISSUE, "7")
                            .withField(StandardField.EID, "e0270533"),
                        "ieee.csl"),
                Arguments.of("[1]F. Last and J. Doe, no. 33, pp. 7–8.\n", BibDatabaseMode.BIBLATEX,
                        new BibEntry(StandardEntryType.Article)
                            .withField(StandardField.AUTHOR, "Last, First and\nDoe, Jane")
                ...
                Arguments.of(
                        ...
                        BibDatabaseMode.BIBTEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                ...
                Arguments.of("Foo, B. (n.d.). volume + issue + pages. Bib(La)TeX Journal, 1(9), 45–67.\n",
                        BibDatabaseMode.BIBTEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                            .withField(StandardField.JOURNAL, "Bib(La)TeX Journal")
                            .withField(StandardField.PAGES, "45--67")
                ...
                Arguments.of("Foo, B. (n.d.). volume + pages. Bib(La)TeX Journal, 1, 45–67.\n", BibDatabaseMode.BIBTEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                            .withField(StandardField.JOURNAL, "Bib(La)TeX Journal")
                            .withField(StandardField.PAGES, "45--67")
                ...
                Arguments.of("Foo, B. (n.d.). number. Bib(La)TeX Journal, 3number.\n", BibDatabaseMode.BIBTEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                            .withField(StandardField.JOURNAL, "Bib(La)TeX Journal")
                            .withField(StandardField.NUMBER, "3number")
                ...
                // The issue field does not exist in bibtex standard, therefore there is
                // no need to render it (it exists in biblatex standard though). Since,
                // for this entry, there is no number field present and therefore no data
                // will be overwriten, enabling the user to be able to move the data
                // within the issue field to the number field via cleanup action is
                // something worth pursuing.
                Arguments.of("Foo, B. (n.d.). issue + pages. Bib(La)TeX Journal, 9, 45–67.\n", BibDatabaseMode.BIBTEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                            .withField(StandardField.JOURNAL, "Bib(La)TeX Journal")
                            .withField(StandardField.PAGES, "45--67")
                ...
                // The issue field does not exist in bibtex standard, therefore there is
                // no need to render it (it exists in biblatex standard though)
                Arguments.of("Foo, B. (n.d.). issue + number. Bib(La)TeX Journal, 3number.\n", BibDatabaseMode.BIBTEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                            .withField(StandardField.JOURNAL, "Bib(La)TeX Journal")
                            .withField(StandardField.NUMBER, "3number")
                ...
                // The issue field does not exist in bibtex standard, therefore there is
                // no need to render it (it exists in biblatex standard though)
                Arguments.of("Foo, B. (n.d.). issue + number + pages. Bib(La)TeX Journal, 3number, 45–67.\n",
                        BibDatabaseMode.BIBTEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                            .withField(StandardField.JOURNAL, "Bib(La)TeX Journal")
                            .withField(StandardField.NUMBER, "3number")
                ...
                // "Article number" is not a field that exists in Bibtex standard.
                // Printing the article number in the pages field is a workaround. Some
                // Journals have opted to put the article number into the pages field. APA
                // 7th Style recommends following procedure: If the journal article has an
                // article number instead of a page range, include the word "Article" and
                // then the article number instead of the page range. Question: Should it
                // be rendered WITH Article or WITHOUT the Word Article in Front? I guess
                // without?
                Arguments.of("Foo, B. (n.d.). number + pages. Bib(La)TeX Journal, 3number, Article 777.\n",
                        BibDatabaseMode.BIBTEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                            .withField(StandardField.JOURNAL, "Bib(La)TeX Journal")
                            .withField(StandardField.NUMBER, "3number")
                ...
                // within the issue field to the number field via cleanup action is
                // something worth pursuing."
                Arguments.of("Foo, B. (n.d.). issue. Bib(La)TeX Journal, 9issue.\n", BibDatabaseMode.BIBTEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                            .withField(StandardField.JOURNAL, "Bib(La)TeX Journal")
                ...
                Arguments.of("Foo, B. (n.d.). number + pages. Bib(La)TeX Journal, 3number, 45–67.\n",
                        BibDatabaseMode.BIBTEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                            .withField(StandardField.JOURNAL, "Bib(La)TeX Journal")
                            .withField(StandardField.NUMBER, "3number")
                ...
                // be rendered WITH Article or WITHOUT the Word Article in Front? I guess
                // without?
                Arguments.of("Foo, B. (n.d.). number + pages. BibTeX Journal, 3number, 777e23.\n",
                        BibDatabaseMode.BIBTEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                ...
                // Not rendering the "eid" field here, is correct. The "eid" field(short
                // for: electronic identifier) does not exist in Bibtex standard. It
                // exists in Biblatex standard though and is the field, in which the
                // "article number" should be entered into. "Article number" is a field
                // that does not exist in Bibtex and also not in Biblatex standard. As a
                // workaround, some Journals have opted to put the article number into the
                // pages field. APA 7th Style recommends following procedure: "If the
                // journal article has an article number instead of a page range, include
                // the word "Article" and then the article number instead of the page
                // range." - Source:
                // https://apastyle.apa.org/style-grammar-guidelines/references/examples/journal-article-references#2.
                // Additionally the APA style (7th edition) created by the CSL community
                // "prints the issue (= the "number" field" in Biblatex) whenever it is in
                // the data and the number (= the "eid" field in Biblatex) when no page
                // range is present, entirely independent of the issue number" - Source:
                // https://github.com/citation-style-language/styles/issues/5827#issuecomment-1006011280).
                // I personally think the "eid" field SHOULD be rendered here SOMEWHERE,
                // maybe even IN ADDITION to the page range, because we have the data,
                // right? Why not show it? - But this is just my humble opinion and may
                // not be coherent with the current APA Style 7th edition. Not rendering
                // the "issue" field here is sufficient for APA 7th edition. Under current
                // circumstances the "number" field takes priority over the "issue" field
                // (see
                // https://github.com/JabRef/jabref/issues/8372#issuecomment-1023768144).
                // [Keyword: IS RENDERING BOTH VIABLE?]. Ideally, they would coexist:
                // "Roughly speaking number subdivides volume and issue is much closer to
                // subdividing year. I don't think I would want to say that issue is
                // subordinate to number or vice versa. They sort of operate on a similar
                // level." (Source:
                // https://github.com/plk/biblatex/issues/726#issuecomment-1010264258)
                Arguments.of("Foo, B. (n.d.). eid + issue + number + pages. BibTeX Journal, 3number, 45–67.\n",
                        BibDatabaseMode.BIBTEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                            .withField(StandardField.JOURNAL, "BibTeX Journal")
                            .withField(StandardField.NUMBER, "3number")
                ...
                /*
                 * Not rendering the "eid" field here, is correct. The "eid" field(=
                 * electronic identifier) does not exist in Bibtex standard. Since, for
                 * this entry, there is no pages field present and therefore no data will
                 * be overwritten, enabling the user to be able to move the data within
                 * the eid scala.annotation.meta.field to the pages
                 * scala.annotation.meta.field via cleanup action is something worth
                 * pursuing.
                 *
                 * Not rendering the "issue" field here is correct. The "issue" field does
                 * not exist in Bibtex standard. Since, for this entry, there is no number
                 * field present and therefore no data will be overwritten, enabling the
                 * user to be able to move the data within the issue field to the number
                 * field via cleanup action is something worth pursuing.
                 */
                Arguments.of("Foo, B. (n.d.). eid + issue. BibTeX Journal, 9issue, Article 6eid.\n",
                        BibDatabaseMode.BIBTEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                            .withField(StandardField.JOURNAL, "BibTeX Journal")
                ...
                /*
                 * Not rendering the "eid" field here, is sufficient, but contested
                 * practice. This statement is based on the following reasoning: "eid" (in
                 * long: electronic identifier) is the field, which should be used to
                 * enter the "article number", when using the Biblatex standard. Both
                 * "eid" and "article number" do not exist in the older Bibtex standard.
                 * As a workaround, some Journals and publishers have opted to put the
                 * article number into the pages field. APA 7th Style recommends following
                 * procedure:
                 * "If the journal article has an article number instead of a page range, include the word "
                 * Article" and then the article number instead of the page range." -
                 * Source:
                 * https://apastyle.apa.org/style-grammar-guidelines/references/examples/
                 * journal-article-references#2. Additionally the APA style (7th edition)
                 * created by the CSL community "prints the issue [= the "number" field"
                 * in both Biblatex and Bibtex] whenever it is in the data and the number
                 * [= the "eid" field in Biblatex] when no page range is present, entirely
                 * independent of the issue
                 * number" - Source: https://github.com/citation-style-language/styles/issues/5827#issuecomment-1006011280. I personally think the "
                 * eid" field SHOULD be rendered here SOMEWHERE, maybe even IN ADDITION to
                 * the page range, because we have the data, right? Why not show it? - But
                 * this is just my humble opinion and may not be coherent with the current
                 * APA Style 7th edition.
                 *
                 * Not rendering the "issue" field here is sufficient for APA 7th edition.
                 * Under current circumstances the "number" field takes priority over the
                 * "issue" field (see
                 * https://github.com/JabRef/jabref/issues/8372#issuecomment-1023768144).
                 * [Keyword: IS RENDERING BOTH VIABLE?]. Ideally, they would coexist:
                ...
                Arguments.of("Foo, B. (n.d.). eid + issue. Bib(La)TeX Journal, 9issue, Article Article 6eid.\n",
                        BibDatabaseMode.BIBLATEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                            .withField(StandardField.JOURNALTITLE, "Bib(La)TeX Journal")
                            .withField(StandardField.TITLE, "eid + issue")
                ...
                Arguments.of("Foo, B. (n.d.). eid + issue + pages. Bib(La)TeX Journal, 9issue, Article 6eid.\n",
                        BibDatabaseMode.BIBLATEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                            .withField(StandardField.JOURNALTITLE, "Bib(La)TeX Journal")
                ...
                Arguments.of("Foo, B. (n.d.). eid + pages. Bib(La)TeX Journal, Article 6eid.\n",
                        BibDatabaseMode.BIBLATEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                            .withField(StandardField.JOURNALTITLE, "Bib(La)TeX Journal")
                ...
                Arguments.of("Foo, B. (n.d.). eid. Bib(La)TeX Journal, Article Article 6eid.\n",
                        BibDatabaseMode.BIBLATEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                            .withField(StandardField.JOURNALTITLE, "Bib(La)TeX Journal")
                ...
                Arguments.of("Foo, B. (n.d.). volume + pages + eid. Bib(La)TeX Journal, 1, Article 6eid.\n",
                        BibDatabaseMode.BIBLATEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                            .withField(StandardField.JOURNALTITLE, "Bib(La)TeX Journal")
                ...
                Arguments.of("Foo, B. (n.d.). eid + number. Bib(La)TeX Journal, 3number, Article Article 6eid.\n",
                        BibDatabaseMode.BIBLATEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                            .withField(StandardField.JOURNALTITLE, "Bib(La)TeX Journal")
                ...
                Arguments.of("Foo, B. (n.d.). eid + number + pages. Bib(La)TeX Journal, 3number, Article 6eid.\n",
                        BibDatabaseMode.BIBLATEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR, "Foo, Bar")
                            .withField(StandardField.JOURNALTITLE, "Bib(La)TeX Journal")
                ...
                // Not rendering the "issue" field here is sufficient for APA Style (7th
                // edition). Under current circumstances the "number" field takes priority
                // over the "issue" field (see
                // https://github.com/JabRef/jabref/issues/8372#issuecomment-1023768144).
                // [Keyword: IS RENDERING BOTH VIABLE?]. Ideally, they would coexist:
                // "Roughly speaking number subdivides volume and issue is much closer to
                // subdividing year. I don't think I would want to say that issue is
    ...
    void cslMapping(String expected, BibDatabaseMode mode, BibEntry entry, String cslFileName) {
        ...
        String citation = CitationStyleGenerator
            .generateBibliography(List.of(entry),
                    CSLStyleUtils.createCitationStyleFromFile(cslFileName).orElseThrow().getSource(),
                    TEXT_OUTPUT_FORMAT, testEntryContext, ENTRY_TYPES_MANAGER)
            .getFirst();
        assertEquals(expected, citation);
    }
    ...
    static Stream<Arguments> doiFieldMapping() {
        return Stream.of(
                ...
                Arguments.of(
                        ...
                        BibDatabaseMode.BIBLATEX,
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR,
                                "Corti, Roberto and Flammer, Andreas J. and Hollenberg, Norman K. and Lüscher, Thomas F.")
                        ...
                        "apa.csl", CitationStyleOutputFormat.TEXT),

                // Test 2: DOI with https://doi.org/ prefix (behavior: another
                // https://doi.org/ prefix is added from APA style regardless)
                Arguments.of(
                ...
                Arguments.of(
                        ...
                        new BibEntry(StandardEntryType.Article).withField(StandardField.AUTHOR,
                            ...
                            .withField(StandardField.VOLUME, "119")
                            .withField(StandardField.PUBLISHER, "Ovid Technologies (Wolters Kluwer Health)"),
                        "apa.csl", CitationStyleOutputFormat.HTML),
    ...
    @ParameterizedTest
    @MethodSource
    void doiFieldMapping(String expected, BibDatabaseMode mode, BibEntry entry, String cslFileName,
        ...
        String citation = CitationStyleGenerator
            .generateBibliography(List.of(entry),
                    CSLStyleUtils.createCitationStyleFromFile(cslFileName).orElseThrow().getSource(), outputFormat,
                    context, new BibEntryTypesManager())
            .getFirst();
        assertEquals(expected, citation);
    }

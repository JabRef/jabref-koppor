...
/**
 * This class provides helping methods for database tests. Furthermore, it determines
 * database systems which are ready to be used for tests.
 */
public class TestManager {

    /**
     * Determine the DBMSType to test from the environment variable "DMBS". In case that
     * variable is not set, use "PostgreSQL" as default
     */

...
class ProxyTest {
    ...
    /**
     * The test checks if ProxyPreference class is still able to store password and use it
     * from memory, even though it's no longer stored in register.
     */
    @Test
    void proxyPreferencesStorePassword() {
        ...
        ProxyPreferences proxyPref = new ProxyPreferences(useProxy, hostname, port, useAuthentication, username,
                password, persist);

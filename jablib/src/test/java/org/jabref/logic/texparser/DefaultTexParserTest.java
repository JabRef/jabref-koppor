...
class DefaultTexParserTest {
    ...
    private void testMatchCite(String key, String citeString) {
        Path path = Path.of("");
        LatexParserResult latexParserResult = new DefaultLatexParser().parse(
            citeString
        );
    ...
    void fileEncodingForThreeFiles() throws URISyntaxException {
        ...
        LatexParserResults expectedParserResults = new LatexParserResults(
            result1,
            result2,
            result3
        );
    ...
    void fileNotFound() {
        ...
        Optional<LatexParserResult> parserResult =
            new DefaultLatexParser().parse(texFile);
    ...
    void nestedFiles() throws URISyntaxException {
        ...
        expectedParserResult.addNestedFile(
            texFile.getParent().resolve("nested2.tex")
        );

...
public class LtwaRepositoryTest {
    ...
    void ltwaAbbreviations(String fullTitle, String expectedAbbreviation) {
        assertEquals(
            ...
            repository.getLtwaAbbreviation(fullTitle).get()
        );
    }
    ...
    private static Stream<Arguments> provideJournalTitlesAndAbbreviations() {
        return Stream.of(
            ...
            Arguments.of(
                "Ślaski Kwartalnik Historyczny Sobótka",
                "Śl. Kwart. Hist. Sobótka"
            ),
            Arguments.of(
            ...
            Arguments.of(
                "Proceedings of the 2024 Conference on Science",
                "Proc. 2024 Conf. Sci."
            ),
            Arguments.of(

...
public class LtwaRepositoryTest {
    ...
    private static Stream<Arguments> provideJournalTitlesAndAbbreviations() {
        return Stream.of(Arguments.of("Journal of Polymer Science Part A", "J. Polym. Sci. A"),
                Arguments.of("Proceedings of the Institution of Mechanical Engineers, Part A",
                        "Proc. Inst. Mech. Eng. A"),
                Arguments.of("Bulletin of the Section of Logic", "Bull. Sect. Log."),
                Arguments.of("The Lancet", "Lancet"), Arguments.of("Baha'i Studies Review", "Baha'i Stud. Rev."),
                ...
                Arguments.of("Off our backs", "Off our backs"), Arguments.of("Volume!", "Volume!"),
                ...
                Arguments.of("Carniflora Australis", "Carniflora Aust."), Arguments.of("Humana.Mente", "Humana.Mente"),
                ...
                Arguments.of("Mitteilungen der Österreichischen Geographischen Gesellschaft",
                ...
                Arguments.of("Proceedings of the National Academy of    Sciences of the United States of America",

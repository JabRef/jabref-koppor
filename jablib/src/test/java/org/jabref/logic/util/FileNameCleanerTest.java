...
class FileNameCleanerTest {
    ...
    @ParameterizedTest
    @CsvSource({ "legalFilename.txt, legalFilename.txt", "illegalFilename______.txt, illegalFilename/?*<>|.txt",
    ...
    @ParameterizedTest
    @CsvSource({ "legalFilename.txt, legalFilename.txt", "subdir/legalFilename.txt, subdir/legalFilename.txt",

...
class StudyYamlParserTest {
    ...
    void setupStudy() throws URISyntaxException {
        ...
        URL studyDefinition = StudyYamlParser.class.getResource(
            StudyRepository.STUDY_DEFINITION_FILE_NAME
        );
    ...
    void parseStudyFileSuccessfully() throws IOException {
        Study study = new StudyYamlParser().parseStudyYamlFile(
    ...
    @Test
    void readsJabRef57StudySuccessfully()
        ...
        URL studyDefinition = StudyYamlParser.class.getResource(
            "study-jabref-5.7.yml"
        );
        Study study = new StudyYamlParser().parseStudyYamlFile(
            Path.of(studyDefinition.toURI())
        );
        assertEquals(expectedStudy, study);
    }
}

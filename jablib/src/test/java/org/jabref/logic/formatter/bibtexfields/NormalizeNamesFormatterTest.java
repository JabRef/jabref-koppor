...
class NormalizeNamesFormatterTest {
    ...
    void normalizeAuthorList() {
        ...
        assertEquals("Bilbo, Staci D. and Smith, S. H. and Schwarz, Jaclyn M.",
        ...
        assertEquals("Kolb, Stefan and Lenhard, J{\\\"o}rg and Wirtz, Guido",
    ...
    void threeAuthorsSeperatedByColon() {
        assertEquals("Bilbo, Staci and Alver, Morten and Name, Test",
    ...
    void threeAuthorsSeperatedByAndWithDash() {
        assertEquals("Jian, Heng-Yu and Xu, Z. and Chang, M.-C. F.",
    ...
    void threeAuthorsSeperatedByAndWithLatex() {
        assertEquals("Gustafsson, Oscar and DeBrunner, Linda S. and DeBrunner, Victor and Johansson, H{\\aa}kan",
                formatter
                    .format("Oscar Gustafsson and Linda S. DeBrunner and Victor DeBrunner and H{\\aa}kan Johansson"));
    }
    ...
    void concatenationOfAuthorsWithCommas() {
        assertEquals("Ali Babar, M. and Dingsøyr, T. and Lago, P. and van der Vliet, H.",
    ...
    @Test
    void nameAffixe() {
        assertEquals("Surname, jr, First and Surname2, First2",
    ...
    @Test
    void andInName() {
        assertEquals("Surname and , First, Surname2 First2",
    ...
    void avoidPreposition() {
        assertEquals("von Zimmer, Hans and van Oberbergern, Michael and zu Berger, Kevin",
    ...
    void oneCommaUntouched() {
        assertEquals("Canon der Barbar, Alexander der Große",
                formatter.format("Canon der Barbar, Alexander der Große"));
    }

    @Test
    void avoidNameAffixes() {
        assertEquals("der Barbar, Canon and der Große, Alexander and der Alexander, Peter",
                formatter.format("Canon der Barbar, Alexander der Große, Peter der Alexander"));
    }

    @Test
    void upperCaseSensitiveList() {
        assertEquals("der Barbar, Canon and der Große, Alexander",
    ...
    void semiCorrectNamesWithSemicolon() {
        assertEquals("Last, First and Last2, First2 and Last3, First3",
        ...
        assertEquals("Last, First and Last2, First2 and Last3, First3 and Last4, First4",
                formatter.format("Last, First; Last2, First2; Last3, First3; First4 Last4"));
        assertEquals("Last and Last2, First2 and Last3, First3 and Last4, First4",

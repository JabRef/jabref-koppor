...
class RegexFormatterTest {
    ...
    void protectedSpacesNotReplacedInTwoProtectedBlocks() {
        formatter = new RegexFormatter("(\" \",\"-\")");
        assertEquals("replace-spaces-{not these ones}-{or these ones}-but-these-ones",
    ...
    void escapedBracesAreNotReplaced() {
        formatter = new RegexFormatter("(\" \",\"-\")");
        assertEquals("replace-spaces-\\{-these-ones\\}-and-these-ones",
    ...
    void escapedBracesAreNotReplacedInTwoCases() {
        formatter = new RegexFormatter("(\" \",\"-\")");
        assertEquals("replace-spaces-\\{-these-ones\\},-these-ones,-and-\\{-these-ones\\}",
    ...
    void escapedBracesAreNotReplacedAndProtectionStillWorks() {
        formatter = new RegexFormatter("(\" \",\"-\")");
        assertEquals("replace-spaces-{not these ones},-these-ones,-and-\\{-these-ones\\}",

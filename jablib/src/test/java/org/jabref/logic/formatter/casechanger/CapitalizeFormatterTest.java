...
class CapitalizeFormatterTest {
    ...
    @CsvSource(value = { "{}, {}", // {}
            ...
            "upper each First, Upper Each First", // multiple words in lower and upper
                                                  // case
            ...
            "upper each {NOT} first, Upper Each {NOT} First", // multiple words lower case
                                                              // with {}
            "Upper {E}ach {NOT} First, Upper {E}ach {NOT} First", // multiple words
                                                                  // correct with {}
            "UPPER {E}ACH {NOT} FIRST, Upper {E}ach {NOT} First", // multiple words upper
                                                                  // case with {}
            "upper each first {NOT} {this}, Upper Each First {NOT} {this}", // multiple
                                                                            // words in
                                                                            // lower and
                                                                            // upper case
                                                                            // with {}
            "upper each first {N}OT {t}his, Upper Each First {N}ot {t}his", // multiple
                                                                            // words in
                                                                            // lower and
                                                                            // upper case
                                                                            // with {}
            ...
            "{u}pper-each-{f}irst, {u}pper-Each-{f}irst", // multiple words lower case
                                                          // with {} and -

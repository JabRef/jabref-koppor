...
class DoiDuplicationCheckerTest {
    ...
    private BibEntry doiA_entry1 = new BibEntry().withField(
        StandardField.DOI,
        doiA
    );
    private BibEntry doiA_entry2 = new BibEntry().withField(
        StandardField.DOI,
        doiA
    );
    private BibEntry doiB_entry1 = new BibEntry().withField(
        StandardField.DOI,
        doiB
    );
    private BibEntry doiB_entry2 = new BibEntry().withField(
        StandardField.DOI,
        doiB
    );
    private BibEntry doiC_entry1 = new BibEntry().withField(
        StandardField.DOI,
        doiC
    );

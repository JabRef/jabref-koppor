...
public class NoURLCheckerTest {
    ...
    @CsvSource({ "Proceedings of the https://example.com/conference", "Find more at http://mywebsite.org/article",
    ...
    void fieldShouldAcceptURLWithoutProtocol() {
        assertEquals(Optional.empty(),
                checker.checkValue("Applying Trip@dvice Recommendation Technology to www.visiteurope.com"));
    }

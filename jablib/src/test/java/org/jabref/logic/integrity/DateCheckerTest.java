...
class DateCheckerTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = { "2018-04-21", "2018-04", "21-04-2018", "04-2018", "04/18", "04/2018", "April 21, 2018",
            "April, 2018", "21.04.2018", "2018.04.21", "2018" })
    void acceptsValidDates(String s) {
        assertEquals(Optional.empty(), checker.checkValue(s));
    }

    @ParameterizedTest
    @ValueSource(strings = { "2018-04-21TZ", "2018-Apr-21", "2018-Apr-Twentyone", "2018-Apr-Twentyfirst", "2018_04_21",

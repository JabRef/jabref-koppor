...
public class TitleCheckerTest {
    ...
    class BibTexChecker {
        ...
        static Stream<Arguments> validTitle() {
            return Stream.of(
                    Arguments.of("firstLetterAsOnlyCapitalLetterInSubTitle2 ",
                    ...
                    Arguments.of("twoCapitalLettersInSubTitle2WithCurlyBrackets ",
                            "This is a sub title 1: This is {A} sub title 2"),
                    Arguments.of("middleLetterAsOnlyCapitalLetterInSubTitle2WithCurlyBrackets ",
                            "This is a sub title 1: this is {A} sub title 2"),
                    Arguments.of("firstLetterAsOnlyCapitalLetterInSubTitle2AfterContinuousDelimiters ",
                            "This is a sub title 1...This is a sub title 2"),
                    Arguments.of("firstLetterAsOnlyCapitalLetterInEverySubTitleWithContinuousDelimiters ",
                            "This is; A sub title 1.... This is a sub title 2"),
                    Arguments.of("firstLetterAsOnlyCapitalLetterInEverySubTitleWithRandomDelimiters ",
                            "This!is!!A!Title??"),
                    ...
                    Arguments.of("bibTexAcceptsTitleWithLowercaseFirstLetter ", "{C}urrent {C}hronicle"), Arguments
                        .of("bibTexAcceptsOriginalAndTranslatedTitle ", "This is a title [This is translated title]"));
        }
        ...
        static Stream<Arguments> invalidTitle() {
            return Stream.of(
                    ...
                    Arguments.of("middleLetterAsOnlyCapitalLetterInSubTitle2 ",
                            "This is a sub title 1: this is A sub title 2"),
                    Arguments.of("middleLetterAsOnlyCapitalLetterInSubTitle2AfterContinuousDelimiters ",
                            "This is a sub title 1... this is a sub Title 2"),
                    ...
                    Arguments.of("bibTexDoesNotAcceptsLeadingTranslatedTitleWithOriginal ",
    ...
    class BibLaTexChecker {
        ...
        static Stream<Arguments> validTitle() {
            return Stream.of(Arguments.of("bibLaTexAcceptsTitleWithOnlyFirstCapitalLetter", "This is a title"),
                    ...
                    Arguments.of("bibLaTexAcceptsSubTitlesWithOnlyFirstCapitalLetter",
                            "This is a sub title 1: This is a sub title 2"),
                    Arguments.of("bibLaTexAcceptsSubTitleWithLowercaseFirstLetter",
                            "This is a sub title 1: this is a sub title 2"),
                    Arguments.of("bibLaTexAcceptsCapitalLettersInsideSubTitle",
                            "This is a sub title 1: This is A sub title 2"),
                    Arguments.of("bibLaTexRemovesCapitalLetterInsideSubTitle",
                            "This is a sub title 1: this is {A} sub title 2"),
                    Arguments.of("bibLaTexSplitsSubTitlesBasedOnDots", "This is a sub title 1...This is a sub title 2"),
                    Arguments.of("bibLaTexSplitsSubTitleBasedOnSpecialCharacters",
                            "This is; A sub title 1.... This is a sub title 2"),

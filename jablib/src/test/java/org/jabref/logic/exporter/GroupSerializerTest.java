...
class GroupSerializerTest {
    ...
    void serializeSmartGroup() {
        ...
        assertEquals(
            List.of("0 SmartGroup:mySmartGroup;0;1;;;;"),
            serialization
        );
    }
    ...
    void serializeSingleExplicitGroup() {
        ...
        assertEquals(
            List.of("0 StaticGroup:myExplicitGroup;0;1;;;;"),
            serialization
        );
    }
    ...
    void serializeSingleExplicitGroupWithEscapedSlash() {
        ...
        assertEquals(
            List.of("0 StaticGroup:B{\\\\\"{o}}hmer;0;1;;;;"),
            serialization
        );
    }
    ...
    void serializeSingleSimpleKeywordGroup() {
        ...
        assertEquals(
            List.of("0 KeywordGroup:name;0;keywords;test;0;0;1;;;;"),
            serialization
        );
    }
    ...
    void serializeSingleRegexKeywordGroup() {
        ...
        assertEquals(
            List.of("0 KeywordGroup:myExplicitGroup;1;author;asdf;0;1;1;;;;"),
            serialization
        );
    }
    ...
    void serializeSingleSearchGroup() {
        ...
        assertEquals(
            List.of("0 SearchGroup:myExplicitGroup;0;author=harrer;1;1;1;;;;"),
            serialization
        );
    }
    ...
    void serializeSingleAutomaticPersonGroup() {
        ...
        assertEquals(
            List.of("0 AutomaticPersonsGroup:myAutomaticGroup;0;author;1;;;;"),
            serialization
        );
    }
    ...
    void serializeSingleTexGroup() throws IOException {
        ...
        assertEquals(
            List.of("0 TexGroup:myTexGroup;0;path/To/File;1;;;;"),
            serialization
        );
    }

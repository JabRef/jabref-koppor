...
class BstCaseChangersTest {
    ...
    private static Stream<Arguments> provideStringsForTitleLowers() {
        return Stream.of(Arguments.of("i", "i"), Arguments.of("0i~ ", "0I~ "), Arguments.of("Hi hi ", "Hi Hi "),
                Arguments.of("{\\oe}", "{\\oe}"), Arguments.of("Hi {\\oe   }hi ", "Hi {\\oe   }Hi "),
                Arguments.of("Jonathan meyer and charles louis xavier joseph de la vall{\\'e}e poussin",
                ...
                Arguments.of("An {$O(n \\log n / \\! \\log\\log n)$} sorting algorithm",
                        "An {$O(n \\log n / \\! \\log\\log n)$} Sorting Algorithm"),
                Arguments.of("On notions of information transfer in {VLSI} circuits",
                        "On Notions of Information Transfer in {VLSI} Circuits"),

                Arguments.of("hallo", "hallo"), Arguments.of("Hallo", "HAllo"),
                Arguments.of("Hallo world", "HAllo World"), Arguments.of("Hallo world. how", "HAllo WORLD. HOW"),
    ...
    private static Stream<Arguments> provideStringsForAllLowers() {
        return Stream.of(Arguments.of("i", "i"), Arguments.of("0i~ ", "0I~ "), Arguments.of("hi hi ", "Hi Hi "),
                ...
                Arguments.of("jonathan meyer and charles louis xavier joseph de la vall{\\'e}e poussin",
                        "Jonathan Meyer and Charles Louis Xavier Joseph de la Vall{\\'e}e Poussin"),
                Arguments.of("{\\'e}", "{\\'e}"), Arguments.of("{\\'{e}}douard masterly", "{\\'{E}}douard Masterly"),
                Arguments.of("ulrich {\\\"{u}}nderwood and ned {\\~n}et and paul {\\={p}}ot",
                        "Ulrich {\\\"{U}}nderwood and Ned {\\~N}et and Paul {\\={P}}ot"),
                Arguments.of("an {$O(n \\log n / \\! \\log\\log n)$} sorting algorithm",
                        "An {$O(n \\log n / \\! \\log\\log n)$} Sorting Algorithm"),
    ...
    private static Stream<Arguments> provideTitleCaseAllLowers() {
        return Stream.of(
                ...
                // Here some modified test cases to show that escaping with
                // BibtexCaseChanger also works
                // Examples taken from
    ...
    void titleCaseAllUppers() {
        /*
         * the real test would look like as follows. Also from the comment of issue 176,
         * order reversed as the "should be" comes first
         */
        // assertCaseChangerTitleUppers("This is a Simple Example {TITLE}", "This is a
        // simple example {TITLE}");
        // assertCaseChangerTitleUppers("This {IS} Another Simple Example Tit{LE}", "This
        // {IS} another simple example tit{LE}");
        // assertCaseChangerTitleUppers("{What ABOUT thIS} one?", "{What ABOUT thIS}
        // one?");
        // assertCaseChangerTitleUppers("{And {thIS} might {a{lso}} be possible}", "{And
        // {thIS} might {a{lso}} be possible}")
    }

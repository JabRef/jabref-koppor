...
class AutomaticPersonsGroupTest {
    ...
    void createSubgroupsFromCommaSeparatedLastNames() {
        ...
        Set<GroupTreeNode> subgroups = new AutomaticPersonsGroup(
            "",
            GroupHierarchyType.INDEPENDENT,
            StandardField.AUTHOR
        ).createSubgroups(bibEntry);
        GroupTreeNode[] expectedSubgroups = createPersonSubGroupFrom(
            "Turing",
            "Hopper"
        );
    ...
    void createSubgroupFromLatex() {
        ...
        Set<GroupTreeNode> subgroup = new AutomaticPersonsGroup(
            "",
            GroupHierarchyType.INDEPENDENT,
            StandardField.AUTHOR
        ).createSubgroups(bibEntry);

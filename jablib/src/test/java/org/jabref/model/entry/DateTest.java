...
class DateTest {
    ...
    private static Stream<Arguments> validDates() {
        return Stream.of(Arguments.of(LocalDateTime.of(2018, Month.OCTOBER, 3, 7, 24), "2018-10-03T07:24"),
                ...
                Arguments.of(LocalDate.of(2015, Month.JANUARY, 15), "2015.1.15"), Arguments.of(Year.of(2015), "2015"),
                ...
                Arguments.of(Year.of(2015), "2015-"), Arguments.of(Year.of(2015), "2015?"),
                Arguments.of(Year.of(-29), "30 BC"), Arguments.of(Year.of(-29), "0030 BC"),
                Arguments.of(Year.of(2), "2 AD"), Arguments.of(Year.of(2), "0002 AD"),
    ...
    private static Stream<Arguments> validDateRanges() {
        return Stream.of(Arguments.of(Year.of(2014), Year.of(2017), "2014/2017"),
                Arguments.of(YearMonth.of(2015, Month.JANUARY), YearMonth.of(2015, Month.FEBRUARY), "2015-01/2015-02"),
                Arguments.of(LocalDate.of(2015, Month.JANUARY, 15), LocalDate.of(2015, Month.FEBRUARY, 25),
                ...
                Arguments.of(YearMonth.of(-29, Month.JANUARY), YearMonth.of(5, Month.FEBRUARY),
                        "0030-01 BC/0005-02 AD"),
                Arguments.of(YearMonth.of(-29, Month.JANUARY), YearMonth.of(5, Month.FEBRUARY),
                        "0030-01 BC / 0005-02 AD"),
                Arguments.of(YearMonth.of(-29, Month.JANUARY), YearMonth.of(-9, Month.FEBRUARY),
                        "0030-01 BC / 0010-02 BC"),
                Arguments.of(YearMonth.of(5, Month.JANUARY), YearMonth.of(20, Month.FEBRUARY),
    ...
    private static Stream<Arguments> invalidCornerCases() {
        return Stream.of(Arguments.of("", "input value not empty"),
                Arguments.of("32-06-2014", "day of month exists [1]"),
                Arguments.of("00-06-2014", "day of month exists [2]"), Arguments.of("30-13-2014", "month exists [1]"),
    ...
    @Test
    void parseZonedTime() {
        Optional<Date> expected = Optional.of(new Date(ZonedDateTime
            .of(LocalDateTime.of(2018, Month.OCTOBER, 3, 7, 24, 14), ZoneId.from(ZoneOffset.ofHours(3)))));
    ...
    // Date.parse() has been updated to defensively strip surrounding whitespace from
    // input strings.
    @Test

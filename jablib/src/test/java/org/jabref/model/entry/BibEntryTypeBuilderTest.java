...
class BibEntryTypeBuilderTest {
    ...
    void fieldAlreadySeenSameCategory() {
        assertThrows(IllegalArgumentException.class,
                () -> new BibEntryTypeBuilder().withImportantFields(StandardField.AUTHOR)
    ...
    void detailOptionalWorks() {
        BibEntryType bibEntryType = new BibEntryTypeBuilder().withImportantFields(StandardField.AUTHOR)
    ...
    void fieldAlreadySeenDifferentCategories() {
        assertThrows(IllegalArgumentException.class,
                () -> new BibEntryTypeBuilder().withRequiredFields(StandardField.AUTHOR)
                    .withImportantFields(StandardField.AUTHOR)
                    .build());
    }

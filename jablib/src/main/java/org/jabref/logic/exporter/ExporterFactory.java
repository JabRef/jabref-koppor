...
public class ExporterFactory {
    ...
    public static ExporterFactory create(CliPreferences preferences) {
        List<TemplateExporter> customFormats = preferences
        ...
        BibDatabaseMode bibDatabaseMode = preferences
        ...
        exporters.add(
            new TemplateExporter(
                Localization.lang("Markdown titles"),
                "title-md",
                "title-md",
                "title-markdown",
        ...
        exporters.add(
            new EndnoteXmlExporter(preferences.getBibEntryPreferences())
        );

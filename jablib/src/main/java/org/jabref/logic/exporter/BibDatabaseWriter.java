...
public class BibDatabaseWriter {
    ...
    private static List<FieldChange> applySaveActions(
        ...
        FieldFormatterCleanup trimWhiteSpaces = new FieldFormatterCleanup(
    ...
    public void savePartOfDatabase(
        ...
        sharedDatabaseIDOptional.ifPresent(
            Unchecked.consumer(this::writeDatabaseID)
        );
        ...
        if (saveConfiguration.getSaveType() == SaveType.WITH_JABREF_META_DATA) {
            ...
            writeMetaData(
                bibDatabaseContext.getMetaData(),
                keyPatternPreferences.getKeyPatterns()
            );
    ...
    protected void writeString(BibtexString bibtexString, int maxKeyLength)
        ...
        if (
            ...
            LOGGER.debug(
                ...
                bibtexString.getParsedSerialization()
            );
        ...
        if (bibtexString.getContent().isEmpty()) {
            ...
            try {
                String formatted = new FieldWriter(fieldPreferences).write(

...
/**
 * This is a {@link SaveOrder} where the contained saveConfiguration is a
...
public class SelfContainedSaveConfiguration extends SaveConfiguration {
    ...
    public SelfContainedSaveConfiguration(SelfContainedSaveOrder saveOrder, Boolean makeBackup,
            BibDatabaseWriter.SaveType saveType, Boolean reformatFile) {

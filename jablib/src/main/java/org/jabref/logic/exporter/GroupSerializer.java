...
public class GroupSerializer {
    ...
    private String serializeGroup(AbstractGroup group) {
        return switch (group) {
            ...
            case ExplicitGroup explicitGroup -> serializeExplicitGroup(
                explicitGroup
            );
            case KeywordGroup keywordGroup -> serializeKeywordGroup(
                keywordGroup
            );
            case SearchGroup searchGroup -> serializeSearchGroup(searchGroup);
            case AutomaticKeywordGroup keywordGroup -> serializeAutomaticKeywordGroup(
                keywordGroup
            );
            case AutomaticPersonsGroup personsGroup -> serializeAutomaticPersonsGroup(
                personsGroup
            );

...
class BstVMVisitor extends BstBaseVisitor<Integer> {
    ...
    public Integer visitFunctionCommand(BstParser.FunctionCommandContext ctx) {
        ...
        bstVMContext
            .functions()
            .put(name, (visitor, functionContext) ->
    ...
    public Integer visitMacroCommand(BstParser.MacroCommandContext ctx) {
        ...
        bstVMContext
            .functions()
            .put(ctx.id.getText(), (visitor, functionContext) ->
    ...
    public Integer visitReadCommand(BstParser.ReadCommandContext ctx) {
        FieldWriter fieldWriter = new FieldWriter(
            new FieldPreferences(true, List.of(StandardField.MONTH), List.of())
        );
        ...
        for (ParseTree childNode : ctx.children) {
            try {
                ...
                bstVMContext
                    ...
                    .ifPresentOrElse(
                        path ->
                            LOGGER.error("{} ({})", e.getMessage(), path, e),
                        () -> LOGGER.error("", e)
                    );
                throw e;
            }

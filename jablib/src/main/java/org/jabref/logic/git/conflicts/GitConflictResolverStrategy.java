...
public interface GitConflictResolverStrategy {
    ...
    /**
     * Resolves all given entry-level semantic conflicts, and produces a new, resolved
     * remote state.
     * <p>
     * @param conflicts the list of detected three-way entry conflicts
     * @return the modified BibDatabaseContext containing resolved entries, or empty if
     * user canceled merge or CLI refuses to merge.
     */

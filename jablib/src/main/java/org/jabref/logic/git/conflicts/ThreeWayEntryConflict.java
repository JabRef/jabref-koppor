...
@NullMarked
public record ThreeWayEntryConflict(@Nullable BibEntry base, @Nullable BibEntry local, @Nullable BibEntry remote) {
    public ThreeWayEntryConflict {
        assert !(local == null && remote == null)
                : "Both local and remote are null: conflict must involve at least one side.";
    }
}

...
public class CitationKeyDeviationChecker implements EntryChecker {
    ...
    public CitationKeyDeviationChecker(BibDatabaseContext bibDatabaseContext,
    ...
    public List<IntegrityMessage> check(BibEntry entry) {
        ...
        // generate new key
        String generatedKey = new CitationKeyGenerator(bibDatabaseContext, citationKeyPatternPreferences)
            .generateKey(entry);

        if (!Objects.equals(key, generatedKey)) {
            return List.of(new IntegrityMessage(Localization.lang("Citation key deviates from generated key"), entry,

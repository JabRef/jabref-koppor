...
public abstract class AbstractIsbnFetcher implements IdBasedParserFetcher {
     ...
     * @implNote We could have created a new exception (which causes much implementation
     * efforts) or we could have used "FetcherException", which is currently more used for
     * I/O errors than syntax errors (thus also more WTF). Moreover, a ISBN is "kind of"
     * an URI (even if the isbn: prefix is missing)
     */

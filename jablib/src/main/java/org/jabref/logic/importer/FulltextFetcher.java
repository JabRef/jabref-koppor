...
/**
 * This interface is used for classes that try to resolve a full-text PDF url for a BibTex
 * entry. Implementing classes should specialize on specific article sites. See
 * e.g. @link{http://libguides.mit.edu/apis}.
 */
public interface FulltextFetcher {
    ...
    /**
     * Returns the level of trust for this fetcher. We distinguish between publishers and

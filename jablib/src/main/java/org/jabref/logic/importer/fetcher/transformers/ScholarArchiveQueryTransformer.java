...
/**
 * This class extends the AbstractQueryTransformer to provide specific implementations for
 * transforming standard queries into ones suitable for the Scholar Archive's unique
 * format.
 */
public class ScholarArchiveQueryTransformer extends AbstractQueryTransformer {
    ...
    /**
     * Handles the year query by formatting it specifically for a range search in the
     * Scholar Archive. This method is for an exact year match.
     ...
     * @param yearRange the range of years to be searched in the Scholar Archive, usually
     * in the format "startYear-endYear".
    ...
    protected String handleYearRange(String yearRange) {
        ...
        if (endYear == Integer.MAX_VALUE) {
            // If no specific end year is set, it assumes the range extends to the current
            // year.
            return yearRange;
        }

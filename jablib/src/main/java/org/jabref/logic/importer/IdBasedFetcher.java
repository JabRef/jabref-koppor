...
/**
 * Searches web resources for bibliographic information based on an identifier. Examples
 * are ISBN numbers and DOIs.
 */
public interface IdBasedFetcher extends WebFetcher {
     ...
     * @return a {@link BibEntry} containing the bibliographic information (or an empty
     * optional if no data was found)
     */

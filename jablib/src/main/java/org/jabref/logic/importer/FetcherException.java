...
public class FetcherException extends JabRefException {
    ...
    private static final Pattern API_KEY_PATTERN = Pattern.compile(
        "(?i)(?<" + API_KEY_PARAM_NAME + ">api|key|api[-_]?key)=[^&]*"
    );
    ...
    public static String getRedactedUrl(String source) {
        return API_KEY_PATTERN.matcher(source).replaceAll(
            "${" + API_KEY_PARAM_NAME + "}=" + REDACTED_STRING
        );
    }
    ...
    public static FetcherException of(
        URL url,

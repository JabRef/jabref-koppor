...
/**
 * Convenience class for getting BibTeX entries from the BibSonomy scraper, from an URL
...
public class BibsonomyScraper {
    ...
    public static Optional<BibEntry> getEntry(String entryUrl, ImportFormatPreferences importFormatPreferences) {
        try {
            ...
            URL url = URLUtil
                .create(BibsonomyScraper.BIBSONOMY_SCRAPER + cleanURL + BibsonomyScraper.BIBSONOMY_SCRAPER_POST);

...
public class StringSimilarity {
    ...
    /**
     * String similarity based on Levenshtein, ignoreCase, and fixed metric threshold of
     * 4.
    ...
    public double editDistanceIgnoreCase(String a, String b) {
        // TODO: Locale is dependent on the language of the strings. English is a good
        // denominator.

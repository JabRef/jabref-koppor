...
/**
 * This class is based on http://stackoverflow.com/a/5626340/873282 extended with LEFT
 * CURLY BRACE and RIGHT CURLY BRACE Replaces illegal characters in given file paths.
 *
...
public class FileNameCleaner {
    ...
    /**
     * Replaces illegal characters in given directoryName by '_'. Directory name may
     * contain directory separators, e.g. 'deep/in/a/tree'; these are left untouched.
     * @param badFileName the fileName to clean
     * @return a clean filename
     */

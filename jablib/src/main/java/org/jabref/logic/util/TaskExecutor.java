...
/**
 * An object that executes submitted {@link javafx.concurrent.Task}s. This interface
 * provides a way of decoupling task submission from the mechanics of how each task will
 * be run, including details of thread use, scheduling, thread pooling, etc.
 */
public interface TaskExecutor {
    ...
    /**
     * Shutdown the task executor. May happen in the background or may be finished when
     * this method returns.
     */
    void shutdown();

...
public final class BuildInfo {
    ...
    public static final String JAVA_VERSION = System.getProperty("java.version", UNKNOWN_VERSION)
    ...
    public BuildInfo(String path) {
        ...
        biodiversityHeritageApiKey = BuildInfo.getValue(properties, "biodiversityHeritageApiKey",
        ...
        springerNatureAPIKey = BuildInfo.getValue(properties, "springerNatureAPIKey",
    ...
    private static String getValue(Properties properties, String key, String defaultValue) {
        String result = Optional.ofNullable(properties.getProperty(key))
            // workaround unprocessed build.properties file --> just remove the reference
            // to some variable used in build.gradle

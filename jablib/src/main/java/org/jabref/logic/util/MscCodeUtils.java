...
public class MscCodeUtils {
     ...
     */
    @NonNull
    public static Optional<HashBiMap<String, String>> loadMscCodesFromJson(
        URL resourceUrl
    ) throws MscCodeLoadingException {
        ...
        try {
            ...
            throw new MscCodeLoadingException(
                "Failed to parse MSC codes from JSON",
                e
            );
        } catch (IOException e) {
            LOGGER.error("Error loading MSC codes from JSON URL", e);
            throw new MscCodeLoadingException(
                "Failed to load MSC codes from JSON URL",
                e
            );
        }
    }

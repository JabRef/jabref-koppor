...
public class MscCodeUtils {
     ...
     */
    @NonNull
    public static Optional<HashBiMap<String, String>> loadMscCodesFromJson(URL resourceUrl)
            throws MscCodeLoadingException {

        ObjectMapper mapper = new ObjectMapper();
        try {
            Map<String, String> mapping = mapper.readValue(resourceUrl, new TypeReference<>() {
            });

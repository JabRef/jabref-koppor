...
public abstract class AbstractCitationKeyPatterns {
    ...
    public String toString() {
        return "AbstractCitationKeyPattern{" + "defaultPattern='" + defaultPattern + '\'' + ", data='" + data + '\''
                + "}";
    }
     ...
     * parents (in the case of DatabaseCitationKeyPattern). This method first tries to
     * obtain the object from this CitationKeyPattern via the <code>get</code> method of
     * <code>Hashtable</code>. If this fails, we try the default.<br />

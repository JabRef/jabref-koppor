 ...
 * help repository at Github.
 *
 * @see <a href=
 * "https://github.com/JabRef/user-documentation">user-documentation@github</a>
 */
public enum HelpFile {

    // empty string denotes that it refers to the TOC/index
    CONTENTS(""), // this is always the index
    ENTRY_EDITOR("advanced/entryeditor"), STRING_EDITOR("setup/stringeditor"),
    ...
    CITATION_KEY_PATTERN("setup/citationkeypatterns"), OWNER("advanced/entryeditor/owner"),
    ...
    FETCHER_ADS("collect/import-using-online-bibliographic-database#ads"), FETCHER_BIBSONOMY_SCRAPER(""),
    ...
    FETCHER_TITLE("collect/add-entry-using-an-id"), FETCHER_SCIENCEDIRECT(""),
    ...
    PUSH_TO_APPLICATION("cite/pushtoapplications"), AI_GENERAL_SETTINGS("ai/preferences"),
    AI_EXPERT_SETTINGS("ai/preferences#ai-expert-settings"), AI_TEMPLATES("ai/preferences#templates");

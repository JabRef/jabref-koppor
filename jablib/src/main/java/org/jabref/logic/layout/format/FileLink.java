...
/**
 * Export formatter that handles the file link list of JabRef 2.3 and later, by selecting
 * the first file link, if any, specified by the field.
 */
public class FileLink implements ParamLayoutFormatter {
    ...
    /**
     * This method is called if the layout file specifies an argument for this formatter.
     * We use it as an indicator of which file type we should look for.

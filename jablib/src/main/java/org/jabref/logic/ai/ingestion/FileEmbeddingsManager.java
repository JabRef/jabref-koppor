...
public class FileEmbeddingsManager {
    ...
    public FileEmbeddingsManager(
        ...
        this.lowLevelIngestor = new LowLevelIngestor(
            aiPreferences,
            embeddingStore,
            embeddingModel
        );
    ...
    public void addDocument(
        ...
        lowLevelIngestor.ingestDocument(
            document,
            shutdownSignal,
            workDone,
            workMax
    ...
    public Optional<Long> getIngestedDocumentModificationTimeInSeconds(
        ...
        return fullyIngestedDocumentsTracker.getIngestedDocumentModificationTimeInSeconds(
            link
        );
    }

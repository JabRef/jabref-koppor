...
public class MVStoreChatHistoryStorage
    extends MVStoreBase
    implements ChatHistoryStorage {
    ...
    private record ChatHistoryRecord(
        ...
        private static final Logger LOGGER = LoggerFactory.getLogger(
            ChatHistoryRecord.class
        );

        public static ChatHistoryRecord fromLangchainMessage(
        ...
        private static String getContentFromLangchainMessage(
            ChatMessage chatMessage
        ) {
            String content;
            ...
            switch (chatMessage) {
                ...
                case UserMessage userMessage -> content =
                    userMessage.singleText();
                case ErrorMessage errorMessage -> content =
    ...
    public MVStoreChatHistoryStorage(
        Path path,
    ...
    @Override
    public List<ChatMessage> loadMessagesForEntry(
        Path bibDatabasePath,
        String citationKey
    ) {
        return loadMessagesFromMap(
            getMapForEntry(bibDatabasePath, citationKey)
        );
    }
    ...
    @Override
    public List<ChatMessage> loadMessagesForGroup(
        Path bibDatabasePath,
        String name
    ) {
    ...
    private List<ChatMessage> loadMessagesFromMap(
        Map<Integer, ChatHistoryRecord> map
    ) {
        return map
            .entrySet()
    ...
    private Map<Integer, ChatHistoryRecord> getMapForGroup(
        Path bibDatabasePath,
        String name
    ) {
    ...
    private Map<Integer, ChatHistoryRecord> getMap(
        Path bibDatabasePath,
        String type,
        String name
    ) {

...
public class Gpt4AllModel implements ChatModel {
    ...
    public ChatResponse chat(List<ChatMessage> list) {
        ...
        List<Message> messages = list.stream().map(chatMessage -> switch (chatMessage) {
        ...
        try {
            ...
            TextGenerationResponse textGenerationResponse = gson.fromJson(response.body(),
            ...
            // This class is not a complete implementation of langchain4j's
            // ChatLanguageModel.

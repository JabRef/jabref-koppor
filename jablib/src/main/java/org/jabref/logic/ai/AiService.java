...
public class AiService implements AutoCloseable {
    ...
    private final BooleanProperty shutdownSignal = new SimpleBooleanProperty(
        false
    );
    ...
    private final ExecutorService cachedThreadPool =
        Executors.newCachedThreadPool(
            new ThreadFactoryBuilder()
                .setNameFormat("ai-retrieval-pool-%d")
                .build()
        );
    ...
    public AiService(
        ...
        this.mvStoreFullyIngestedDocumentsTracker =
            new MVStoreFullyIngestedDocumentsTracker(
                Directories.getAiFilesDirectory().resolve(
                    FULLY_INGESTED_FILE_NAME
                ),
                notificationService
            );
        ...
        this.chatHistoryService = new ChatHistoryService(
            ...
            mvStoreChatHistoryStorage
        );
        this.jabRefChatLanguageModel = new JabRefChatLanguageModel(
            aiPreferences
        );
        this.jabRefEmbeddingModel = new JabRefEmbeddingModel(
            aiPreferences,
            notificationService,
            taskExecutor
        );

...
public class URLCleanup implements CleanupJob {
    ...
    private static final String DATE_TERMS_REGEX =
    ...
    private static final Pattern DATE_TERMS_PATTERN = Pattern.compile(
        DATE_TERMS_REGEX,
        Pattern.CASE_INSENSITIVE
    );
    ...
    public List<FieldChange> cleanup(BibEntry entry) {
        ...
        final Matcher dateTermsMatcher = DATE_TERMS_PATTERN.matcher(
            noteFieldValue
        );

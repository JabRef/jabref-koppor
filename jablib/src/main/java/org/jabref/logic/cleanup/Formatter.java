...
/**
 * The Formatter is used for a Filter design-pattern. Extending classes have to accept a
 * String and returned a formatted version of it. Implementations have to reside in the
 * logic package.
 * <p>
 * Example:
 * <p>
...
public abstract class Formatter {
    ...
    /**
     * Returns an example input string of the formatter. This example is used as input to
     * the formatter to demonstrate its functionality
    ...
    /**
     * Indicates whether some other object is the same formatter as this one based on the
     * key.

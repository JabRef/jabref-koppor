...
public class PushToApplicationPreferences {
    ...
    public PushToApplicationPreferences(
        ...
        this.activeApplicationName = new SimpleStringProperty(
            activeApplicationName
        );
        this.commandPaths = new SimpleMapProperty<>(
    ...
    public PushToApplicationPreferences withCitationCommand(
        CitationCommandString config
    ) {

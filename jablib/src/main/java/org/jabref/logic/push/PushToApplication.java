...
public interface PushToApplication {
    ...
    /**
     * Gets the display name for the push operation. This name is used in the GUI to
     * represent the push action to the user.
     * @return The display name for the push operation.
     */
    String getDisplayName();

    /**
     * The actual operation. This method will not be called on the event dispatch thread,
     * so it should not do GUI operations without utilizing invokeLater().
     */
    ...
    /**
     * Check whether this operation requires citation keys to be set for the entries. If
     * true is returned an error message will be displayed if keys are missing.

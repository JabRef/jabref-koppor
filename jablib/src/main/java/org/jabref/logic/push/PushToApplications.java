...
public class PushToApplications {
    ...
    public static Optional<PushToApplication> getApplicationById(String applicationId,
            NotificationService notificationService, PushToApplicationPreferences pushToApplicationPreferences) {
    ...
    public static Optional<PushToApplication> getApplication(PushApplications application,
            NotificationService notificationService, PushToApplicationPreferences preferences) {

...
class StudyCatalogToFetcherConverter {
     ...
     *
     * A fetcher is considered active if there exists an library entry of the library the
     * fetcher is associated with that is enabled.
    ...
    /**
     * Transforms a library entry into a SearchBasedFetcher instance. This only works if
     * the library entry specifies a supported fetcher.

...
/**
 * Class to model a reference mark. See {@link CSLReferenceMarkManager} for the usage and
 * management of all reference marks.
 */
public class CSLReferenceMark {
    ...
    public static CSLReferenceMark of(List<String> citationKeys, List<Integer> citationNumbers,
            XMultiServiceFactory factory) throws Exception {
    ...
    private static String buildReferenceName(List<String> citationKeys, List<Integer> citationNumbers,
            String uniqueId) {
        ...
        for (int i = 0; i < citationKeys.size(); i++) {
            ...
            nameBuilder.append(ReferenceMark.PREFIXES[0])
    ...
    public void updateName(String newName) {
        this.referenceMark = new ReferenceMark(newName, this.citationKeys, this.citationNumbers,

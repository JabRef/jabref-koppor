...
public class ExportCited {
     ...
     * @return A new database, with cloned entries. If a key is not found, it is added to
     * result.unresolvedKeys
     * <p>
     * Cross references (in StandardField.CROSSREF) are followed (not recursively): If the
     * referenced entry is found, it is included in the result. If it is not found, it is
     * silently ignored.
     */

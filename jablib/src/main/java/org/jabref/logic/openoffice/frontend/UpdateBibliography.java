...
public class UpdateBibliography {
     ...
     */
    public static void rebuildBibTextSection(XTextDocument doc, OOFrontend frontend, CitedKeys bibliography,
            JStyle style, boolean alwaysAddCitedOnPages)
    ...
    private static void clearBibTextSectionContent2(XTextDocument doc)
        ...
        // Optional<XTextRange> sectionRange = UnoTextSection.getAnchor(doc,
        // BIB_SECTION_NAME);
     ...
     */
    private static void populateBibTextSection(XTextDocument doc, OOFrontend frontend, CitedKeys bibliography,
            JStyle style, boolean alwaysAddCitedOnPages) throws CreationException, IllegalArgumentException,
            NoDocumentException, WrappedTargetException, IOException {
        ...
        OOText bibliographyText = OOFormatBibliography.formatBibliography(frontend.citationGroups, bibliography, style,

...
public class CSLCitationOOAdapter {
    ...
    public CSLCitationOOAdapter(
        XTextDocument doc,
        Supplier<List<BibDatabaseContext>> databasesSupplier,
    ...
    public void insertCitation(
        ...
        if (isAlphanumericStyle) {
            citation = CSLFormatUtils.generateAlphanumericCitation(
                entries,
                bibDatabaseContext
            );
        } else {
            citation = CitationStyleGenerator.generateCitation(
                entries,
                style,
                HTML_OUTPUT_FORMAT,
                bibDatabaseContext,
        ...
        if (isNumericStyle) {
            formattedCitation = updateSingleOrMultipleCitationNumbers(
                formattedCitation,
                entries
            );
        }

        OOText ooText = OOFormat.setLocaleNone(
            OOText.fromString(formattedCitation)
        );
    ...
    public void insertInTextCitation(
        ...
        while (iterator.hasNext()) {
            ...
            if (isAlphanumericStyle) {
                inTextCitation =
                    CSLFormatUtils.generateAlphanumericInTextCitation(
                        currentEntry,
                        bibDatabaseContext
                    );
            } else {
                inTextCitation = CitationStyleGenerator.generateCitation(
            ...
            String formattedCitation = CSLFormatUtils.transformHTML(
                inTextCitation
            );
            String finalText;
            ...
            if (isNumericStyle) {
                ...
                String prefix = CSLFormatUtils.generateAuthorPrefix(
                    currentEntry,
                    bibDatabaseContext
                );
     ...
     */
    public void insertEmptyCitation(
        XTextCursor cursor,
        CitationStyle selectedStyle,
        List<BibEntry> entries
    ) throws CreationException, Exception {
    ...
    public void insertBibliography(
        ...
        OOTextIntoOO.write(
            document,
            cursor,
            OOText.fromString(title.toString())
        );
        ...
        if (isNumericStyle) {
            ...
            for (BibEntry entry : entries) {
                ...
                String formattedBibliographyEntry =
                    CSLFormatUtils.transformHTML(bibliographyEntry);
    ...
    private void insertReferences(
        ...
        XTextCursor checkCursor = cursor
            .getText()
     ...
     */
    private String updateSingleOrMultipleCitationNumbers(
        String citation,
        List<BibEntry> entries
    ) {
        ...
        while (matcher.find() && iterator.hasNext()) {
            ...
            int currentNumber = markManager.getCitationNumber(
                iterator.next().getCitationKey().orElse("")
            );

            matcher.appendReplacement(
                sb,
                Matcher.quoteReplacement(prefix + currentNumber + suffix)
            );
        }
     ...
     */
    private void updateAllCitationsWithNewStyle(
        CitationStyle style,
        boolean isInTextStyle
        ...
        */
        ...
        List<BibEntry> citedEntries = databases
            .stream()
        ...
        BibDatabaseContext unifiedBibDatabaseContext = new BibDatabaseContext(
            unifiedDatabase
        );
        ...
        if (isInTextStyle) {
            ...
            for (CSLReferenceMark mark : marksInOrder) {
                ...
                List<BibEntry> entries = citationKeys
                    .stream()
                ...
                while (iterator.hasNext()) {
                    ...
                    if (isNumericStyle) {
                        ...
                        formattedCitation = CSLFormatUtils.changeToInText(
                            formattedCitation
                        );
                    }
                ...
                markManager.updateMarkAndTextWithNewStyle(
                    mark,
                    finalText.toString()
                );
            }
            ...
            for (CSLReferenceMark mark : marksInOrder) {
                ...
                if (isAlphaNumericStyle) {
                    newCitation = CSLFormatUtils.generateAlphanumericCitation(
                        entries,
                        unifiedBibDatabaseContext
                    );
                } else {

 ...
 * <li>For "ONLY_ABBREVIATED", the auto completer returns the first name abbreviated, e.g.
 * "Smith, B."</li>
...
public enum AutoCompleteFirstNameMode {
    ...
    ONLY_FULL, ONLY_ABBREVIATED, BOTH;
    ...
    public static AutoCompleteFirstNameMode parse(String input) {
        try {
            ...
            // Should only occur when preferences are set directly via preferences.put and
            // not via setFirstnameMode

...
public class BibEntryCompare {
    ...
    public enum Result {
        ...
        SUBSET, EQUAL, SUPERSET, DISJUNCT, DISJUNCT_OR_EQUAL_FIELDS, DIFFERENT

    }

    /**
     * @return first {Result} second, e.g., if first is a subset of second, then
     * Result.SUBSET is returned.
     */

...
public class TitleCaseFormatter extends Formatter {
     ...
     * conjunctions to lower case Capitalizes first and last word Does not change words
     * starting with "{"
     */
    @Override
    public String format(String input) {
        return StringUtil.getStringAsSentences(input).stream().map(sentence -> {
    ...
    public String getDescription() {
        return Localization
            .lang("Capitalize all Words, but Converts Articles, Prepositions, and Conjunctions to Lower Case.");
    }

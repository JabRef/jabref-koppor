...
/**
 * This exception is thrown if a BibEntry with smaller version number is going to be used
 * for an update on the shared side. The principle of optimistic offline lock forbids
 * updating with obsolete objects.
 */

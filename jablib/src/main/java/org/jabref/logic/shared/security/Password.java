...
/**
 * {@link Password} contains methods which are useful to encrypt and decrypt passwords
 * using symetric algorithms.
 */
public class Password {
    ...
    /**
     * Decrypts the set phrase/password which was encrypted via
     * {@link Password#encrypt()}.

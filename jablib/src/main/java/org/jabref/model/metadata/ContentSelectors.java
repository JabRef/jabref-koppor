...
public class ContentSelectors {
    ...
    public static final List<Field> DEFAULT_FIELD_NAMES = List.of(
    ...
    public ContentSelectors() {
        contentSelectors = new TreeSet<>((o1, o2) -> {
            ...
            List<FieldProperty> properties1 = o1
                .getField()
                .getProperties()
                .stream()
                .sorted()
                .toList();
            List<FieldProperty> properties2 = o2
                .getField()
                .getProperties()
                .stream()
                .sorted()
    ...
    public static Map<Field, List<String>> getFieldKeywordsMap(
        ...
        contentSelectors.forEach(existingContentSelector ->

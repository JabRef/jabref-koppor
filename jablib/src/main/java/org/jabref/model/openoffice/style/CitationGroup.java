...
public class CitationGroup {
    ...
    public CitationGroup(
        ...
        this.citationsInStorageOrder = Collections.unmodifiableList(
            citationsInStorageOrder
        );
        this.localOrder = OOListUtil.makeIndices(
            citationsInStorageOrder.size()
        );
    ...
    void imposeLocalOrder(Comparator<BibEntry> entryComparator) {
        ...
        this.localOrder = OOListUtil.order(
            citationsInStorageOrder,

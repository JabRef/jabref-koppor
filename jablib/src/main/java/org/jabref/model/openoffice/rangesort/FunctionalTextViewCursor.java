...
public class FunctionalTextViewCursor {
    ...
    public static OOResult<FunctionalTextViewCursor, String> get(
        ...
        XServiceInfo initialSelection = UnoSelection.getSelectionAsXServiceInfo(
            doc
        ).orElse(null);
        ...
        if (initialSelection == null) {
            ...
            Arrays.stream(
                initialSelection.getSupportedServiceNames()
    ...
    private static void restore(
        ...
        if (initialPosition != null) {
            XTextViewCursor viewCursor = UnoCursor.getViewCursor(doc).orElse(
                null
            );
            if (viewCursor != null) {

...
public class UnoSelection {
    ...
    /**
     * @return may be Optional.empty(), or some type supporting XServiceInfo So far it
     * seems the first thing we have to do with a selection is to decide what do we have.
     * <p>
     * One way to do that is accessing its XServiceInfo interface.
     * <p>
     * Experiments using printServiceInfo with cursor in various positions in the
     * document:
     * <p>
     * With cursor within the frame, in text: *** xserviceinfo.getImplementationName:
     * "SwXTextRanges" "com.sun.star.text.TextRanges"
     * <p>
     * With cursor somewhere else in text: *** xserviceinfo.getImplementationName:
     * "SwXTextRanges" "com.sun.star.text.TextRanges"
     * <p>
     * With cursor in comment (also known as "annotation"): *** XSelectionSupplier is OK
     * *** Object initialSelection is null *** xserviceinfo is null
     * <p>
     * With frame selected: *** xserviceinfo.getImplementationName: "SwXTextFrame"
     * "com.sun.star.text.BaseFrame" "com.sun.star.text.TextContent"
     * "com.sun.star.document.LinkTarget" "com.sun.star.text.TextFrame"
     * "com.sun.star.text.Text"
     * <p>
     * With cursor selecting an inserted image: *** XSelectionSupplier is OK *** Object
     * initialSelection is OK *** xserviceinfo is OK ***
     * xserviceinfo.getImplementationName: "SwXTextGraphicObject"
     * "com.sun.star.text.BaseFrame" "com.sun.star.text.TextContent"
     * "com.sun.star.document.LinkTarget" "com.sun.star.text.TextGraphicObject"
     */
    ...
    /**
     * Select the object represented by {@code newSelection} if it is known and selectable
     * in this {@code XSelectionSupplier} object.
     * <p>
     * Presumably result from {@code XSelectionSupplier.getSelection()} is usually OK. It
     * also accepted {@code XTextRange newSelection = doc.getText().getStart();}
     */

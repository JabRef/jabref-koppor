 ...
 * <p>
 * Some of the tags can be added using OOFormat methods. Others come from the layout
 * engine, either by interpreting LaTeX markup or from settings in the jstyle file.
 */
public class OOText {

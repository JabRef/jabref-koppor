...
public class UnoNamed {
     ...
     * @param service For example "com.sun.star.text.ReferenceMark",
     * "com.sun.star.text.Bookmark" or "com.sun.star.text.TextSection".
     * <p>
     * Passed to this.asXMultiServiceFactory().createInstance(service) The result is
     * expected to support the XNamed and XTextContent interfaces.
    ...
    static XNamed insertNamedTextContent(String service, DocumentAnnotation documentAnnotation)
        ...
        documentAnnotation.range()
            .getText()
            .insertTextContent(documentAnnotation.range(), xTextContent, documentAnnotation.absorb());
        return xNamed;
    }

...
public class UnoProperties {
    ...
    public static Optional<XPropertySetInfo> getPropertySetInfo(
        ...
        return Optional.ofNullable(propertySet).flatMap(e ->
            Optional.ofNullable(e.getPropertySetInfo())
        );
    }
    ...
    public static Optional<XPropertySetInfo> getPropertySetInfo(
        ...
        return Optional.ofNullable(propertyContainer).flatMap(
            UnoProperties::getPropertySetInfo
        );
    }

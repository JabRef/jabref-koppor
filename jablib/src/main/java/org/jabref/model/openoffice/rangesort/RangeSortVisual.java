 ...
 * (top-down,left-to-right) order interpreted as-on-the-screen: an XTextRange at the top
 * of the second column or second page is sorted before an XTextRange at the bottom of the
...
public class RangeSortVisual {
     ...
     */
    public static <T> List<RangeSortable<T>> visualSort(List<RangeSortable<T>> inputs, XTextDocument doc,
    ...
    /**
     * Given a location, return its position: coordinates relative to the top left
     ...
     * <p>
     * Note: The "relative to the top left position of the first page" is meant "as it
     ...
     * @param cursor To get the position, we need az XTextViewCursor. It will be moved to
     * the range.
     */
     ...
     * <p>
     * Comparison is based on (Y,X,indexInPosition): vertical compared first, horizontal
     * second, indexInPosition third.
     * <p>

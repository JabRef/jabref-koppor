 ...
 * <p>
 * These do not cover all tags, only those needed to embed markup from Layout and citation
 * marker formatters into citation markers and bibliography.
 */
public class OOFormat {
     ...
     * <p>
     * The territory part is not only optional, the allowed "codes are vendor and
     * browser-specific", so probably best to avoid them if possible.
     */
    ...
    /**
     * Mark {@code ootext} as using the character locale "zxx", which means "no language",
     ...
     * @param charStyle Name of a character style known to OO. May be empty for
     * "Standard", which in turn means do not override any properties.
     */
    ...
    /**
     * Format an OO cross-reference showing the target's page number as label to a
     * reference mark.
     */

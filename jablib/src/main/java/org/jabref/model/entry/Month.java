...
public enum Month {
    ...
    JANUARY("January", "jan", 1), FEBRUARY("February", "feb", 2), MARCH("March", "mar", 3), APRIL("April", "apr", 4),
    MAY("May", "may", 5), JUNE("June", "jun", 6), JULY("July", "jul", 7), AUGUST("August", "aug", 8),
    SEPTEMBER("September", "sep", 9), OCTOBER("October", "oct", 10), NOVEMBER("November", "nov", 11),
    ...
    /**
     * Find month by one-based number. If the number is not in the valid range, then an
    ...
    /**
     * Find month by shortName (3 letters) case-insensitive. If no matching month is
    ...
    /**
     * This method accepts three types of months: - Single and Double Digit months from 1
     * to 12 (01 to 12) - 3 Digit BibTeX strings (jan, feb, mar...) possibly with #
     * prepended - Full English Month identifiers.
    ...
    /**
     * Parses a month having the string in German standard form such as "Oktober" or in
     * German short form such as "Okt"
     * @param value a String that represents a month in German form
     * @return the corresponding month instance, empty if input is not in German form
     */
    ...
    /**
     * Returns the month in JabRef format. The format is the short 3-digit name surrounded
     * by a '#' (FieldWriter.BIBTEX_STRING_START_END_SYMBOL). Example: #jan#, #feb#, etc.
     * <p>
     * See
     * <a href="https://github.com/JabRef/jabref/issues/263#issuecomment-151246595">Issue
     * 263</a> for a discussion on that thing. This seems to be an <em>invalid</em> format
     * in terms of plain BiBTeX, but a <em>valid</em> format in the case of JabRef. The
     * documentation is available at the
     * <a href="https://docs.jabref.org/fields/strings">Strings help</a> of JabRef.
    ...
    /**
     * Returns the number of the Month in a 1-indexed fashion: 1 -> January, 2 -> February
     * etc.
    ...
    /**
     * Returns the number of the Month in a 1-indexed fashion using exactly two digits: 01
     * -> January, 02 -> February...

...
/**
 * Our representation of the type of the FileAnnotation. This is needed as some
 * FileAnnotationTypes require special handling (e.g., Highlight or Underline), because of
 * the linked FileAnnotations.
 */

public enum FileAnnotationType {

    TEXT("Text", false), HIGHLIGHT("Highlight", true), SQUIGGLY("Squiggly", true), UNDERLINE("Underline", true),
    STRIKEOUT("StrikeOut", true), POLYGON("Polygon", false), POPUP("Popup", false), LINE("Line", false),
    CIRCLE("Circle", false), FREETEXT("FreeText", false), INK("Ink", false), UNKNOWN("Unknown", false),
    NONE("None", false);
    ...
    /**
     * Determines the FileAnnotationType of a raw PDAnnotation. Returns 'UNKNOWN' if the
     * type is currently not in our list of FileAnnotationTypes.
    ...
    public static FileAnnotationType parse(PDAnnotation annotation) {
        try {
            ...
            LOGGER.info("FileAnnotationType {} is not supported and was converted into 'Unknown'!",

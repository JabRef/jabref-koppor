...
public enum EmbeddingModel {
    ZEROHELL_TINYDPR_ACC_0_315_BS_307(
        "zerohell/tinydpr-acc_0.315-bs_307",
        45821255L
    ),
    ...
    DAEKEUN_ML_KOELECTRA_SMALL_V3_KORSTS(
    ...
    TAVAKOLIH_ALL_MINILM_L6_V2_PUBMED_FULL(
        "tavakolih/all-MiniLM-L6-v2-pubmed-full",
        91838102L
    ),
    TEKRAJ_AVODAMED_SYNONYM_GENERATOR1(
        "tekraj/avodamed-synonym-generator1",
        91838145L
    ),
    RIOLITE_PRODUCTS_MATCHING_AUMET_FINE_TUNE_2023_08_22(
        "RIOLITE/products_matching_aumet_fine_tune_2023-08-22",
        91839291L
    ),
    ...
    VALURANK_MINILM_L6_KEYWORD_EXTRACTION(
    ...
    SEZNAM_SIMCSE_DIST_MPNET_CZENG_CS_EN(
        "Seznam/simcse-dist-mpnet-czeng-cs-en",
        99167904L
    ),
    SEZNAM_DIST_MPNET_PARACRAWL_CS_EN(
        "Seznam/dist-mpnet-paracrawl-cs-en",
        99168001L
    ),
    KORNWTP_CONGEN_WANGCHANBERT_SMALL(
        "kornwtp/ConGen-WangchanBERT-Small",
        116473324L
    ),
    MRP_SCT_DISTILLATION_BERT_SMALL(
        "mrp/SCT_Distillation_BERT_Small",
        117991002L
    ),
    ...
    YUNYU_SENTENCE_TRANSFORMERS_E5_SMALL_V2(
        "yunyu/sentence-transformers-e5-small-v2",
        134456313L
    ),
    ...
    SENTENCE_TRANSFORMERS_ALL_MINILM_L6_V1(
    ...
    INTFLOAT_E5_SMALL_UNSUPERVISED(
        "intfloat/e5-small-unsupervised",
        267690846L
    ),
    SENTENCE_TRANSFORMERS_ALL_MINILM_L12_V1(
        "sentence-transformers/all-MiniLM-L12-v1",
        267711998L
    ),
    METARANK_CE_ESCI_MINILM_L12_V2(
    ...
    HUM_WORKS_LODESTONE_BASE_4096_V1(
    ...
    GANYMEDENIL_TEXT2VEC_BASE_CHINESE(
        "GanymedeNil/text2vec-base-chinese",
        409692389L
    ),
    RYANLAI_SHIBING624_TEXT2VEC_BASE_CHINESE_FINE_TUNE_INSURANCE_DATA(
        "ryanlai/shibing624_text2vec-base-chinese-fine-tune-insurance_data",
        409693794L
    ),
    DMETASOUL_SBERT_CHINESE_GENERAL_V2(
    ...
    DMETASOUL_SBERT_CHINESE_GENERAL_V1(
    ...
    KAMALKRAJ_BIOSIMCSE_BIOLINKBERT_BASE(
    ...
    PRITAMDEKA_S_BIOBERT_SNLI_MULTINLI_STSB(
    ...
    ALFANEO_JURISBERT_BASE_PORTUGUESE_STS(
        "alfaneo/jurisbert-base-portuguese-sts",
        436521076L
    ),
    ANATEL_BERT_AUGMENTED_PT_ANATEL(
        "anatel/bert-augmented-pt-anatel",
        436668456L
    ),
    JEGORMEISTER_BERT_BASE_DUTCH_CASED_SNLI(
    ...
    CASKCSG_COTMAE_BASE_MSMARCO_RETRIEVER(
    ...
    PRITAMDEKA_S_PUBMEDBERT_MS_MARCO(
    ...
    NEUML_PUBMEDBERT_BASE_EMBEDDINGS(
        "NeuML/pubmedbert-base-embeddings",
        438938814L
    ),
    JOSELUHF11_SYMPTOM_ENCODER_V10(
        "joseluhf11/symptom_encoder_v10",
        438945770L
    ),
    ...
    ESPEJELOMAR_SENTECE_EMBEDDINGS_BETO(
        "espejelomar/sentece-embeddings-BETO",
        440451936L
    ),
    RECOBO_CHEMICAL_BERT_UNCASED_TSDAE(
        "recobo/chemical-bert-uncased-tsdae",
        440455185L
    ),
    RECOBO_CHEMICAL_BERT_UNCASED_SIMCSE(
    ...
    DANGVANTUAN_SENTENCE_CAMEMBERT_BASE(
    ...
    EFEDERICI_CROSS_ENCODER_UMBERTO_STSB(
        "efederici/cross-encoder-umberto-stsb",
        445782000L
    ),
    PKSHATECH_SIMCSE_JA_BERT_BASE_CLCMLP(
    ...
    SNUNLP_KR_SBERT_V40K_KLUENLI_AUGSTS(
    ...
    M3HRDADFI_BERT_ZWNJ_WNLI_MEAN_TOKENS(
        "m3hrdadfi/bert-zwnj-wnli-mean-tokens",
        474471928L
    ),
    M3HRDADFI_ROBERTA_ZWNJ_WNLI_MEAN_TOKENS(
    ...
    JMBRITO_PTBR_SIMILARITY_E5_SMALL(
        "jmbrito/ptbr-similarity-e5-small",
        492840150L
    ),
    EF_ZULLA_E5_MULTI_SML_TORCH("ef-zulla/e5-multi-sml-torch", 492995658L),
    EFEDERICI_MULTILINGUAL_E5_SMALL_4096(
        "efederici/multilingual-e5-small-4096",
        494892908L
    ),
    ...
    TURKUNLP_SBERT_CASED_FINNISH_PARAPHRASE(
        "TurkuNLP/sbert-cased-finnish-paraphrase",
        498571084L
    ),
    FIRQAAA_INDO_SENTENCE_BERT_BASE(
    ...
    KBLAB_SENTENCE_BERT_SWEDISH_CASED(
    ...
    IPIPAN_SILVER_RETRIEVER_BASE_V1(
    ...
    JINAAI_JINA_EMBEDDINGS_V2_SMALL_EN(
    ...
    BARISAYDIN_TEXT2VEC_BASE_MULTILINGUAL(
    ...
    DDOBOKKI_KLUE_ROBERTA_SMALL_NLI_STS(
    ...
    MRP_SIMCSE_MODEL_M_BERT_THAI_CASED(
    ...
    SONOISA_CLIP_VIT_B_32_JAPANESE_V1(
    ...
    KMARIUNAS_UNCASED_BERT_TRIPLET_40(
        "kmariunas/uncased-bert-triplet-40",
        876434296L
    ),
    ...
    SENTENCE_TRANSFORMERS_NLI_BERT_BASE(
    ...
    DENNLINGER_BERT_WIKI_PARAGRAPHS(
        "dennlinger/bert-wiki-paragraphs",
        876684158L
    ),
    SENTENCE_TRANSFORMERS_ALL_MPNET_BASE_V1(
    ...
    BIU_NLP_ABSTRACT_SIM_SENTENCE_PUBMED(
        "biu-nlp/abstract-sim-sentence-pubmed",
        876931102L
    ),
    ...
    L3CUBE_PUNE_TAMIL_SENTENCE_BERT_NLI(
    ...
    L3CUBE_PUNE_INDIC_SENTENCE_BERT_NLI(
    ...
    SDADAS_ST_POLISH_PARAPHRASE_FROM_MPNET(
    ...
    LIGHTETERNAL_STSB_XLM_R_GREEK_TRANSFER(
    ...
    KAISERRR_PMC_VIT_L_14_MULTILINGUAL(
        "kaiserrr/pmc-vit-l-14-multilingual",
        1134398395L
    ),
    ...
    UARITM_MULTILINGUAL_EN_UK_PL_RU(
    ...
    EFEDERICI_E5_BASE_MULTILINGUAL_4096(
        "efederici/e5-base-multilingual-4096",
        1141989720L
    ),
    SDADAS_MMLW_RETRIEVAL_E5_LARGE(
        "sdadas/mmlw-retrieval-e5-large",
        1142073524L
    ),
    SHIBING624_TEXT2VEC_BASE_CHINESE(
        "shibing624/text2vec-base-chinese",
        1225878310L
    ),
    CMARKEA_DISTILCAMEMBERT_BASE_NLI(
        "cmarkea/distilcamembert-base-nli",
        1233966108L
    ),
    THENLPER_GTE_LARGE_ZH("thenlper/gte-large-zh", 1302780948L),
    SHIBING624_TEXT2VEC_BGE_LARGE_CHINESE(
        "shibing624/text2vec-bge-large-chinese",
        1302786763L
    ),
    RESEARCH2NLP_ELECTRICAL_STELLA(
    ...
    SENTENCE_TRANSFORMERS_STSB_BERT_BASE(
    ...
    BIU_NLP_ABSTRACT_SIM_QUERY_PUBMED(
        "biu-nlp/abstract-sim-query-pubmed",
        1314929735L
    ),
    ...
    SENTENCE_TRANSFORMERS_ALLENAI_SPECTER(
    ...
    NAUFALIHSAN_INDONESIAN_SBERT_LARGE(
    ...
    CONSCIOUSAI_CAI_LUNARIS_TEXT_EMBEDDINGS(
    ...
    JHLEE3421_FAQ_SEMANTIC_KLUE_ROBERTA_LARGE(
        "jhlee3421/faq-semantic-klue-roberta-large",
        1347759387L
    ),
    YS7YOO_SENTENCE_ROBERTA_LARGE_KOR_STS(
    ...
    CL_NAGOYA_UNSUP_SIMCSE_JA_LARGE(
    ...
    SHIBING624_TEXT2VEC_BASE_MULTILINGUAL(
    ...
    SENTENCE_TRANSFORMERS_STSB_ROBERTA_BASE(
    ...
    HIIAMSID_SENTENCE_SIMILARITY_HINDI(
    ...
    GANYMEDENIL_TEXT2VEC_LARGE_CHINESE(
        "GanymedeNil/text2vec-large-chinese",
        2604914264L
    ),
    INTFLOAT_E5_LARGE_UNSUPERVISED(
    ...
    AARI1995_GERMAN_SEMANTIC_STS_V2(
        "aari1995/German_Semantic_STS_V2",
        2687049043L
    ),
    LAJAVANESS_CROSSENCODER_CAMEMBERT_LARGE(
    ...
    SENTENCE_TRANSFORMERS_STSB_BERT_LARGE(
    ...
    DANGVANTUAN_SENTENCE_CAMEMBERT_LARGE(
        "dangvantuan/sentence-camembert-large",
        4041517356L
    ),
    SENTENCE_TRANSFORMERS_NLI_ROBERTA_LARGE(
    ...
    BLAXZTER_LABSE_SENTENCE_EMBEDDINGS(

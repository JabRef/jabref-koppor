...
/**
 * This enumeration was formed by <a href=
 * "https://docs.djl.ai/master/docs/load_model.html#list-available-models-using-djl-command-line">listing
 * available embeddings model from Model Zoo of DJL</a> and by using a script that would
 * rewrite the output in Java syntax + calculate size information by finding the models on
 * Hugging Face.
 */
public enum EmbeddingModel {
    ...
    FLAX_SENTENCE_EMBEDDINGS_MULTI_QA_V1_MINILM_L6_CLS_DOT("flax-sentence-embeddings/multi-qa_v1-MiniLM-L6-cls_dot",
            91634951L),
    ...
    RIOLITE_PRODUCTS_MATCHING_AUMET_FINE_TUNE_2023_08_22("RIOLITE/products_matching_aumet_fine_tune_2023-08-22",
            91839291L),
    ...
    INKOZIEV_SBERT_PQ("inkoziev/sbert_pq", 120308714L), INKOZIEV_SBERT_SYNONYMY("inkoziev/sbert_synonymy", 120311223L),
    THENLPER_GTE_SMALL_ZH("thenlper/gte-small-zh", 121472573L),
    FLAX_SENTENCE_EMBEDDINGS_ALL_DATASETS_V3_MINILM_L12("flax-sentence-embeddings/all_datasets_v3_MiniLM-L12",
            134243017L),
    ...
    TAYLORAI_BGE_MICRO("TaylorAI/bge-micro", 157041724L), TAYLORAI_BGE_MICRO_V2("TaylorAI/bge-micro-v2", 157042922L),
    ...
    SENTENCE_TRANSFORMERS_MSMARCO_DISTILBERT_BASE_TAS_B("sentence-transformers/msmarco-distilbert-base-tas-b",
            266190339L),
    ...
    EMBEDDING_DATA_DISTILROBERTA_BASE_SENTENCE_TRANSFORMER("embedding-data/distilroberta-base-sentence-transformer",
            331882136L),
    ...
    INTFLOAT_E5_SMALL("intfloat/e5-small", 400847215L), BAAI_BGE_SMALL_EN_V1_5("BAAI/bge-small-en-v1.5", 401109346L),
    ...
    KORNWTP_CONGEN_PARAPHRASE_MULTILINGUAL_MPNET_BASE_V2("kornwtp/ConGen-paraphrase-multilingual-mpnet-base-v2",
            423346343L),
    ...
    PRITAMDEKA_BIOBERT_MNLI_SNLI_SCINLI_SCITAIL_MEDNLI_STSB("pritamdeka/BioBERT-mnli-snli-scinli-scitail-mednli-stsb",
            434214702L),
    RICARDO_FILHO_BERT_BASE_PORTUGUESE_CASED_NLI_ASSIN_2("ricardo-filho/bert-base-portuguese-cased-nli-assin-2",
            436429150L),
    ...
    INOKUFU_BERT_BASE_UNCASED_XNLI_STS_FINETUNED_EDUCATION("inokufu/bert-base-uncased-xnli-sts-finetuned-education",
            438946856L),
    ...
    NYTK_SENTENCE_TRANSFORMERS_EXPERIMENTAL_HUBERT_HUNGARIAN("NYTK/sentence-transformers-experimental-hubert-hungarian",
            443593876L),
    ...
    INFGRAD_STELLA_LARGE_ZH_V2("infgrad/stella-large-zh-v2", 652825863L), AMU_TAO_8K("amu/tao-8k", 667548999L),
    ...
    JHGAN_KO_SBERT_NLI("jhgan/ko-sbert-nli", 886045384L), JHGAN_KO_SROBERTA_STS("jhgan/ko-sroberta-sts", 886050344L),
    ...
    AIDA_UPM_MSTSB_PARAPHRASE_MULTILINGUAL_MPNET_BASE_V2("AIDA-UPM/mstsb-paraphrase-multilingual-mpnet-base-v2",
            1126421474L),
    ...
    SENTENCE_TRANSFORMERS_PARAPHRASE_DISTILROBERTA_BASE_V2("sentence-transformers/paraphrase-distilroberta-base-v2",
            1316717279L),
    SENTENCE_TRANSFORMERS_MSMARCO_DISTILROBERTA_BASE_V2("sentence-transformers/msmarco-distilroberta-base-v2",
            1316717517L),
    ...
    FLAX_SENTENCE_EMBEDDINGS_ALL_DATASETS_V3_ROBERTA_LARGE("flax-sentence-embeddings/all_datasets_v3_roberta-large",
            1424216178L),
    COINTEGRATED_RUBERT_BASE_CASED_DP_PARAPHRASE_DETECTION("cointegrated/rubert-base-cased-dp-paraphrase-detection",
            1424603089L),
    ABBASGOLESTANI_AG_NLI_DETS_SENTENCE_SIMILARITY_V1("abbasgolestani/ag-nli-DeTS-sentence-similarity-v1", 1424949708L),
    S_NLP_RUBERT_BASE_CASED_CONVERSATIONAL_PARAPHRASE_V1("s-nlp/rubert-base-cased-conversational-paraphrase-v1",
            1427358048L),
    ...
    SENTENCE_TRANSFORMERS_ROBERTA_BASE_NLI_MEAN_TOKENS("sentence-transformers/roberta-base-nli-mean-tokens",
            1498736923L),
    ...
    SENTENCE_TRANSFORMERS_MSMARCO_ROBERTA_BASE_ANCE_FIRSTP("sentence-transformers/msmarco-roberta-base-ance-firstp",
            1503475571L),
    SENTENCE_TRANSFORMERS_QUORA_DISTILBERT_MULTILINGUAL("sentence-transformers/quora-distilbert-multilingual",
            1619939023L),
    ...
    SENTENCE_TRANSFORMERS_MSMARCO_DISTILBERT_MULTILINGUAL_EN_DE_V2_TMP_LNG_ALIGNED(
            "sentence-transformers/msmarco-distilbert-multilingual-en-de-v2-tmp-lng-aligned", 1619939584L),
    SENTENCE_TRANSFORMERS_MSMARCO_DISTILBERT_MULTILINGUAL_EN_DE_V2_TMP_TRAINED_SCRATCH(
            "sentence-transformers/msmarco-distilbert-multilingual-en-de-v2-tmp-trained-scratch", 1619939629L),
    SENTENCE_TRANSFORMERS_CLIP_VIT_B_32_MULTILINGUAL_V1("sentence-transformers/clip-ViT-B-32-multilingual-v1",
            1623088124L),
    ...
    SENTENCE_TRANSFORMERS_BERT_BASE_NLI_STSB_MEAN_TOKENS("sentence-transformers/bert-base-nli-stsb-mean-tokens",
            1752799151L),
    ...
    SENTENCE_TRANSFORMERS_ROBERTA_BASE_NLI_STSB_MEAN_TOKENS("sentence-transformers/roberta-base-nli-stsb-mean-tokens",
            1997326693L),
    ...
    EMBAAS_SENTENCE_TRANSFORMERS_MULTILINGUAL_E5_LARGE("embaas/sentence-transformers-multilingual-e5-large",
            2261845613L),
    ...
    INTFLOAT_E5_LARGE("intfloat/e5-large", 2682104146L), LLMRAILS_EMBER_V1("llmrails/ember-v1", 2682324569L),
    ...
    SENTENCE_TRANSFORMERS_ROBERTA_LARGE_NLI_MEAN_TOKENS("sentence-transformers/roberta-large-nli-mean-tokens",
            2845695742L),
    ...
    SENTENCE_TRANSFORMERS_BERT_LARGE_NLI_STSB_MEAN_TOKENS("sentence-transformers/bert-large-nli-stsb-mean-tokens",
            4023122049L),
    ...
    SENTENCE_TRANSFORMERS_ROBERTA_LARGE_NLI_STSB_MEAN_TOKENS("sentence-transformers/roberta-large-nli-stsb-mean-tokens",
            5689102286L),

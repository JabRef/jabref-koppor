...
/**
 * This class checks JabRef's shipped classes for architecture quality. Does not analyze
 * test classes. Hint from
 * <a href="https://stackoverflow.com/a/44681895/873282">StackOverflow</a>
 */
...
public class CommonArchitectureTest {
    ...
    public void doNotUseSwing(JavaClasses classes) {
        ...
        ArchRuleDefinition.noClasses()
            ...
            .should()
            .accessClassesThat()
            .resideInAnyPackage("javax.swing", "javax.swing.border..", "javax.swing.colorchooser..",
                    "javax.swing.event..", "javax.swing.filechooser..", "javax.swing.plaf..", "javax.swing.table..",
    ...
    public void doNotUseAssertJ(JavaClasses classes) {
        ArchRuleDefinition.noClasses().should().accessClassesThat().resideInAPackage("org.assertj..").check(classes);
    }
    ...
    public void useStreamsOfResources(JavaClasses classes) {
        ...
        ArchRuleDefinition.noClasses()
            ...
            .and()
            .areNotAssignableFrom("org.jabref.logic.importer.fileformat.ImporterTestEngine")
            .should()
    ...
    public void doNotUseGuiInLogic(JavaClasses classes) {
        ArchRuleDefinition.noClasses()
            ...
            .should()
            .dependOnClassesThat()
            .resideInAPackage(PACKAGE_ORG_JABREF_GUI)
            .check(classes);
    }

    @ArchTest
    public void restrictUsagesInModel(JavaClasses classes) {
        // Until we switch to Lucene, we need to access
        // Globals.stateManager().getActiveDatabase() from the search classes,
    ...
    public void restrictToSlf4jLogger(JavaClasses classes) {
        List<String> restrictedLoggingPackages = List.of("java.util.logging..", // Java's
                                                                                // built-in
                                                                                // logging
        ...
        ArchRuleDefinition.noClasses()
            .that()
            .resideOutsideOfPackages("org.jabref.gui.errorconsole", "org.jabref.gui.logging", "org.jabref")
            .should()
            .accessClassesThat()
    ...
    public void restrictStandardStreams(JavaClasses classes) {
        ArchRuleDefinition.noClasses()
            ...
            .and()
            .resideOutsideOfPackages("org.jabref.gui.openoffice..") // Uses LibreOffice
                                                                    // SDK
            .and()
    ...
    public void shouldNotCallUriCreateMethod(JavaClasses classes) {
        ArchRuleDefinition.noClasses()
            ...
            .should()
            .callMethod(URI.class, "create", String.class)
            .check(classes);
    }
    ...
    public void shouldUseJSpecifyAnnotations(JavaClasses classes) {
        ArchRuleDefinition.noClasses()
            .should()
            .dependOnClassesThat()
            .resideInAPackage("org.jetbrains.annotations..")
